...
#if defined(HAVE_SSE) || defined(HAVE_SSE2) || defined(HAVE_AVX) ||            \
    defined(HAVE_AVX_128_FMA) || defined(HAVE_AVX2) || defined(HAVE_AVX512) || \
    defined(HAVE_KCVI) || defined(HAVE_ALTIVEC) || defined(HAVE_VSX) ||        \
    defined(HAVE_MIPS_PS) || defined(HAVE_GENERIC_SIMD128) ||                  \
...
#define MIN_ALIGNMENT                                                          \
  32 /* best alignment for AVX, conservative for                               \
      * everything else */
#else
...
#define FFTW_2R_IS_DOUBLE                                                      \
  (defined(FFTW_SINGLE) && SIZEOF_FLOAT != 0 &&                                \
...
/*-----------------------------------------------------------------------*/
/* assert.c: */
IFFTW_EXTERN void X(assertion_failed)(const char *s, int line,
                                      const char *file);

/* always check */
#define CK(ex) (void)((ex) || (X(assertion_failed)(#ex, __LINE__, __FILE__), 0))

#ifdef FFTW_DEBUG
/* check only if debug enabled */
#define A(ex) (void)((ex) || (X(assertion_failed)(#ex, __LINE__, __FILE__), 0))
#else
#define A(ex) /* nothing */
#endif
...
tensor *X(mktensor_2d)(INT n0, INT is0, INT os0, INT n1, INT is1, INT os1);
tensor *X(mktensor_3d)(INT n0, INT is0, INT os0, INT n1, INT is1, INT os1,
                       INT n2, INT is2, INT os2);
tensor *X(mktensor_4d)(INT n0, INT is0, INT os0, INT n1, INT is1, INT os1,
                       INT n2, INT is2, INT os2, INT n3, INT is3, INT os3);
tensor *X(mktensor_5d)(INT n0, INT is0, INT os0, INT n1, INT is1, INT os1,
                       INT n2, INT is2, INT os2, INT n3, INT is3, INT os3,
...
enum wakefulness { SLEEPY, AWAKE_ZERO, AWAKE_SQRTN_TABLE, AWAKE_SINCOS };
...
#define NO_FIXED_RADIX_LARGE_NP(plnr) (PLNR_L(plnr) & NO_FIXED_RADIX_LARGE_N)
...
struct planner_s {
  ...
  void (*hook)(struct planner_s *plnr, plan *pln, const problem *p,
               int optimalp);
...
plan *X(mkplan_f_d)(planner *ego, problem *p, unsigned l_set, unsigned u_set,
                    unsigned u_reset);
...
#if (defined(__i386__) || defined(__x86_64__) || _M_IX86 >= 500) &&            \
    !defined(FFTW_LDOUBLE)
...
/* thresholds below which certain solvers are considered SLOW.  These are
   guesses believed to be conservative */
...
void X(cpy2d)(R *I, R *O, INT n0, INT is0, INT os0, INT n1, INT is1, INT os1,
              INT vl);
...
void X(cpy2d_co)(R *I, R *O, INT n0, INT is0, INT os0, INT n1, INT is1, INT os1,
                 INT vl);
void X(cpy2d_tiled)(R *I, R *O, INT n0, INT is0, INT os0, INT n1, INT is1,
                    INT os1, INT vl);
void X(cpy2d_tiledbuf)(R *I, R *O, INT n0, INT is0, INT os0, INT n1, INT is1,
                       INT os1, INT vl);
void X(cpy2d_pair)(R *I0, R *I1, R *O0, R *O1, INT n0, INT is0, INT os0, INT n1,
                   INT is1, INT os1);
void X(cpy2d_pair_ci)(R *I0, R *I1, R *O0, R *O1, INT n0, INT is0, INT os0,
                      INT n1, INT is1, INT os1);
void X(cpy2d_pair_co)(R *I0, R *I1, R *O0, R *O1, INT n0, INT is0, INT os0,
                      INT n1, INT is1, INT os1);
...
typedef void (*cpy2d_func)(R *I, R *O, INT n0, INT is0, INT os0, INT n1,
                           INT is1, INT os1, INT vl);
...
double X(measure_execution_time)(const planner *plnr, plan *pln,
                                 const problem *p);
IFFTW_EXTERN int X(ialignment_of)(R *p);
unsigned X(hash)(const char *s);
INT X(nbuf)(INT n, INT vl, INT maxnbuf);
int X(nbuf_redundant)(INT n, INT vl, size_t which, const INT *maxnbuf,
                      size_t nmaxnbuf);
