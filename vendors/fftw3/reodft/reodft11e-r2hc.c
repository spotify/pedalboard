...
static void awake(plan *ego_, enum wakefulness wakefulness) {
  ...
  static const tw_instr reodft11e_tw[] = {{TW_COS, 1, 1}, {TW_NEXT, 2, 0}};
  ...
  X(twiddle_awake)
  (wakefulness, &ego->td2, reodft11e_tw, 8 * ego->n, 1, ego->n * 2);
}
...
void X(reodft11e_r2hc_register)(planner *p) { REGISTER_SOLVER(p, mksolver()); }
