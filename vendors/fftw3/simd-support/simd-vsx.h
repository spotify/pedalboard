...
#define VDUPL(a)                                                               \
  ({                                                                           \
    const vector unsigned char perm = {0, 1, 2,  3,  0, 1, 2,  3,              \
                                       8, 9, 10, 11, 8, 9, 10, 11};            \
    vec_perm(a, a, perm);                                                      \
  })
#define VDUPH(a)                                                               \
  ({                                                                           \
    const vector unsigned char perm = {4,  5,  6,  7,  4,  5,  6,  7,          \
...
#define VDUPL(a)                                                               \
  ({                                                                           \
    const vector unsigned char perm = {0, 1, 2, 3, 4, 5, 6, 7,                 \
                                       0, 1, 2, 3, 4, 5, 6, 7};                \
    vec_perm(a, a, perm);                                                      \
  })
#define VDUPH(a)                                                               \
  ({                                                                           \
    const vector unsigned char perm = {8, 9, 10, 11, 12, 13, 14, 15,           \
...
#ifdef FFTW_SINGLE
  const vector unsigned char perm = {4,  5,  6,  7,  0, 1, 2,  3,
