...
int X(planner_nthreads)(void) { return X(the_planner)()->nthr; }

void X(make_planner_thread_safe)(void) { X(threads_register_planner_hooks)(); }

spawnloop_function X(spawnloop_callback) = (spawnloop_function)0;
void *X(spawnloop_callback_data) = (void *)0;
void X(threads_set_callback)(void (*spawnloop)(void *(*work)(char *), char *,
                                               size_t, int, void *),
                             void *data) {
