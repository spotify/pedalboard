...
static plan *mkplan(const solver *ego_, const problem *p_, planner *plnr) {
  ...
  cldt = X(mkplan_d)(plnr,
                     XM(mkproblem_transpose)(p->sz->dims[0].n, p->sz->dims[1].n,
                                             nrest, I, O, p->sz->dims[0].b[IB],
...

  {
    ...
    cld2 = X(mkplan_d)(plnr, X(mkproblem_rdft_1_d)(
                                 X(mktensor_1d)(p->sz->dims[0].n, nrest, nrest),
                                 X(mktensor_2d)(b, is, is, nrest, 1, 1), O, O,
                                 p->kind[0]));
