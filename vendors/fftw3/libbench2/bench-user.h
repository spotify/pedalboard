...
#define SINGLE_PRECISION                                                       \
  (!DOUBLE_PRECISION && sizeof(bench_real) == sizeof(float))
#undef LDOUBLE_PRECISION
#define LDOUBLE_PRECISION                                                      \
  (!DOUBLE_PRECISION && sizeof(bench_real) == sizeof(long double))

#undef QUAD_PRECISION
#ifdef BENCHFFT_QUAD
#define QUAD_PRECISION                                                         \
  (!LDOUBLE_PRECISION && sizeof(bench_real) == sizeof(__float128))
#else
...
extern void after_problem_ccopy_from(bench_problem *p, bench_real *ri,
                                     bench_real *ii);
extern void after_problem_ccopy_to(bench_problem *p, bench_real *ro,
                                   bench_real *io);
extern void after_problem_hccopy_from(bench_problem *p, bench_real *ri,
                                      bench_real *ii);
extern void after_problem_hccopy_to(bench_problem *p, bench_real *ro,
                                    bench_real *io);
...
#define BEGIN_BENCH_DOC                                                        \
  struct bench_doc bench_doc[] = {CC_DOC CXX_DOC F77_DOC F90_DOC
