 ...
 * -pipeline-latency 4 -n 20 -name n1_20 -include dft/scalar/n.h */
...
static void n1_20(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP250000000, +0.250000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(80, is),
        MAKE_VOLATILE_STRIDE(80, os)) {
...
static const kdft_desc desc = {20, "n1_20", {136, 0, 72, 0}, &GENUS, 0, 0,
                               0,  0};
...
static const kdft_desc desc = {20, "n1_20", {184, 24, 24, 0}, &GENUS, 0, 0,
                               0,  0};
