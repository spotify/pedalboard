 ...
 * -pipeline-latency 4 -n 10 -name n1_10 -include dft/scalar/n.h */
...
static void n1_10(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(40, is),
        MAKE_VOLATILE_STRIDE(40, os)) {
...
static const kdft_desc desc = {10, "n1_10", {72, 12, 12, 0}, &GENUS, 0, 0,
                               0,  0};
