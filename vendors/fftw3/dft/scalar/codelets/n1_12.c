 ...
 * -pipeline-latency 4 -n 12 -name n1_12 -include dft/scalar/n.h */
...
static void n1_12(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(48, is),
        MAKE_VOLATILE_STRIDE(48, os)) {
