 ...
 * -pipeline-latency 4 -n 32 -name t1_32 -include dft/scalar/t.h */
...
static void t1_32(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + (mb * 62); m < me; m = m + 1, ri = ri + ms,
        ii = ii + ms, W = W + 62, MAKE_VOLATILE_STRIDE(64, rs)) {
      E T8, T8x, T3w, T87, Tl, T8y, T3B, T83, Tz, T6F, T3J, T5T, TM, T6G, T3Q;
      E T5U, T11, T1e, T6M, T6J, T6K, T6L, T3Z, T5X, T46, T5Y, T1s, T1F, T6O,
          T6P;
      E T6Q, T6R, T4e, T60, T4l, T61, T32, T7b, T78, T7N, T54, T6f, T5r, T6c,
          T29;
      E T70, T6X, T7I, T4v, T68, T4S, T65, T3t, T79, T7e, T7O, T5b, T5s, T5i,
          T5t;
      ...
      {
        E T3S, T5C, T4n, T8C, T8B, T8H, T5F, T8I, T5w, T5Q, T5A, T5M, T4X, T5P,
            T5z;
        E T5J;
        {
          E T3C, T3R, T5D, T5E;
...
static const tw_instr twinstr[] = {{TW_FULL, 0, 32}, {TW_NEXT, 1, 0}};

static const ct_desc desc = {32, "t1_32", twinstr, &GENUS, {236, 62, 198, 0},
                             0,  0,       0};

void X(codelet_t1_32)(planner *p) { X(kdft_dit_register)(p, t1_32, &desc); }
#else
...
static const ct_desc desc = {32, "t1_32", twinstr, &GENUS, {340, 114, 94, 0},
                             0,  0,       0};
