 ...
 * -pipeline-latency 4 -n 20 -name t1_20 -include dft/scalar/t.h */
...
static void t1_20(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + (mb * 38); m < me; m = m + 1, ri = ri + ms,
        ii = ii + ms, W = W + 38, MAKE_VOLATILE_STRIDE(40, rs)) {
      E T8, T4N, T2i, T4r, Tl, T4O, T2n, T4n, TN, T2b, T40, T4b, T2v, T3v, T3i;
      E T3F, T27, T2f, T3W, T4f, T2R, T3z, T3a, T3J, T1G, T2e, T3T, T4e, T2K,
          T3y;
...
static const tw_instr twinstr[] = {{TW_FULL, 0, 20}, {TW_NEXT, 1, 0}};

static const ct_desc desc = {20, "t1_20", twinstr, &GENUS, {136, 38, 110, 0},
                             0,  0,       0};

void X(codelet_t1_20)(planner *p) { X(kdft_dit_register)(p, t1_20, &desc); }
#else
...
static void t1_20(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + (mb * 38); m < me; m = m + 1, ri = ri + ms,
        ii = ii + ms, W = W + 38, MAKE_VOLATILE_STRIDE(40, rs)) {
      E Tj, T1R, T4g, T4p, T2q, T37, T3Q, T42, T1r, T1O, T1P, T3i, T3l, T44,
          T3D;
      E T3E, T3K, T1V, T1W, T1X, T23, T28, T4r, T2W, T2X, T4c, T33, T34, T35,
          T2G;
      E T2L, T2M, TG, T13, T14, T3p, T3s, T43, T3A, T3B, T3J, T1S, T1T, T1U,
          T2e;
      ...
      {
        E T1f, T3g, T21, T2C, T1N, T3k, T27, T2K, T1q, T3h, T22, T2F, T1C, T3j,
            T26;
        E T2H;
        {
          E T19, T1Z, T1e, T20;
      ...
      {
        E Tu, T3n, T2c, T2r, T12, T3r, T2i, T2z, TF, T3o, T2d, T2u, TR, T3q,
            T2h;
        E T2w;
        {
          E To, T2a, Tt, T2b;
...
static const ct_desc desc = {20, "t1_20", twinstr, &GENUS, {184, 62, 62, 0},
                             0,  0,       0};
