 ...
 * -pipeline-latency 4 -n 15 -name n1_15 -include dft/scalar/n.h */
...
static void n1_15(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(60, is),
        MAKE_VOLATILE_STRIDE(60, os)) {
...
static const kdft_desc desc = {15, "n1_15", {128, 28, 28, 0}, &GENUS, 0, 0,
                               0,  0};
