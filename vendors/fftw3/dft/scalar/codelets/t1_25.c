 ...
 * -pipeline-latency 4 -n 25 -name t1_25 -include dft/scalar/t.h */
...
static void t1_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + (mb * 48); m < me; m = m + 1, ri = ri + ms,
        ii = ii + ms, W = W + 48, MAKE_VOLATILE_STRIDE(50, rs)) {
      E T1, T6X, T3Y, T5G, T7c, T7C, Ts, T3L, T3M, T6W, T77, T78, T4P, T5T, T4W;
      E T5Q, T2G, T5S, T4M, T3G, T5P, T4T, T45, T65, T4c, T68, T11, T64, T42,
          T2Z;
      E T67, T49, T4k, T61, T4r, T5Y, T1z, T5X, T4o, T3d, T60, T4h, T4A, T5M,
          T4H;
      ...
      {
        E T3Z, T5d, T7d, T7p, T56, T59, T7l, T7k, T7e, T7f, T7g, T4u, T4Z, T50,
            T5y;
      ...
      {
        E T5H, T6p, T7D, T7P, T6i, T6l, T7X, T7W, T7Q, T7R, T7S, T5W, T6b, T6c,
            T6K;
...
static const tw_instr twinstr[] = {{TW_FULL, 0, 25}, {TW_NEXT, 1, 0}};

static const ct_desc desc = {25, "t1_25", twinstr, &GENUS, {84, 48, 316, 0},
                             0,  0,       0};

void X(codelet_t1_25)(planner *p) { X(kdft_dit_register)(p, t1_25, &desc); }
#else
...
static void t1_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + (mb * 48); m < me; m = m + 1, ri = ri + ms,
      ...
      E T5D, T4r, T58, T3Z, T5C, T4q, T5b, TS, T5W, T2G, T5s, T4g, T4M, T2R,
          T5t;
      E T4h, T4P, T1l, T5X, T33, T5w, T4j, T4W, T3e, T5v, T4k, T4T, T1P, T5Z,
          T3r;
      ...
      {
        E T2v, T4f, T6u, T6G, T42, T6z, T43, T6y, T4A, T6H, T4D, T6F, T4u, T6L,
            T4v;
      ...
      {
        E T4J, T5r, T6U, T76, T5e, T6Z, T5f, T6Y, T5M, T77, T5P, T75, T5G, T7b,
            T5H;
...
static const ct_desc desc = {25, "t1_25", twinstr, &GENUS, {260, 140, 140, 0},
                             0,  0,       0};
