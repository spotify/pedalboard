 ...
 * -pipeline-latency 4 -n 32 -name n1_32 -include dft/scalar/n.h */
...
static void n1_32(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP414213562, +0.414213562373095048801688724209698078569671875);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(128, is),
...
static const kdft_desc desc = {32, "n1_32", {236, 0, 136, 0}, &GENUS, 0, 0,
                               0,  0};
...
static const kdft_desc desc = {32, "n1_32", {340, 52, 32, 0}, &GENUS, 0, 0,
                               0,  0};
