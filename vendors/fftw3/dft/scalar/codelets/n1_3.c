 ...
 * -pipeline-latency 4 -n 3 -name n1_3 -include dft/scalar/n.h */
...
static void n1_3(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(12, is),
        MAKE_VOLATILE_STRIDE(12, os)) {
