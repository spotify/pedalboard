 ...
 * -pipeline-latency 4 -twiddle-log3 -precompute-twiddles -n 32 -name t2_32
...
static void t2_32(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * 8); m < me; m = m + 1, ri = ri + ms,
        ii = ii + ms, W = W + 8, MAKE_VOLATILE_STRIDE(64, rs)) {
      ...
      }
      {
        E Tq, T46, T8H, T97, TH, T98, T4b, T8D, TZ, T7f, T4j, T6t, T1g, T7g,
            T4q;
        E T6u, T1v, T1I, T7m, T7j, T7k, T7l, T4z, T6x, T4G, T6y, T22, T2j, T7o,
            T7p;
        E T7q, T7r, T4O, T6A, T4V, T6B, T3G, T7L, T7I, T8n, T5E, T6P, T61, T6M,
            T2N;
        E T7A, T7x, T8i, T55, T6I, T5s, T6F, T43, T7J, T7O, T8o, T5L, T62, T5S,
            T63;
...
static const ct_desc desc = {32, "t2_32", twinstr, &GENUS, {236, 98, 252, 0},
                             0,  0,       0};

void X(codelet_t2_32)(planner *p) { X(kdft_dit_register)(p, t2_32, &desc); }
#else
...
static const ct_desc desc = {32, "t2_32", twinstr, &GENUS, {376, 168, 112, 0},
                             0,  0,       0};
