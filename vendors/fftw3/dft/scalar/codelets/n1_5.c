 ...
 * -pipeline-latency 4 -n 5 -name n1_5 -include dft/scalar/n.h */
...
static void n1_5(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(20, is),
        MAKE_VOLATILE_STRIDE(20, os)) {
