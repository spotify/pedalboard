 ...
 * -pipeline-latency 4 -n 64 -name t1_64 -include dft/scalar/t.h */
...
static void t1_64(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + (mb * 126); m < me; m = m + 1, ri = ri + ms,
        ii = ii + ms, W = W + 126, MAKE_VOLATILE_STRIDE(128, rs)) {
      E Tm, TeM, TjR, Tkl, T7e, TcA, TiV, Tjm, T1G, TeW, TeZ, Ths, T7Q, TcJ,
          T7X;
      E TcI, T29, Tf8, Tf5, Thv, T87, TcN, T8u, TcQ, T5K, Tg9, TfU, ThS, Taq,
          Tdm;
      E Tbj, Tdx, TN, Tjl, TeP, TiP, T7l, TcB, T7s, TcC, T1f, TeR, TeU, Thr,
          T7B;
      E TcG, T7I, TcF, T32, Tfj, Tfg, ThB, T8G, TcU, T93, TcX, T3X, TfI, Tft,
          ThH;
      E T9h, Td3, Taa, Tde, T2A, Tf6, Tfb, Thw, T8m, TcR, T8x, TcO, T3t, Tfh,
          Tfm;
      E ThC, T8V, TcY, T96, TcV, T4o, Tfu, TfL, ThI, T9w, Tdf, Tad, Td4, T6b,
          TfV;
      E Tgc, ThT, TaF, Tdy, Tbm, Tdn, T4Q, ThN, TfA, TfN, Ta1, Tdh, Taf, Td8,
          T5h;
      E ThO, TfF, TfO, T9M, Tdi, Tag, Tdb, T6D, ThY, Tg1, Tge, Tba, TdA, Tbo,
          Tdr;
      ...
      {
        E T1I, Tio, T3v, Tj1, TiX, Tj2, Tir, TiN, T76, TiK, TiC, TiG, T5j, TiJ,
            Tix;
        E TiF;
        {
          E TO, T1H, Tip, Tiq;
      ...
      {
        E Thu, Ti8, Tj9, Tjf, ThF, Tjg, Tib, Tja, ThR, Til, Ti5, Tif, Ti2, Tim,
            Ti6;
        E Tii;
        {
          E Thq, Tht, Tj7, Tj8;
      ...
      {
        E Tf2, TjJ, Tgo, TjD, TgI, Tjv, Tha, Tjp, Tfp, Tjw, Tgr, Tjq, Th4, Tho,
            Th8;
        E Thk, TfR, TgB, Tgl, Tgv, TgP, TjK, Thd, TjE, TgX, Thn, Th7, Thh, Tgi,
            TgC;
        E Tgm, Tgy;
        {
      ...
      {
        E T99, Tkw, TbB, Tkq, Taj, TbL, Tbv, TbF, Tce, Tcy, Tci, Tcu, Tc7, Tcx,
            Tch;
        E Tcr, TbZ, TkK, Tcn, TkE, Tbs, TbM, Tbw, TbI, T80, TkD, TkJ, Tby, TbS,
            Tkp;
        E Tkv, Tck;
        {
          E T8z, Tbz, T98, TbA;
      ...
      {
        E Td1, Tk2, TdN, TjW, Tdl, TdX, TdH, TdR, Teq, TeK, Teu, TeG, Tej, TeJ,
            Tet;
        E TeD, Teb, Tkg, Tez, Tka, TdE, TdY, TdI, TdU, TcM, Tk9, Tkf, TdK, Te4,
            TjV;
        E Tk1, Tew;
        {
          E TcT, TdL, Td0, TdM;
...
static const tw_instr twinstr[] = {{TW_FULL, 0, 64}, {TW_NEXT, 1, 0}};

static const ct_desc desc = {64, "t1_64", twinstr, &GENUS, {520, 126, 518, 0},
                             0,  0,       0};

void X(codelet_t1_64)(planner *p) { X(kdft_dit_register)(p, t1_64, &desc); }
#else
...
static void t1_64(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * 126); m < me; m = m + 1, ri = ri + ms,
      ...
      E Tim, T14, Tfq, T6y, T9O, TaG, Tc0, TcU, TeE, T1r, Tfr, T6J, T9P, TaJ,
          Tc1;
      E TcZ, TeF, T1Q, T2d, Tfx, Tfu, Tfv, Tfw, T6Q, TaM, Tdb, TeJ, T71, TaQ,
          T7a;
      E TaN, Td6, TeI, T77, TaP, T2B, T2Y, Tfz, TfA, TfB, TfC, T7h, TaW, Tdm,
          TeM;
      E T7s, TaU, T7B, TaX, Tdh, TeL, T7y, TaT, T5j, TfR, Tec, Tf0, TfY, Tgy,
          T8D;
      E Tbl, T8O, Tbx, T9l, Tbm, TdV, TeX, T9i, Tbw, T3M, TfL, TdL, TeQ, TfI,
          Tgt;
      E T7K, Tb2, T7V, Tbe, T8s, Tb3, Tdu, TeT, T8p, Tbd, T4x, TfJ, TdE, TdM,
          TfO;
      E Tgu, T87, T8v, T8i, T8u, Tba, Tbg, Tdz, TdN, Tb7, Tbh, T64, TfZ, Te5,
          Ted;
      ...
      {
        E T1y, T6M, T1D, T6N, T1E, Td2, T1J, T74, T1O, T75, T1P, Td3, T21, Td8,
            T6W;
      ...
      {
        E T2j, T7d, T2o, T7e, T2p, Tdd, T2u, T7v, T2z, T7w, T2A, Tde, T2M, Tdj,
            T7n;
      ...
      {
        E T4D, T9e, T4I, T9f, T4J, Te8, T4O, T8A, T4T, T8B, T4U, Te9, T56, TdS,
            T8G;
      ...
      {
        E T36, T7G, T3b, T7H, T3c, Tdq, T3h, T8m, T3m, T8n, T3n, Tdr, T3z, TdI,
            T7Q;
      ...
      {
        E T3X, TdB, T8a, T8d, T4v, Tdx, T80, T85, T48, TdC, T8b, T8g, T4k, Tdw,
            T7X;
        E T84;
        {
          E T3R, T88, T3W, T89;
      ...
      {
        E T5u, TdW, T8S, T8V, T62, Te3, T94, T99, T5F, TdX, T8T, T8Y, T5R, Te2,
            T93;
        E T96;
        {
          E T5o, T8Q, T5t, T8R;
      ...
      {
        E T1t, Tgn, TgK, TgL, TgV, Th1, T30, Th0, T66, TgX, Tgw, TgE, TgB, TgF,
            Tgq;
        E TgM;
        {
          E TH, T1s, TgI, TgJ;
      ...
      {
        E Tft, Tg7, Tgh, Tgl, Th9, Thf, TfE, Th6, TfQ, Tg4, Tga, The, Tge, Tgk,
            Tg1;
        E Tg5;
        {
          E Tfp, Tfs, Tgf, Tgg;
      ...
      {
        E Td1, Ten, Tdo, ThA, ThD, ThJ, Teq, ThI, Teh, TeB, Tel, Tex, TdQ, TeA,
            Tek;
        E Teu;
        {
          E TcP, Td0, Teo, Tep;
      ...
      {
        E TeH, Tf9, TeO, Thk, Thp, Thv, Tfc, Thu, Tf3, Tfn, Tf7, Tfj, TeW, Tfm,
            Tf6;
        E Tfg;
        {
          E TeD, TeG, Tfa, Tfb;
      ...
      {
        E T6L, T9x, TiD, TiJ, T7E, TiI, T9A, TiA, T8y, T9K, T9u, T9E, T9r, T9L,
            T9v;
        E T9H;
        {
          E T6n, T6K, TiB, TiC;
      ...
      {
        E TaL, TbJ, Ti9, Tif, Tb0, Tie, TbM, Ti6, Tbk, TbW, TbG, TbQ, TbD, TbX,
            TbH;
        E TbT;
        {
          E TaD, TaK, Ti7, Ti8;
      ...
      {
        E Tc3, Tcv, ThV, Ti1, Tca, Ti0, Tcy, ThO, Tci, TcI, Tcs, TcC, Tcp, TcJ,
            Tct;
        E TcF;
        {
          E TbZ, Tc2, ThP, ThU;
      ...
      {
        E T9R, Taj, Tip, Tiv, T9Y, Tiu, Tam, Tik, Ta6, Taw, Tag, Taq, Tad, Tax,
            Tah;
        E Tat;
        {
          E T9N, T9Q, Til, Tio;
...
static const ct_desc desc = {64, "t1_64", twinstr, &GENUS, {808, 270, 230, 0},
                             0,  0,       0};
