 ...
 * -pipeline-latency 4 -n 25 -name n1_25 -include dft/scalar/n.h */
...
static void n1_25(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(100, is),
        MAKE_VOLATILE_STRIDE(100, os)) {
      E T9, T4Q, T1U, T3b, T45, T1D, T46, T3e, T1R, T4P, Ti, Tr, Ts, TY, T17;
      E T1E, T22, T5f, T3z, T4z, T2o, T5b, T3C, T4s, T2h, T5c, T3D, T4p, T29,
          T5e;
...
static const kdft_desc desc = {25, "n1_25", {84, 0, 268, 0}, &GENUS, 0, 0,
                               0,  0};
...
static void n1_25(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP951056516, +0.951056516295153572116439333379382143405698634);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
      ...
      E T5v, T18, T4G, T34, T3M, T1G, T4J, T38, T3T, T1v, T4K, T37, T3W, T1j,
          T4H;
...
static const kdft_desc desc = {25, "n1_25", {260, 92, 92, 0}, &GENUS, 0, 0,
                               0,  0};
