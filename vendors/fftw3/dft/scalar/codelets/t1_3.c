 ...
 * -pipeline-latency 4 -n 3 -name t1_3 -include dft/scalar/t.h */
...
static void t1_3(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + (mb * 4); m < me; m = m + 1, ri = ri + ms,
        ii = ii + ms, W = W + 4, MAKE_VOLATILE_STRIDE(6, rs)) {
      E T1, Tm, T7, Th, Td, Tj;
      T1 = ri[0];
      Tm = ii[0];
      {
...
static const ct_desc desc = {3, "t1_3", twinstr, &GENUS, {6, 4, 10, 0},
                             0, 0,      0};
...
static const ct_desc desc = {3, "t1_3", twinstr, &GENUS, {10, 6, 6, 0},
                             0, 0,      0};
