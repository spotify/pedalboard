 ...
 * -pipeline-latency 4 -reload-twiddle -dif -n 6 -name q1_6 -include
 * dft/scalar/q.h */
...
static void q1_6(R *rio, R *iio, const R *W, stride rs, stride vs, INT mb,
                 INT me, INT ms) {
  DK(KP866025403, +0.866025403784438646763723170752936183471402627);
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    INT m;
    for (m = mb, W = W + (mb * 10); m < me; m = m + 1, rio = rio + ms,
        iio = iio + ms, W = W + 10, MAKE_VOLATILE_STRIDE(12, rs),
        MAKE_VOLATILE_STRIDE(0, vs)) {
      E T3, Tc, Tw, TW, Ta, TM, Tf, Tg, Tt, TT, Tn, TP, Tu, Tv, TU;
      E TV, T17, T1g, T1A, T20, T1e, T1Q, T1j, T1k, T1x, T1X, T1r, T1T, T1y,
          T1z;
      E T1Y, T1Z, T2B, T31, T2v, T2X, T2C, T2D, T32, T33, T2b, T2k, T2E, T34,
          T2i;
      E T2U, T2n, T2o, T3f, T3o, T3I, T48, T3m, T3Y, T3r, T3s, T3F, T45, T3z,
          T41;
      E T3G, T3H, T46, T47, T4j, T4s, T4M, T5c, T4q, T52, T4v, T4w, T4J, T59,
          T4D;
      E T55, T4K, T4L, T5a, T5b, T5N, T6d, T5H, T69, T5O, T5P, T6e, T6f, T5n,
          T5w;
...
static const ct_desc desc = {6, "q1_6", twinstr, &GENUS, {144, 60, 132, 0},
                             0, 0,      0};

void X(codelet_q1_6)(planner *p) { X(kdft_difsq_register)(p, q1_6, &desc); }
#else
...
static void q1_6(R *rio, R *iio, const R *W, stride rs, stride vs, INT mb,
  ...
  DK(KP866025403, +0.866025403784438646763723170752936183471402627);
  {
    ...
    for (m = mb, W = W + (mb * 10); m < me; m = m + 1, rio = rio + ms,
      ...
      E T2D, T23, T2e, T2S, T3x, T2X, T38, T35, T3v, T3c, T3r, T3M, T4r, T3R,
          T42;
...
static const ct_desc desc = {6, "q1_6", twinstr, &GENUS, {192, 84, 84, 0},
                             0, 0,      0};
