 ...
 * -pipeline-latency 4 -n 16 -name n1_16 -include dft/scalar/n.h */
...
static void n1_16(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(64, is),
...
static const kdft_desc desc = {16, "n1_16", {104, 0, 40, 0}, &GENUS, 0, 0,
                               0,  0};
...
static const kdft_desc desc = {16, "n1_16", {136, 16, 8, 0}, &GENUS, 0, 0,
                               0,  0};
