 ...
 * -pipeline-latency 4 -n 14 -name n1_14 -include dft/scalar/n.h */
...
static void n1_14(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP356895867, +0.356895867892209443894399510021300583399127187);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(56, is),
        MAKE_VOLATILE_STRIDE(56, os)) {
  ...
  DK(KP974927912, +0.974927912181823607018131682993931217232785801);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
      ...
      io[0] = T1f + T1i + T1o + T1l;
      {
        ...
        T1d = FMA(KP623489801, T18, T16) +
              FNMA(KP900968867, T17, KP222520933 * T19);
        io[WS(os, 5)] = T1d - T1e;
        io[WS(os, 9)] = T1e + T1d;
      }
      {
        ...
        T1c = FMA(KP623489801, T19, T16) +
              FNMA(KP900968867, T18, KP222520933 * T17);
        io[WS(os, 1)] = T1b + T1c;
        io[WS(os, 13)] = T1c - T1b;
      }
      {
        ...
        T1a = FMA(KP623489801, T17, T16) +
              FNMA(KP222520933, T18, KP900968867 * T19);
        io[WS(os, 3)] = T13 + T1a;
        io[WS(os, 11)] = T1a - T13;
      }
      {
        ...
        T1p = FMA(KP623489801, T1i, T1f) +
              FNMA(KP900968867, T1l, KP222520933 * T1o);
        io[WS(os, 6)] = T1p - T1t;
        io[WS(os, 8)] = T1t + T1p;
        T1C = FNMS(KP433883739, T1A, KP781831482 * T1z) - (KP974927912 * T1B);
        T1y =
            FMA(KP623489801, Ts, Tp) + FNMA(KP900968867, Ty, KP222520933 * Tv);
        ro[WS(os, 6)] = T1y - T1C;
        ro[WS(os, 8)] = T1y + T1C;
      }
      {
        ...
        T1u = FMA(KP623489801, T1o, T1f) +
              FNMA(KP222520933, T1l, KP900968867 * T1i);
        io[WS(os, 4)] = T1u - T1v;
        io[WS(os, 10)] = T1v + T1u;
        T1E = FMA(KP433883739, T1z, KP781831482 * T1B) - (KP974927912 * T1A);
        T1D =
            FMA(KP623489801, Tv, Tp) + FNMA(KP222520933, Ty, KP900968867 * Ts);
        ro[WS(os, 4)] = T1D - T1E;
        ro[WS(os, 10)] = T1D + T1E;
      }
      {
        ...
        T1x = FMA(KP623489801, T1l, T1f) +
              FNMA(KP900968867, T1o, KP222520933 * T1i);
        io[WS(os, 2)] = T1w + T1x;
        io[WS(os, 12)] = T1x - T1w;
        T1G = FMA(KP974927912, T1z, KP433883739 * T1B) + (KP781831482 * T1A);
        T1F =
            FMA(KP623489801, Ty, Tp) + FNMA(KP900968867, Tv, KP222520933 * Ts);
        ro[WS(os, 12)] = T1F - T1G;
        ro[WS(os, 2)] = T1F + T1G;
      }
    }
...
static const kdft_desc desc = {14, "n1_14", {100, 24, 48, 0}, &GENUS, 0, 0,
                               0,  0};
