 ...
 * -pipeline-latency 4 -twiddle-log3 -precompute-twiddles -n 25 -name t2_25
...
static void t2_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (m = mb, W = W + (mb * 8); m < me; m = m + 1, ri = ri + ms,
        ii = ii + ms, W = W + 8, MAKE_VOLATILE_STRIDE(50, rs)) {
      ...
      {
        E T1, T7r, T4s, T6a, T7G, T86, TM, T4f, T4g, T7q, T7B, T7C, T5j, T6n,
            T5q;
        E T6k, T3a, T6m, T5g, T4a, T6j, T5n, T4z, T6z, T4G, T6C, T1v, T6y, T4w,
            T3t;
        E T6B, T4D, T4O, T6v, T4V, T6s, T21, T6r, T4S, T3H, T6u, T4L, T54, T6g,
            T5b;
        ...
        {
          E T4t, T5H, T7H, T7T, T5A, T5D, T7P, T7O, T7I, T7J, T7K, T4Y, T5t,
              T5u, T62;
        ...
        {
          E T6b, T6T, T87, T8j, T6M, T6P, T8r, T8q, T8k, T8l, T8m, T6q, T6F,
              T6G, T7e;
...
static const ct_desc desc = {25, "t2_25", twinstr, &GENUS, {84, 78, 356, 0},
                             0,  0,       0};

void X(codelet_t2_25)(planner *p) { X(kdft_dit_register)(p, t2_25, &desc); }
#else
...
static void t2_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + (mb * 8); m < me; m = m + 1, ri = ri + ms,
      ...
      {
        E T1, T6v, T2F, T6I, TK, T2G, T6u, T6J, T6N, T7c, T2O, T52, T2C, T6k,
            T48;
        E T5X, T4L, T5s, T4j, T5W, T4K, T5v, T1o, T6g, T30, T5M, T4A, T56, T3b,
            T5N;
        E T4B, T59, T1L, T6h, T3n, T5Q, T4D, T5g, T3y, T5P, T4E, T5d, T2d, T6j,
            T3L;
        ...
        {
          E T2g, T4c, T43, T46, T4h, T4g, T49, T4a, T4d, T2p, T2A, T2B, T2e,
              T2f;
          T2e = ri[WS(rs, 3)];
          T2f = ii[WS(rs, 3)];
        ...
        {
          E T1r, T3r, T3i, T3l, T3w, T3v, T3o, T3p, T3s, T1y, T1J, T1K, T1p,
              T1q;
          T1p = ri[WS(rs, 4)];
          T1q = ii[WS(rs, 4)];
        ...
        {
          E T1P, T3P, T3G, T3J, T3U, T3T, T3M, T3N, T3Q, T20, T2b, T2c, T1N,
              T1O;
          T1N = ri[WS(rs, 2)];
          T1O = ii[WS(rs, 2)];
        ...
        {
          E T2P, T4z, T6O, T70, T4m, T6T, T4n, T6S, T4U, T71, T4X, T6Z, T4O,
              T75, T4P;
        ...
        {
          E T53, T5L, T7e, T7q, T5y, T7j, T5z, T7i, T66, T7r, T69, T7p, T60,
              T7v, T61;
...
static const ct_desc desc = {25, "t2_25", twinstr, &GENUS, {280, 180, 160, 0},
                             0,  0,       0};
