 ...
 * -pipeline-latency 4 -n 13 -name n1_13 -include dft/scalar/n.h */
...
static void n1_13(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
        io = io + ovs, MAKE_VOLATILE_STRIDE(52, is),
        MAKE_VOLATILE_STRIDE(52, os)) {
      ...
      io[0] = T1P + T1U;
      {
        E T1z, T1J, T1G, T1H, T1w, T1I, T1n, T1i, T1s, T1E, TD, T1D, TI, T1r,
            T1e;
        E T1h;
        {
          E T1x, T1y, T1u, T1v;
      ...
      {
        E T2F, T2N, T2v, T2u, T2A, T2K, T2p, T2m, T2C, T2M, T23, T2J, T28, T2z,
            T2i;
        E T2l;
        {
          E T2D, T2E, T2s, T2t;
...
static const kdft_desc desc = {13, "n1_13", {62, 0, 114, 0}, &GENUS, 0, 0,
                               0,  0};
...
static void n1_13(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, ri = ri + ivs, ii = ii + ivs, ro = ro + ovs,
      ...
      io[0] = T1q + T1r;
      {
        E T1D, T1N, T1y, T1x, T1E, T1O, Tv, TK, T1J, T1Q, T1m, T1R, T1t, T1I,
            TG;
        E TJ;
        {
          E T1B, T1C, T1v, T1w;
      ...
      {
        E T2y, T2I, T2J, T2K, T2B, T2L, T2e, T2p, T2u, T2G, T23, T2F, T28, T2t,
            T2l;
        E T2o;
        {
          E T2w, T2x, T2z, T2A;
...
static const kdft_desc desc = {13, "n1_13", {138, 30, 38, 0}, &GENUS, 0, 0,
                               0,  0};
