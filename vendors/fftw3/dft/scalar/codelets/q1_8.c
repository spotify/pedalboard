 ...
 * -pipeline-latency 4 -reload-twiddle -dif -n 8 -name q1_8 -include
 * dft/scalar/q.h */
...
static void q1_8(R *rio, R *iio, const R *W, stride rs, stride vs, INT mb,
                 INT me, INT ms) {
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    INT m;
    for (m = mb, W = W + (mb * 14); m < me; m = m + 1, rio = rio + ms,
        iio = iio + ms, W = W + 14, MAKE_VOLATILE_STRIDE(16, rs),
        MAKE_VOLATILE_STRIDE(0, vs)) {
      E T7, T1d, T1t, Tk, TD, TV, T18, TQ, T4F, T5L, T61, T4S, T5b, T5t, T5G;
      E T5o, T6b, T7h, T7x, T6o, T6H, T6Z, T7c, T6U, TaJ, TbP, Tc5, TaW, Tbf,
          Tbx;
      E TbK, Tbs, T1D, T2J, T2Z, T1Q, T29, T2r, T2E, T2m, T39, T4f, T4v, T3m,
          T3F;
      E T3X, T4a, T3S, T7H, T8N, T93, T7U, T8d, T8v, T8I, T8q, T9d, Taj, Taz,
          T9q;
      E T9J, Ta1, Tae, T9W, Te, T19, T1u, T1g, TE, TF, TW, Tv, TR, T4M, T5H;
      E T62, T5O, T5c, T5d, T5u, T53, T5p, T6i, T7d, T7y, T7k, T6I, T6J, T70,
          T6z;
      E T6V, TaQ, TbL, Tc6, TbS, Tbg, Tbh, Tby, Tb7, Tbt, T1K, T2F, T30, T2M,
          T2a;
      E T2b, T2s, T21, T2n, T3g, T4b, T4w, T4i, T3G, T3H, T3Y, T3x, T3T, T7O,
          T8J;
      E T94, T8Q, T8e, T8f, T8w, T85, T8r, T9k, Taf, TaA, Tam, T9K, T9L, Ta2,
          T9B;
      E T9X;
      {
...
static const tw_instr twinstr[] = {{TW_FULL, 0, 8}, {TW_NEXT, 1, 0}};

static const ct_desc desc = {8, "q1_8", twinstr, &GENUS, {352, 112, 176, 0},
                             0, 0,      0};

void X(codelet_q1_8)(planner *p) { X(kdft_difsq_register)(p, q1_8, &desc); }
#else
...
static void q1_8(R *rio, R *iio, const R *W, stride rs, stride vs, INT mb,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * 14); m < me; m = m + 1, rio = rio + ms,
      ...
      E T1V, T7R, T8O, T90, T84, T8m, T8A, T8K, T8w, T9g, Ta9, Taj, T9r, T9w,
          T9G;
      E Ta3, T9F, Te, T17, T1h, Tp, Tu, TE, T11, TD, T1p, T2m, T2y, T1C, T1U;
      E T28, T2i, T24, T7Y, T8R, T91, T89, T8e, T8o, T8L, T8n, T99, Ta6, Tai,
          T9m;
      E T9E, T9S, Ta2, T9O, T2H, T3E, T3Q, T2U, T3c, T3q, T3A, T3m, T46, T4Z,
          T59;
      E T4h, T4m, T4w, T4T, T4v, T5h, T6e, T6q, T5u, T5M, T60, T6a, T5W, T6G,
          T7z;
      E T7J, T6R, T6W, T76, T7t, T75, T2O, T3H, T3R, T2Z, T34, T3e, T3B, T3d,
          T3Z;
      E T4W, T58, T4c, T4u, T4I, T4S, T4E, T5o, T6h, T6r, T5z, T5E, T5O, T6b,
          T5N;
...
static const ct_desc desc = {8, "q1_8", twinstr, &GENUS, {416, 144, 112, 0},
                             0, 0,      0};
