 ...
 * -pipeline-latency 4 -twiddle-log3 -precompute-twiddles -n 10 -name t2_10
...
static void t2_10(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP250000000, +0.250000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + (mb * 6); m < me; m = m + 1, ri = ri + ms,
        ii = ii + ms, W = W + 6, MAKE_VOLATILE_STRIDE(20, rs)) {
      ...
      {
        E Tk, T1c, T24, T2d, TW, T19, T1a, T1P, T1Q, T1Z, T1g, T1h, T1i, T1C,
            T1H;
...
static const tw_instr twinstr[] = {
    {TW_CEXP, 0, 1}, {TW_CEXP, 0, 3}, {TW_CEXP, 0, 9}, {TW_NEXT, 1, 0}};

static const ct_desc desc = {10, "t2_10", twinstr, &GENUS, {48, 28, 66, 0},
                             0,  0,       0};
...
static const ct_desc desc = {10, "t2_10", twinstr, &GENUS, {76, 42, 38, 0},
                             0,  0,       0};
