 ...
 * -variables 4 -pipeline-latency 8 -n 32 -name t1sv_32 -include dft/simd/ts.h
 */
...
static void t1sv_32(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + (mb * 62); m < me; m = m + (2 * VL),
        ri = ri + ((2 * VL) * ms), ii = ii + ((2 * VL) * ms),
        W = W + ((2 * VL) * 62), MAKE_VOLATILE_STRIDE(64, rs)) {
      V T8, T8x, T3w, T87, Tl, T8y, T3B, T83, Tz, T6F, T3J, T5T, TM, T6G, T3Q;
      V T5U, T11, T1e, T6M, T6J, T6K, T6L, T3Z, T5X, T46, T5Y, T1s, T1F, T6O,
          T6P;
      V T6Q, T6R, T4e, T60, T4l, T61, T32, T7b, T78, T7N, T54, T6f, T5r, T6c,
          T29;
      V T70, T6X, T7I, T4v, T68, T4S, T65, T3t, T79, T7e, T7O, T5b, T5s, T5i,
          T5t;
      ...
      {
        V TO, T7C, T7Z, T80, T89, T8e, T1H, T8d, T3v, T8b, T7L, T7T, T7Q, T7U,
            T7F;
        V T81;
        {
          V Tm, TN, T7X, T7Y;
        ...
        }
        {
          ...
          T7S = VSUB(T7C, T7F);
          T7V = VSUB(T7T, T7U);
          ST(&(ri[WS(rs, 28)]), VFNMS(LDK(KP707106781), T7V, T7S), ms,
             &(ri[0]));
          ST(&(ri[WS(rs, 12)]), VFMA(LDK(KP707106781), T7V, T7S), ms, &(ri[0]));
          T8h = VSUB(T8e, T8d);
          T8i = VSUB(T7Q, T7L);
          ST(&(ii[WS(rs, 12)]), VFMA(LDK(KP707106781), T8i, T8h), ms, &(ii[0]));
          ST(&(ii[WS(rs, 28)]), VFNMS(LDK(KP707106781), T8i, T8h), ms,
             &(ii[0]));
        }
      }
      {
        V T6I, T7m, T7w, T7A, T8l, T8r, T6T, T8m, T75, T7j, T7p, T8s, T7t, T7z,
            T7g;
        V T7k;
        {
          V T6E, T6H, T7u, T7v;
        ...
        }
        {
          ...
          T7h = VSUB(T75, T7g);
          ST(&(ri[WS(rs, 22)]), VFNMS(LDK(KP923879532), T7h, T6U), ms,
             &(ri[0]));
          ...
          ST(&(ii[WS(rs, 22)]), VFNMS(LDK(KP923879532), T8u, T8t), ms,
             &(ii[0]));
        }
        {
          V T7i, T7l, T8v, T8w;
          ...
          T7l = VADD(T7j, T7k);
          ST(&(ri[WS(rs, 14)]), VFNMS(LDK(KP923879532), T7l, T7i), ms,
             &(ri[0]));
          ST(&(ri[WS(rs, 30)]), VFMA(LDK(KP923879532), T7l, T7i), ms, &(ri[0]));
          T8v = VFNMS(LDK(KP707106781), T8s, T8r);
          T8w = VADD(T75, T7g);
          ST(&(ii[WS(rs, 14)]), VFNMS(LDK(KP923879532), T8w, T8v), ms,
             &(ii[0]));
        ...
        }
        {
          ...
          T7x = VADD(T7t, T7w);
          ST(&(ri[WS(rs, 18)]), VFNMS(LDK(KP923879532), T7x, T7q), ms,
             &(ri[0]));
          ...
          ST(&(ii[WS(rs, 18)]), VFNMS(LDK(KP923879532), T8o, T8n), ms,
             &(ii[0]));
        }
        {
          V T7y, T7B, T8p, T8q;
          ...
          T7B = VSUB(T7z, T7A);
          ST(&(ri[WS(rs, 26)]), VFNMS(LDK(KP923879532), T7B, T7y), ms,
             &(ri[0]));
          ...
          ST(&(ii[WS(rs, 26)]), VFNMS(LDK(KP923879532), T8q, T8p), ms,
             &(ii[0]));
        }
      }
      {
        V T3S, T5C, T4n, T8C, T8B, T8H, T5F, T8I, T5w, T5Q, T5A, T5M, T4X, T5P,
            T5z;
        V T5J;
        {
          V T3C, T3R, T5D, T5E;
        ...
        }
        {
          ...
          T5x = VSUB(T4X, T5w);
          ST(&(ri[WS(rs, 21)]), VFNMS(LDK(KP831469612), T5x, T4o), ms,
             &(ri[WS(rs, 1)]));
          ST(&(ri[WS(rs, 5)]), VFMA(LDK(KP831469612), T5x, T4o), ms,
             &(ri[WS(rs, 1)]));
          T8J = VFMA(LDK(KP923879532), T8I, T8H);
          T8K = VSUB(T5A, T5z);
          ST(&(ii[WS(rs, 5)]), VFMA(LDK(KP831469612), T8K, T8J), ms,
             &(ii[WS(rs, 1)]));
          ST(&(ii[WS(rs, 21)]), VFNMS(LDK(KP831469612), T8K, T8J), ms,
             &(ii[WS(rs, 1)]));
        }
        {
          V T5y, T5B, T8L, T8M;
          ...
          T5B = VADD(T5z, T5A);
          ST(&(ri[WS(rs, 13)]), VFNMS(LDK(KP831469612), T5B, T5y), ms,
             &(ri[WS(rs, 1)]));
          ST(&(ri[WS(rs, 29)]), VFMA(LDK(KP831469612), T5B, T5y), ms,
             &(ri[WS(rs, 1)]));
          T8L = VFNMS(LDK(KP923879532), T8I, T8H);
          T8M = VADD(T4X, T5w);
          ST(&(ii[WS(rs, 13)]), VFNMS(LDK(KP831469612), T8M, T8L), ms,
             &(ii[WS(rs, 1)]));
          ST(&(ii[WS(rs, 29)]), VFMA(LDK(KP831469612), T8M, T8L), ms,
             &(ii[WS(rs, 1)]));
        }
        {
          V T5G, T5N, T8D, T8E;
          ...
          T5N = VADD(T5J, T5M);
          ST(&(ri[WS(rs, 17)]), VFNMS(LDK(KP980785280), T5N, T5G), ms,
             &(ri[WS(rs, 1)]));
          ST(&(ri[WS(rs, 1)]), VFMA(LDK(KP980785280), T5N, T5G), ms,
             &(ri[WS(rs, 1)]));
          T8D = VFMA(LDK(KP923879532), T8C, T8B);
          T8E = VADD(T5P, T5Q);
          ST(&(ii[WS(rs, 1)]), VFMA(LDK(KP980785280), T8E, T8D), ms,
             &(ii[WS(rs, 1)]));
          ST(&(ii[WS(rs, 17)]), VFNMS(LDK(KP980785280), T8E, T8D), ms,
             &(ii[WS(rs, 1)]));
        }
        {
          V T5O, T5R, T8F, T8G;
          ...
          T5R = VSUB(T5P, T5Q);
          ST(&(ri[WS(rs, 25)]), VFNMS(LDK(KP980785280), T5R, T5O), ms,
             &(ri[WS(rs, 1)]));
          ST(&(ri[WS(rs, 9)]), VFMA(LDK(KP980785280), T5R, T5O), ms,
             &(ri[WS(rs, 1)]));
          T8F = VFNMS(LDK(KP923879532), T8C, T8B);
          T8G = VSUB(T5M, T5J);
          ST(&(ii[WS(rs, 9)]), VFMA(LDK(KP980785280), T8G, T8F), ms,
             &(ii[WS(rs, 1)]));
          ST(&(ii[WS(rs, 25)]), VFNMS(LDK(KP980785280), T8G, T8F), ms,
             &(ii[WS(rs, 1)]));
        }
      }
      {
        V T5W, T6o, T63, T8W, T8P, T8V, T6r, T8Q, T6i, T6C, T6m, T6y, T6b, T6B,
            T6l;
        V T6v;
        {
          V T5S, T5V, T6p, T6q;
        ...
        }
        {
          ...
          T6j = VADD(T6b, T6i);
          ST(&(ri[WS(rs, 19)]), VFNMS(LDK(KP831469612), T6j, T64), ms,
             &(ri[WS(rs, 1)]));
          ST(&(ri[WS(rs, 3)]), VFMA(LDK(KP831469612), T6j, T64), ms,
             &(ri[WS(rs, 1)]));
          T8R = VFMA(LDK(KP923879532), T8Q, T8P);
          T8S = VADD(T6l, T6m);
          ST(&(ii[WS(rs, 3)]), VFMA(LDK(KP831469612), T8S, T8R), ms,
             &(ii[WS(rs, 1)]));
          ST(&(ii[WS(rs, 19)]), VFNMS(LDK(KP831469612), T8S, T8R), ms,
             &(ii[WS(rs, 1)]));
        }
        {
          V T6k, T6n, T8T, T8U;
          ...
          T6n = VSUB(T6l, T6m);
          ST(&(ri[WS(rs, 27)]), VFNMS(LDK(KP831469612), T6n, T6k), ms,
             &(ri[WS(rs, 1)]));
          ST(&(ri[WS(rs, 11)]), VFMA(LDK(KP831469612), T6n, T6k), ms,
             &(ri[WS(rs, 1)]));
          T8T = VFNMS(LDK(KP923879532), T8Q, T8P);
          T8U = VSUB(T6i, T6b);
          ST(&(ii[WS(rs, 11)]), VFMA(LDK(KP831469612), T8U, T8T), ms,
             &(ii[WS(rs, 1)]));
          ST(&(ii[WS(rs, 27)]), VFNMS(LDK(KP831469612), T8U, T8T), ms,
             &(ii[WS(rs, 1)]));
        }
        {
          V T6s, T6z, T8X, T8Y;
          ...
          T6z = VSUB(T6v, T6y);
          ST(&(ri[WS(rs, 23)]), VFNMS(LDK(KP980785280), T6z, T6s), ms,
             &(ri[WS(rs, 1)]));
          ST(&(ri[WS(rs, 7)]), VFMA(LDK(KP980785280), T6z, T6s), ms,
             &(ri[WS(rs, 1)]));
          T8X = VFNMS(LDK(KP923879532), T8W, T8V);
          T8Y = VSUB(T6C, T6B);
          ST(&(ii[WS(rs, 7)]), VFMA(LDK(KP980785280), T8Y, T8X), ms,
             &(ii[WS(rs, 1)]));
          ST(&(ii[WS(rs, 23)]), VFNMS(LDK(KP980785280), T8Y, T8X), ms,
             &(ii[WS(rs, 1)]));
        }
        {
          V T6A, T6D, T8Z, T90;
          ...
          T6D = VADD(T6B, T6C);
          ST(&(ri[WS(rs, 15)]), VFNMS(LDK(KP980785280), T6D, T6A), ms,
             &(ri[WS(rs, 1)]));
          ST(&(ri[WS(rs, 31)]), VFMA(LDK(KP980785280), T6D, T6A), ms,
             &(ri[WS(rs, 1)]));
          T8Z = VFMA(LDK(KP923879532), T8W, T8V);
          T90 = VADD(T6v, T6y);
          ST(&(ii[WS(rs, 15)]), VFNMS(LDK(KP980785280), T90, T8Z), ms,
             &(ii[WS(rs, 1)]));
          ST(&(ii[WS(rs, 31)]), VFMA(LDK(KP980785280), T90, T8Z), ms,
             &(ii[WS(rs, 1)]));
        }
      }
    }
...
static const tw_instr twinstr[] = {
    ...
    VTW(0, 13), VTW(0, 14), VTW(0, 15), VTW(0, 16),
    VTW(0, 17), VTW(0, 18), VTW(0, 19), VTW(0, 20),
    VTW(0, 21), VTW(0, 22), VTW(0, 23), VTW(0, 24),
    VTW(0, 25), VTW(0, 26), VTW(0, 27), VTW(0, 28),
    VTW(0, 29), VTW(0, 30), VTW(0, 31), {TW_NEXT, (2 * VL), 0}};

static const ct_desc desc = {
    32, XSIMD_STRING("t1sv_32"), twinstr, &GENUS, {236, 62, 198, 0}, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 32 -name t1sv_32 -include dft/simd/ts.h */
...
static void t1sv_32(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * 62); m < me; m = m + (2 * VL),
        ri = ri + ((2 * VL) * ms), ii = ii + ((2 * VL) * ms),
        W = W + ((2 * VL) * 62), MAKE_VOLATILE_STRIDE(64, rs)) {
      V Tj, T5F, T7C, T7Q, T35, T4T, T78, T7m, T1Q, T61, T5Y, T6J, T3K, T59,
          T41;
      V T56, T2B, T67, T6e, T6O, T4b, T5d, T4s, T5g, TG, T7l, T5I, T73, T3a,
          T4U;
      V T3f, T4V, T14, T5N, T5M, T6E, T3m, T4Y, T3r, T4Z, T1r, T5P, T5S, T6F,
          T3x;
      V T51, T3C, T52, T2d, T5Z, T64, T6K, T3V, T57, T44, T5a, T2Y, T6f, T6a,
          T6P;
      V T4m, T5h, T4v, T5e;
      {
      ...
      {
        V T5J, T7n, T7t, T6n, T5U, T7k, T6x, T6B, T6q, T7s, T66, T6k, T6u, T6A,
            T6h;
        V T6l;
        {
          V T5O, T5T, T60, T65;
      ...
      {
        V T3h, T4D, T7R, T7X, T3E, T7O, T4N, T4R, T46, T4A, T4G, T7W, T4K, T4Q,
            T4x;
        V T4B, T3g, T7P;
      ...
      {
        V T4X, T5p, T7D, T7J, T54, T7y, T5z, T5D, T5c, T5m, T5s, T7I, T5w, T5C,
            T5j;
        V T5n, T4W, T7z;
...
static const ct_desc desc = {
    32, XSIMD_STRING("t1sv_32"), twinstr, &GENUS, {340, 114, 94, 0}, 0, 0, 0};
