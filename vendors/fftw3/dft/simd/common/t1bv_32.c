 ...
 * -variables 4 -pipeline-latency 8 -n 32 -name t1bv_32 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_32(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    32, XSIMD_STRING("t1bv_32"), twinstr, &GENUS, {119, 62, 98, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 32 -name t1bv_32 -include dft/simd/t1b.h -sign 1 */
...
static void t1bv_32(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 62)); m < me; m = m + VL,
      ...
      V T3d, T1k, T20, T2y, T3a, T1r, T21, T2v, T39, TV, T1X, T2r, T37, T12,
          T1Y;
      V T2o, T36;
      {
...
static const ct_desc desc = {
    32, XSIMD_STRING("t1bv_32"), twinstr, &GENUS, {201, 88, 16, 0}, 0, 0, 0};
