 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 5 -name n1bv_5 -include
 * dft/simd/n1b.h */
...
static void n1bv_5(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    5, XSIMD_STRING("n1bv_5"), {7, 2, 9, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 5 -name n1bv_5 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {
    5, XSIMD_STRING("n1bv_5"), {13, 3, 3, 0}, &GENUS, 0, 0, 0, 0};
