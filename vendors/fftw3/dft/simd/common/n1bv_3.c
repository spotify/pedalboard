 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 3 -name n1bv_3 -include
 * dft/simd/n1b.h */
...
static void n1bv_3(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    3, XSIMD_STRING("n1bv_3"), {3, 1, 3, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 3 -name n1bv_3 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {
    3, XSIMD_STRING("n1bv_3"), {5, 1, 1, 0}, &GENUS, 0, 0, 0, 0};
