 ...
 * -variables 4 -pipeline-latency 8 -n 5 -name n1fv_5 -include dft/simd/n1f.h */
...
static void n1fv_5(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DVK(KP951056516, +0.951056516295153572116439333379382143405698634);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(10, is), MAKE_VOLATILE_STRIDE(10, os)) {
      V T1, T8, Td, Ta, Tc;
      T1 = LD(&(xi[0]), ivs, &(xi[0]));
      {
        V T2, T3, T4, T5, T6, T7;
...
static const kdft_desc desc = {
    5, XSIMD_STRING("n1fv_5"), {7, 2, 9, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 5 -name n1fv_5 -include dft/simd/n1f.h */
...
static const kdft_desc desc = {
    5, XSIMD_STRING("n1fv_5"), {13, 3, 3, 0}, &GENUS, 0, 0, 0, 0};
