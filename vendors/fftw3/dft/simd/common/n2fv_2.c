 ...
 * -variables 4 -pipeline-latency 8 -n 2 -name n2fv_2 -with-ostride 2 -include
...
static void n2fv_2(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    2, XSIMD_STRING("n2fv_2"), {2, 0, 0, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -n 2 -name n2fv_2 -with-ostride 2 -include dft/simd/n2f.h
 * -store-multiple 2 */
