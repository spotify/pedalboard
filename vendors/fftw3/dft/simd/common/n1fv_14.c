 ...
 * -variables 4 -pipeline-latency 8 -n 14 -name n1fv_14 -include dft/simd/n1f.h
 */
...
static void n1fv_14(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    14, XSIMD_STRING("n1fv_14"), {32, 6, 42, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 14 -name n1fv_14 -include dft/simd/n1f.h */
  ...
  DVK(KP974927912, +0.974927912181823607018131682993931217232785801);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
      ...
      ST(&(xo[0]), VADD(Ty, VADD(TB, VADD(TH, TE))), ovs, &(xo[0]));
      {
        V Tt, Tp, TP, TQ;
        Tt = VBYI(
            VFNMS(LDK(KP781831482), Tr,
                  VFNMS(LDK(KP433883739), Ts, VMUL(LDK(KP974927912), Tq))));
        Tp = VFMA(LDK(KP623489801), To,
                  VFNMS(LDK(KP900968867), Th, VFNMS(LDK(KP222520933), Ta, T3)));
        ST(&(xo[WS(os, 5)]), VSUB(Tp, Tt), ovs, &(xo[WS(os, 1)]));
        ST(&(xo[WS(os, 9)]), VADD(Tp, Tt), ovs, &(xo[WS(os, 1)]));
        TP = VBYI(VFMA(LDK(KP974927912), TJ,
                       VFMA(LDK(KP433883739), TL, VMUL(LDK(KP781831482), TK))));
        TQ = VFMA(LDK(KP623489801), TE,
                  VFNMS(LDK(KP900968867), TH, VFNMS(LDK(KP222520933), TB, Ty)));
        ST(&(xo[WS(os, 2)]), VADD(TP, TQ), ovs, &(xo[0]));
        ST(&(xo[WS(os, 12)]), VSUB(TQ, TP), ovs, &(xo[0]));
      }
      {
        V Tv, Tu, TM, TI;
        Tv = VBYI(VFMA(LDK(KP781831482), Tq,
                       VFMA(LDK(KP974927912), Ts, VMUL(LDK(KP433883739), Tr))));
        Tu = VFMA(LDK(KP623489801), Ta,
                  VFNMS(LDK(KP900968867), To, VFNMS(LDK(KP222520933), Th, T3)));
        ...
        TI = VFMA(LDK(KP623489801), TB,
                  VFNMS(LDK(KP900968867), TE, VFNMS(LDK(KP222520933), TH, Ty)));
      ...
      }
      {
        ...
        TN = VFMA(LDK(KP623489801), TH,
                  VFNMS(LDK(KP222520933), TE, VFNMS(LDK(KP900968867), TB, Ty)));
        ST(&(xo[WS(os, 4)]), VSUB(TN, TO), ovs, &(xo[0]));
        ST(&(xo[WS(os, 10)]), VADD(TO, TN), ovs, &(xo[0]));
        Tx =
            VBYI(VFMA(LDK(KP433883739), Tq,
                      VFNMS(LDK(KP781831482), Ts, VMUL(LDK(KP974927912), Tr))));
        Tw = VFMA(LDK(KP623489801), Th,
                  VFNMS(LDK(KP222520933), To, VFNMS(LDK(KP900968867), Ta, T3)));
...
static const kdft_desc desc = {
    14, XSIMD_STRING("n1fv_14"), {50, 12, 24, 0}, &GENUS, 0, 0, 0, 0};
