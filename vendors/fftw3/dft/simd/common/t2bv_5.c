 ...
 * -variables 4 -pipeline-latency 8 -n 5 -name t2bv_5 -include dft/simd/t2b.h
 * -sign 1 */
...
static void t2bv_5(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
...
static const ct_desc desc = {
    5, XSIMD_STRING("t2bv_5"), twinstr, &GENUS, {11, 10, 9, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 5 -name t2bv_5 -include dft/simd/t2b.h -sign 1 */
...
static const ct_desc desc = {
    5, XSIMD_STRING("t2bv_5"), twinstr, &GENUS, {17, 11, 3, 0}, 0, 0, 0};
