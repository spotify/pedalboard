 ...
 * -variables 4 -pipeline-latency 8 -n 10 -name n1fv_10 -include dft/simd/n1f.h
 */
...
static void n1fv_10(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    10, XSIMD_STRING("n1fv_10"), {24, 4, 18, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 10 -name n1fv_10 -include dft/simd/n1f.h */
...
static const kdft_desc desc = {
    10, XSIMD_STRING("n1fv_10"), {36, 6, 6, 0}, &GENUS, 0, 0, 0, 0};
