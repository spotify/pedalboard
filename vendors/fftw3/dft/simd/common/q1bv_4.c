 ...
 * -variables 4 -pipeline-latency 8 -n 4 -dif -name q1bv_4 -include
...
static void q1bv_4(R *ri, R *ii, const R *W, stride rs, stride vs, INT mb,
                   INT me, INT ms) {
  {
    INT m;
    R *x;
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 6)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 6), MAKE_VOLATILE_STRIDE(8, rs),
        MAKE_VOLATILE_STRIDE(8, vs)) {
...
static const tw_instr twinstr[] = {
    VTW(0, 1), VTW(0, 2), VTW(0, 3), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    4, XSIMD_STRING("q1bv_4"), twinstr, &GENUS, {36, 24, 8, 0}, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 4 -dif -name q1bv_4 -include dft/simd/q1b.h -sign 1 */
...
static const ct_desc desc = {
    4, XSIMD_STRING("q1bv_4"), twinstr, &GENUS, {44, 24, 0, 0}, 0, 0, 0};
