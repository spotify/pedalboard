 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 10 -name n2bv_10 -with-ostride 2
...
static void n2bv_10(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP951056516, +0.951056516295153572116439333379382143405698634);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(20, is), MAKE_VOLATILE_STRIDE(20, os)) {
...
static const kdft_desc desc = {
    10, XSIMD_STRING("n2bv_10"), {24, 4, 18, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 10 -name n2bv_10 -with-ostride 2 -include
...
static const kdft_desc desc = {
    10, XSIMD_STRING("n2bv_10"), {36, 6, 6, 0}, &GENUS, 0, 2, 0, 0};
