 ...
 * -variables 4 -pipeline-latency 8 -n 12 -name n2fv_12 -with-ostride 2 -include
...
static void n2fv_12(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    12, XSIMD_STRING("n2fv_12"), {30, 2, 18, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -n 12 -name n2fv_12 -with-ostride 2 -include
 * dft/simd/n2f.h -store-multiple 2 */
...
static const kdft_desc desc = {
    12, XSIMD_STRING("n2fv_12"), {44, 4, 4, 0}, &GENUS, 0, 2, 0, 0};
