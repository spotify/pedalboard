 ...
 * -variables 4 -pipeline-latency 8 -n 20 -name t2fv_20 -include dft/simd/t2f.h
 */
...
static void t2fv_20(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    20, XSIMD_STRING("t2fv_20"), twinstr, &GENUS, {77, 42, 46, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 20 -name t2fv_20 -include dft/simd/t2f.h */
...
static const ct_desc desc = {
    20, XSIMD_STRING("t2fv_20"), twinstr, &GENUS, {111, 50, 12, 0}, 0, 0, 0};
