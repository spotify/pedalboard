...
static void q1fv_4(R *ri, R *ii, const R *W, stride rs, stride vs, INT mb,
                   INT me, INT ms) {
  {
    INT m;
    R *x;
...
static const ct_desc desc = {
    4, XSIMD_STRING("q1fv_4"), twinstr, &GENUS, {36, 24, 8, 0}, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 4 -dif -name q1fv_4 -include dft/simd/q1f.h */
...
static const ct_desc desc = {
    4, XSIMD_STRING("q1fv_4"), twinstr, &GENUS, {44, 24, 0, 0}, 0, 0, 0};
