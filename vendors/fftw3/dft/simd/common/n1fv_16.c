 ...
 * -variables 4 -pipeline-latency 8 -n 16 -name n1fv_16 -include dft/simd/n1f.h
 */
...
static void n1fv_16(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    16, XSIMD_STRING("n1fv_16"), {38, 0, 34, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 16 -name n1fv_16 -include dft/simd/n1f.h */
...
static const kdft_desc desc = {
    16, XSIMD_STRING("n1fv_16"), {68, 8, 4, 0}, &GENUS, 0, 0, 0, 0};
