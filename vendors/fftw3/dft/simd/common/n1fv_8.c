 ...
 * -variables 4 -pipeline-latency 8 -n 8 -name n1fv_8 -include dft/simd/n1f.h */
...
static void n1fv_8(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    8, XSIMD_STRING("n1fv_8"), {16, 0, 10, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 8 -name n1fv_8 -include dft/simd/n1f.h */
...
static const kdft_desc desc = {
    8, XSIMD_STRING("n1fv_8"), {26, 2, 0, 0}, &GENUS, 0, 0, 0, 0};
