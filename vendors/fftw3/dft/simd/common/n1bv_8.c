 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 8 -name n1bv_8 -include
 * dft/simd/n1b.h */
...
static void n1bv_8(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    8, XSIMD_STRING("n1bv_8"), {16, 0, 10, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 8 -name n1bv_8 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {
    8, XSIMD_STRING("n1bv_8"), {26, 2, 0, 0}, &GENUS, 0, 0, 0, 0};
