 ...
 * -no-generate-bytw -n 10 -name t3bv_10 -include dft/simd/t3b.h -sign 1 */
...
static void t3bv_10(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    10, XSIMD_STRING("t3bv_10"), twinstr, &GENUS, {39, 34, 18, 0}, 0, 0, 0};
 ...
 * 10 -name t3bv_10 -include dft/simd/t3b.h -sign 1 */
...
static const ct_desc desc = {
    10, XSIMD_STRING("t3bv_10"), twinstr, &GENUS, {51, 36, 6, 0}, 0, 0, 0};
