 ...
 * -variables 4 -pipeline-latency 8 -n 32 -name n2fv_32 -with-ostride 2 -include
...
static void n2fv_32(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    32, XSIMD_STRING("n2fv_32"), {88, 0, 98, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -n 32 -name n2fv_32 -with-ostride 2 -include
 * dft/simd/n2f.h -store-multiple 2 */
...
static const kdft_desc desc = {
    32, XSIMD_STRING("n2fv_32"), {170, 26, 16, 0}, &GENUS, 0, 2, 0, 0};
