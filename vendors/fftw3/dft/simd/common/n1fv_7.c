 ...
 * -variables 4 -pipeline-latency 8 -n 7 -name n1fv_7 -include dft/simd/n1f.h */
...
static void n1fv_7(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    7, XSIMD_STRING("n1fv_7"), {9, 3, 21, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 7 -name n1fv_7 -include dft/simd/n1f.h */
...
static void n1fv_7(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DVK(KP433883739, +0.433883739117558120475768332848358754609990728);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
      ...
      ST(&(xo[0]), VADD(T1, VADD(T4, VADD(T7, Ta))), ovs, &(xo[0]));
      Tj = VBYI(VFMA(LDK(KP433883739), Tc,
                     VFNMS(LDK(KP781831482), Te, VMUL(LDK(KP974927912), Td))));
      Ti = VFMA(LDK(KP623489801), T7,
                VFNMS(LDK(KP222520933), Ta, VFNMS(LDK(KP900968867), T4, T1)));
      ST(&(xo[WS(os, 4)]), VSUB(Ti, Tj), ovs, &(xo[0]));
      ST(&(xo[WS(os, 3)]), VADD(Ti, Tj), ovs, &(xo[WS(os, 1)]));
      {
        V Tf, Tb, Th, Tg;
        Tf = VBYI(
            VFNMS(LDK(KP781831482), Td,
                  VFNMS(LDK(KP433883739), Te, VMUL(LDK(KP974927912), Tc))));
        Tb = VFMA(LDK(KP623489801), Ta,
                  VFNMS(LDK(KP900968867), T7, VFNMS(LDK(KP222520933), T4, T1)));
        ST(&(xo[WS(os, 5)]), VSUB(Tb, Tf), ovs, &(xo[WS(os, 1)]));
        ST(&(xo[WS(os, 2)]), VADD(Tb, Tf), ovs, &(xo[0]));
        Th = VBYI(VFMA(LDK(KP781831482), Tc,
                       VFMA(LDK(KP974927912), Te, VMUL(LDK(KP433883739), Td))));
        Tg = VFMA(LDK(KP623489801), T4,
                  VFNMS(LDK(KP900968867), Ta, VFNMS(LDK(KP222520933), T7, T1)));
...
static const kdft_desc desc = {
    7, XSIMD_STRING("n1fv_7"), {18, 6, 12, 0}, &GENUS, 0, 0, 0, 0};
