 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 128 -name n1bv_128 -include
 * dft/simd/n1b.h */
...
static void n1bv_128(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP414213562, +0.414213562373095048801688724209698078569671875);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(256, is), MAKE_VOLATILE_STRIDE(256, os)) {
      V Tr, T5J, Ted, Tgf, Tfq, TgG, T4U, T6a, T6Z, T8T, Tad, TcZ, Tcc, Td0,
          T84;
      V T9k, Tb6, Tbt, T2G, T5U, TeV, Tgt, T3p, T5X, T7B, T97, TeK, Tgq, T7q,
          T94;
      V Td8, TdK, TbD, Tc0, T3V, T61, Tfg, TgA, T4E, T64, T7U, T9e, Tf5, Tgx,
          T7J;
      V T9b, Tdf, TdN, Td2, Td3, TI, T4V, Tft, Tgg, TZ, T4W, T75, T86, Tek, TgH;
      V T72, T85, Tas, Tcd, Tdm, Tdn, TdG, Teq, Tgj, Tet, Tgi, T1s, T5N, T1B,
          T5M;
      V T7d, T8W, TaI, Tcf, T7a, T8X, Tdp, Tdq, TdH, Tez, Tgm, TeC, Tgl, T23,
          T5Q;
      V T2c, T5P, T7k, T8Z, TaX, Tcg, T7h, T90, Tbl, Tbu, Tdb, TdL, TeY, Tgr,
          TeR;
      V Tgu, T7x, T98, T7E, T95, T3f, T5Y, T3s, T5V, TbS, Tc1, Tdi, TdO, Tfj,
          Tgy;
      V Tfc, TgB, T7Q, T9f, T7X, T9c, T4u, T65, T4H, T62;
      {
        V T3, Ta7, T4O, Ta8, Ta, Tab, T4P, Taa, Tc6, Tc7, Ti, Tea, T4R, Tc9,
            Tca;
        V Tp, Teb, T4S;
        {
          V T1, T2, T4M, T4N;
      ...
      {
        V Tb0, Tb1, T2i, Tb2, T3j, Tb3, Tb4, T2p, Tb5, T3k, T2x, TeH, T3m, Tbp,
            T2E;
      ...
      {
        V Tbx, Tby, T3x, Tbz, T4y, TbA, TbB, T3E, TbC, T4z, T3M, Tf2, T4B, TbZ,
            T3T;
      ...
      {
        V Tau, Tav, T14, Taw, T1v, Tax, Tay, T1b, Taz, T1w, T1j, Ten, T1y, TaD,
            T1q;
      ...
      {
        V TaJ, TaK, T1F, TaL, T26, TaM, TaN, T1M, TaO, T27, T1U, Tew, T29, TaV,
            T21;
      ...
      {
        V T2J, TeL, T2U, Tb9, T30, TeO, T3b, Tbg, T2Q, TeM, T2V, Tbc, T37, TeP,
            T3c;
        V Tbj;
        {
      ...
      {
        V T3Y, Tf6, T49, TbG, T4f, Tf9, T4q, TbN, T45, Tf7, T4a, TbJ, T4m, Tfa,
            T4r;
        V TbQ;
        {
      ...
      {
        V TeF, Tga, TfF, Tg0, Tfy, Tg7, TfI, TfP, Tfm, TfJ, TfB, TfG, TfW, Tgb,
            Tg3;
        V Tg8;
        {
      ...
      {
        V Tgp, Tho, TgT, The, TgM, Thl, TgW, Th3, TgE, TgX, TgP, TgU, Tha, Thp,
            Thh;
        V Thm;
        {
      ...
      {
        V T80, T8n, T8f, T8k, T8A, T8P, T8H, T8M, T7n, T8L, T8O, T8c, T8j, T8t,
            T8E;
        V T8m;
        {
          V T7G, T8d, T7Z, T8e;
      ...
      {
        V T4K, T5d, T55, T5a, T5q, T5F, T5x, T5C, T2f, T5B, T5E, T52, T59, T5j,
            T5u;
        V T5c;
        {
          V T3u, T53, T4J, T54;
      ...
      {
        V T9i, T9B, T9t, T9y, T9O, Ta3, T9V, Ta0, T93, T9Z, Ta2, T9q, T9x, T9H,
            T9S;
        V T9A;
        {
          V T9a, T9r, T9h, T9s;
      ...
      {
        V T68, T6r, T6j, T6o, T6E, T6T, T6L, T6Q, T5T, T6P, T6S, T6g, T6n, T6x,
            T6I;
        V T6q;
        {
          V T60, T6h, T67, T6i;
...
static const kdft_desc desc = {
    128, XSIMD_STRING("n1bv_128"), {440, 0, 642, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 128 -name n1bv_128 -include dft/simd/n1b.h */
...
static void n1bv_128(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(256, is), MAKE_VOLATILE_STRIDE(256, os)) {
      V T49, T6e, Tev, TgK, TfA, TgL, T4U, T5J, T7R, T9o, Tah, TdG, Tcw, TdB,
          T84;
      V T8T, Tfk, Tfo, T1G, T64, Tgs, Th6, T2p, T62, T7t, T9c, Tce, Tdm, T7i,
          T9e;
      V Tc8, Tdp, TgF, TgG, T4q, T4V, TeC, Tfx, T4H, T4W, T7X, T86, Tcr, TdH,
          T7U;
      V T85, Taw, TdC, Tf3, Tf7, Tr, T5X, Tgl, Th3, T1a, T5V, T7a, T95, TbD,
          Tdf;
      V T6Z, T97, Tbx, Tdi, Tgy, Tgz, TgA, TaN, Tdv, TeK, Tfu, T2W, T5M, T35,
          T5N;
      V T7F, T8X, TaI, Tdu, T7C, T8W, TgB, TgC, TgD, Tb4, Tdy, TeR, Tfv, T3x,
          T5P;
      V T3G, T5Q, T7M, T90, TaZ, Tdx, T7J, T8Z, Tbm, Tdg, TbG, Tdj, Tgo, Th4,
          Tf0;
      V Tf8, T76, T98, T7d, T94, T10, T5Y, T1d, T5U, TbX, Tdn, Tch, Tdq, Tgv,
          Th7;
      V Tfh, Tfp, T7p, T9f, T7w, T9b, T2f, T65, T2s, T61;
      {
        V T47, Ta8, T4O, Ta7, T44, Tcu, T4P, Tct, Taa, Tab, T3P, Tac, T4R, Tad,
            Tae;
        V T3W, Taf, T4S;
        {
          V T45, T46, T4M, T4N;
      ...
      {
        V Tca, Tcb, T1i, Tfm, T2n, Tc5, Tc6, T1p, Tfn, T2k, T1x, Tfi, T2h, Tc0,
            T1E;
      ...
      {
        V T4c, Tew, T4o, Tak, T4A, Tez, T4E, Tau, T4j, Tex, T4l, Tan, T4x, TeA,
            T4F;
        V Tar, Tcp, Tcq;
        {
      ...
      {
        V TaK, TaJ, T2U, TeE, T2Z, TaF, TaG, T2R, TeF, T30, T2C, TeH, T32, TaA,
            T2J;
      ...
      {
        V Tb1, Tb0, T3v, TeO, T3A, TaW, TaX, T3s, TeP, T3B, T3d, TeL, T3D, TaR,
            T3k;
      ...
      {
        V T1Q, Tfb, T1U, TbL, T27, Tfe, T2b, TbS, T1N, Tfc, T1V, TbO, T24, Tff,
            T2c;
        V TbV;
        {
      ...
      {
        V Tb7, Td8, TcI, Td0, Tcy, Tda, TcG, TcP, Tck, TcJ, TcB, TcF, TcW, Tdb,
            Td3;
        V Td7;
        {
      ...
      {
        V TdE, Tel, TdW, Tee, TdM, Teo, TdT, Tea, Tdt, TdX, TdP, TdU, Te7, Tep,
            Teh;
        V Tem;
        {
      ...
      {
        V T7z, T8n, T8f, T8k, T8x, T8P, T8H, T8M, T80, T8L, T8O, T8c, T8j, T8A,
            T8E;
        V T8m;
        {
          V T7f, T8d, T7y, T8e;
      ...
      {
        V T2v, T5d, T55, T5a, T5n, T5F, T5x, T5C, T4K, T5B, T5E, T52, T59, T5q,
            T5u;
        V T5c;
        {
          V T1f, T53, T2u, T54;
      ...
      {
        V T9i, T9B, T9t, T9x, T9O, Ta3, T9V, T9Z, T93, Ta0, Ta2, T9q, T9y, T9H,
            T9S;
        V T9A;
        {
          V T9a, T9r, T9h, T9s;
      ...
      {
        V T68, T6r, T6j, T6n, T6E, T6T, T6L, T6P, T5T, T6Q, T6S, T6g, T6o, T6x,
            T6I;
        V T6q;
        {
          V T60, T6h, T67, T6i;
...
static const kdft_desc desc = {
    128, XSIMD_STRING("n1bv_128"), {938, 186, 144, 0}, &GENUS, 0, 0, 0, 0};
