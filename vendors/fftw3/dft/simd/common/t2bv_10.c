 ...
 * -variables 4 -pipeline-latency 8 -n 10 -name t2bv_10 -include dft/simd/t2b.h
 * -sign 1 */
...
static void t2bv_10(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP250000000, +0.250000000000000000000000000000000000000000000);
  {
    ...
    R *x;
    x = ii;
    for (m = mb, W = W + (mb * ((TWVL / VL) * 18)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 18), MAKE_VOLATILE_STRIDE(10, rs)) {
...
static const tw_instr twinstr[] = {
    ...
    VTW(0, 6), VTW(0, 7), VTW(0, 8), VTW(0, 9), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    10, XSIMD_STRING("t2bv_10"), twinstr, &GENUS, {33, 22, 18, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 10 -name t2bv_10 -include dft/simd/t2b.h -sign 1 */
...
static const ct_desc desc = {
    10, XSIMD_STRING("t2bv_10"), twinstr, &GENUS, {45, 24, 6, 0}, 0, 0, 0};
