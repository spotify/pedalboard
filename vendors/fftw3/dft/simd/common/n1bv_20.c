 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 20 -name n1bv_20 -include
 * dft/simd/n1b.h */
...
static void n1bv_20(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    20, XSIMD_STRING("n1bv_20"), {58, 4, 46, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 20 -name n1bv_20 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {
    20, XSIMD_STRING("n1bv_20"), {92, 12, 12, 0}, &GENUS, 0, 0, 0, 0};
