 ...
 * -variables 4 -pipeline-latency 8 -n 2 -name t2bv_2 -include dft/simd/t2b.h
 * -sign 1 */
...
static void t2bv_2(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  {
    INT m;
    R *x;
...
static const ct_desc desc = {
    2, XSIMD_STRING("t2bv_2"), twinstr, &GENUS, {3, 2, 0, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 2 -name t2bv_2 -include dft/simd/t2b.h -sign 1 */
