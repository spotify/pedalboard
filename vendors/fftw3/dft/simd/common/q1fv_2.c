 ...
 * -variables 4 -pipeline-latency 8 -n 2 -dif -name q1fv_2 -include
 * dft/simd/q1f.h */
...
static void q1fv_2(R *ri, R *ii, const R *W, stride rs, stride vs, INT mb,
                   INT me, INT ms) {
  {
    INT m;
    R *x;
...
static const ct_desc desc = {
    2, XSIMD_STRING("q1fv_2"), twinstr, &GENUS, {6, 4, 0, 0}, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 2 -dif -name q1fv_2 -include dft/simd/q1f.h */
