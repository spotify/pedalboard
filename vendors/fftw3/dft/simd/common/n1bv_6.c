 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 6 -name n1bv_6 -include
 * dft/simd/n1b.h */
...
static void n1bv_6(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    6, XSIMD_STRING("n1bv_6"), {12, 2, 6, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 6 -name n1bv_6 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {
    6, XSIMD_STRING("n1bv_6"), {16, 2, 2, 0}, &GENUS, 0, 0, 0, 0};
