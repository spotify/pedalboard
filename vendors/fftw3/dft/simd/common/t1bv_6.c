 ...
 * -variables 4 -pipeline-latency 8 -n 6 -name t1bv_6 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_6(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
...
static const ct_desc desc = {
    6, XSIMD_STRING("t1bv_6"), twinstr, &GENUS, {17, 12, 6, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 6 -name t1bv_6 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {
    6, XSIMD_STRING("t1bv_6"), twinstr, &GENUS, {21, 12, 2, 0}, 0, 0, 0};
