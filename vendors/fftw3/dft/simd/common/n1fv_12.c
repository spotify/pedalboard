 ...
 * -variables 4 -pipeline-latency 8 -n 12 -name n1fv_12 -include dft/simd/n1f.h
 */
...
static void n1fv_12(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    12, XSIMD_STRING("n1fv_12"), {30, 2, 18, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 12 -name n1fv_12 -include dft/simd/n1f.h */
...
static const kdft_desc desc = {
    12, XSIMD_STRING("n1fv_12"), {44, 4, 4, 0}, &GENUS, 0, 0, 0, 0};
