 ...
 * -variables 4 -pipeline-latency 8 -n 3 -name n1fv_3 -include dft/simd/n1f.h */
...
static void n1fv_3(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DVK(KP866025403, +0.866025403784438646763723170752936183471402627);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(6, is), MAKE_VOLATILE_STRIDE(6, os)) {
      V T1, T4, T6, T2, T3, T5;
      T1 = LD(&(xi[0]), ivs, &(xi[0]));
...
static const kdft_desc desc = {
    3, XSIMD_STRING("n1fv_3"), {3, 1, 3, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 3 -name n1fv_3 -include dft/simd/n1f.h */
...
static const kdft_desc desc = {
    3, XSIMD_STRING("n1fv_3"), {5, 1, 1, 0}, &GENUS, 0, 0, 0, 0};
