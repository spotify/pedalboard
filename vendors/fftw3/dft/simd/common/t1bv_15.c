 ...
 * -variables 4 -pipeline-latency 8 -n 15 -name t1bv_15 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_15(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    R *x;
    x = ii;
    for (m = mb, W = W + (mb * ((TWVL / VL) * 28)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 28), MAKE_VOLATILE_STRIDE(15, rs)) {
...
static const tw_instr twinstr[] = {
    ...
    VTW(0, 11), VTW(0, 12), VTW(0, 13), VTW(0, 14), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    15, XSIMD_STRING("t1bv_15"), twinstr, &GENUS, {50, 35, 42, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 15 -name t1bv_15 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {
    15, XSIMD_STRING("t1bv_15"), twinstr, &GENUS, {78, 39, 14, 0}, 0, 0, 0};
