 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 32 -name n2bv_32 -with-ostride 2
...
static void n2bv_32(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(64, is), MAKE_VOLATILE_STRIDE(64, os)) {
...
static const kdft_desc desc = {
    32, XSIMD_STRING("n2bv_32"), {88, 0, 98, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 32 -name n2bv_32 -with-ostride 2 -include
...
static const kdft_desc desc = {
    32, XSIMD_STRING("n2bv_32"), {170, 26, 16, 0}, &GENUS, 0, 2, 0, 0};
