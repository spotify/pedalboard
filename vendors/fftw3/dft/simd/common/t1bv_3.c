 ...
 * -variables 4 -pipeline-latency 8 -n 3 -name t1bv_3 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_3(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
...
static const ct_desc desc = {
    3, XSIMD_STRING("t1bv_3"), twinstr, &GENUS, {5, 5, 3, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 3 -name t1bv_3 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {
    3, XSIMD_STRING("t1bv_3"), twinstr, &GENUS, {7, 5, 1, 0}, 0, 0, 0};
