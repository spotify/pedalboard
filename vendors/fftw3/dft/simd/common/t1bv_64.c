 ...
 * -variables 4 -pipeline-latency 8 -n 64 -name t1bv_64 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_64(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    64, XSIMD_STRING("t1bv_64"), twinstr, &GENUS, {261, 126, 258, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 64 -name t1bv_64 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {
    64, XSIMD_STRING("t1bv_64"), twinstr, &GENUS, {467, 198, 52, 0}, 0, 0, 0};
