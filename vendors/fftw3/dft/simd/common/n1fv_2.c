 ...
 * -variables 4 -pipeline-latency 8 -n 2 -name n1fv_2 -include dft/simd/n1f.h */
...
static void n1fv_2(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    2, XSIMD_STRING("n1fv_2"), {2, 0, 0, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 2 -name n1fv_2 -include dft/simd/n1f.h */
