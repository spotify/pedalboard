 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 20 -name n2bv_20 -with-ostride 2
...
static void n2bv_20(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP250000000, +0.250000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(40, is), MAKE_VOLATILE_STRIDE(40, os)) {
...
static const kdft_desc desc = {
    20, XSIMD_STRING("n2bv_20"), {58, 4, 46, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 20 -name n2bv_20 -with-ostride 2 -include
      ...
      }
      {
        ...
        }
        {
          V T1O, T1P, T1R, T1S;
          {
            ...
            T1e = VSUB(T1a, T1d);
            T1f =
                VBYI(VFNMS(LDK(KP951056516), T1e, VMUL(LDK(KP587785252), T17)));
            T1p =
                VBYI(VFMA(LDK(KP951056516), T17, VMUL(LDK(KP587785252), T1e)));
            T1O = VADD(T1i, T1l);
            STM2(&(xo[20]), T1O, ovs, &(xo[0]));
            T1q = VADD(T1n, T1m);
            T1P = VADD(T1p, T1q);
...
static const kdft_desc desc = {
    20, XSIMD_STRING("n2bv_20"), {92, 12, 12, 0}, &GENUS, 0, 2, 0, 0};
