 ...
 * -variables 4 -pipeline-latency 8 -n 8 -dif -name q1fv_8 -include
 * dft/simd/q1f.h */
...
static void q1fv_8(R *ri, R *ii, const R *W, stride rs, stride vs, INT mb,
                   INT me, INT ms) {
...
static const ct_desc desc = {
    8, XSIMD_STRING("q1fv_8"), twinstr, &GENUS, {184, 112, 80, 0}, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 8 -dif -name q1fv_8 -include dft/simd/q1f.h */
...
static const ct_desc desc = {
    8, XSIMD_STRING("q1fv_8"), twinstr, &GENUS, {264, 128, 0, 0}, 0, 0, 0};
