 ...
 * -variables 4 -pipeline-latency 8 -n 2 -name t1fuv_2 -include dft/simd/t1fu.h
 */
...
static void t1fuv_2(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  {
    INT m;
    R *x;
...
static const ct_desc desc = {
    2, XSIMD_STRING("t1fuv_2"), twinstr, &GENUS, {3, 2, 0, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 2 -name t1fuv_2 -include dft/simd/t1fu.h */
