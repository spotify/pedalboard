 ...
 * -variables 4 -pipeline-latency 8 -n 9 -name t1buv_9 -include dft/simd/t1bu.h
 * -sign 1 */
...
static void t1buv_9(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    9, XSIMD_STRING("t1buv_9"), twinstr, &GENUS, {20, 20, 34, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 9 -name t1buv_9 -include dft/simd/t1bu.h -sign 1 */
  ...
  DVK(KP866025403, +0.866025403784438646763723170752936183471402627);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 16)); m < me; m = m + VL,
      ...
      }
      {
        ...
        TC = VBYI(VSUB(
            VFMA(LDK(KP984807753), Tf,
                 VFMA(LDK(KP813797681), Tq,
                      VFNMS(LDK(KP150383733), Tg, VMUL(LDK(KP342020143), Tp)))),
            Tu));
        ...
        TB = VFMA(
            LDK(KP852868531), Tg,
            VFMA(LDK(KP173648177), Tf,
                 VFMA(LDK(KP296198132), Tq, VFNMS(LDK(KP939692620), Tp, T7))));
        ...
        ST(&(x[WS(rs, 2)]), VADD(TB, TC), ms, &(x[0]));
        {
          ...
          Tz = VBYI(VADD(Tu, VFNMS(LDK(KP500000000), Tx,
                                   VMUL(LDK(KP866025403), VSUB(Th, Tr)))));
          TA = VFMA(LDK(KP866025403), VSUB(Tw, Tv),
                    VFNMS(LDK(KP500000000), Ts, T7));
...
static const ct_desc desc = {
    9, XSIMD_STRING("t1buv_9"), twinstr, &GENUS, {38, 26, 16, 0}, 0, 0, 0};
