 ...
 * -variables 4 -pipeline-latency 8 -n 8 -name t1fuv_8 -include dft/simd/t1fu.h
 */
...
static void t1fuv_8(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    8, XSIMD_STRING("t1fuv_8"), twinstr, &GENUS, {23, 14, 10, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 8 -name t1fuv_8 -include dft/simd/t1fu.h */
...
static const ct_desc desc = {
    8, XSIMD_STRING("t1fuv_8"), twinstr, &GENUS, {33, 16, 0, 0}, 0, 0, 0};
