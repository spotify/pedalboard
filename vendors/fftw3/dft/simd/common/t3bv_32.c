 ...
 * -no-generate-bytw -n 32 -name t3bv_32 -include dft/simd/t3b.h -sign 1 */
...
static void t3bv_32(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP414213562, +0.414213562373095048801688724209698078569671875);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 8)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 8), MAKE_VOLATILE_STRIDE(32, rs)) {
      ...
      T1c = VZMUL(T4, T7);
      {
        ...
        V T3y, T1N, T2v, T3a, T3G, T1V, T2w, T37, T3F, T1j, T2s, T33, T3D, T1r,
            T2t;
        V T30, T3C;
        {
...
static const tw_instr twinstr[] = {
    VTW(0, 1), VTW(0, 3), VTW(0, 9), VTW(0, 27), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    32, XSIMD_STRING("t3bv_32"), twinstr, &GENUS, {146, 116, 98, 0}, 0, 0, 0};
 ...
 * 32 -name t3bv_32 -include dft/simd/t3b.h -sign 1 */
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 8)); m < me; m = m + VL,
      ...
      T1f = VZMULJ(T4, T7);
      {
        ...
        V T3I, T1M, T2v, T33, T3F, T1V, T2w, T30, T3E, T1j, T2s, T2W, T3C, T1r,
            T2t;
        V T2T, T3B;
        {
...
static const ct_desc desc = {
    32, XSIMD_STRING("t3bv_32"), twinstr, &GENUS, {228, 142, 16, 0}, 0, 0, 0};
