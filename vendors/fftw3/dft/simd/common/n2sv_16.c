 ...
 * 4 -pipeline-latency 8 -n 16 -name n2sv_16 -with-ostride 1 -include
...
static void n2sv_16(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - (2 * VL), ri = ri + ((2 * VL) * ivs),
        ...
        io = io + ((2 * VL) * ovs), MAKE_VOLATILE_STRIDE(64, is),
        MAKE_VOLATILE_STRIDE(64, os)) {
...
static const kdft_desc desc = {
    16, XSIMD_STRING("n2sv_16"), {104, 0, 40, 0}, &GENUS, 0, 1, 0, 0};
 ...
 * -pipeline-latency 8 -n 16 -name n2sv_16 -with-ostride 1 -include
 * dft/simd/n2s.h -store-multiple 4 */
...
static const kdft_desc desc = {
    16, XSIMD_STRING("n2sv_16"), {136, 16, 8, 0}, &GENUS, 0, 1, 0, 0};
