 ...
 * -variables 4 -pipeline-latency 8 -n 4 -name t2fv_4 -include dft/simd/t2f.h */
...
static void t2fv_4(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  {
    INT m;
    R *x;
...
static const ct_desc desc = {
    4, XSIMD_STRING("t2fv_4"), twinstr, &GENUS, {9, 6, 2, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 4 -name t2fv_4 -include dft/simd/t2f.h */
...
static const ct_desc desc = {
    4, XSIMD_STRING("t2fv_4"), twinstr, &GENUS, {11, 6, 0, 0}, 0, 0, 0};
