 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 16 -name n2bv_16 -with-ostride 2
...
static void n2bv_16(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    16, XSIMD_STRING("n2bv_16"), {38, 0, 34, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 16 -name n2bv_16 -with-ostride 2 -include
...
static const kdft_desc desc = {
    16, XSIMD_STRING("n2bv_16"), {68, 8, 4, 0}, &GENUS, 0, 2, 0, 0};
