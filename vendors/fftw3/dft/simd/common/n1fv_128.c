 ...
 * -variables 4 -pipeline-latency 8 -n 128 -name n1fv_128 -include
 * dft/simd/n1f.h */
...
static void n1fv_128(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP414213562, +0.414213562373095048801688724209698078569671875);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
      ...
      V T72, T85, Tas, Tcd, Tdp, Tdq, TdG, Teq, Tgj, Tet, Tgi, T1s, T5N, T1B,
          T5M;
      V T7d, T8W, TaI, Tcg, T7a, T8X, Tdm, Tdn, TdH, Tez, Tgm, TeC, Tgl, T23,
          T5Q;
      V T2c, T5P, T7k, T8Z, TaX, Tcf, T7h, T90, Tbl, Tbu, Tdb, TdL, TeY, Tgr,
          TeR;
      V Tgu, T7x, T98, T7E, T95, T3f, T5Y, T3s, T5V, TbS, Tc1, Tdi, TdO, Tfj,
          Tgy;
      V Tfc, TgB, T7Q, T9f, T7X, T9c, T4u, T65, T4H, T62;
      {
        V T3, Ta7, T4O, Ta8, Ta, Tab, T4P, Taa, Tc9, Tca, Ti, Tea, T4R, Tc6,
            Tc7;
        V Tp, Teb, T4S;
        {
          V T1, T2, T4M, T4N;
...
static const kdft_desc desc = {
    128, XSIMD_STRING("n1fv_128"), {440, 0, 642, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 128 -name n1fv_128 -include dft/simd/n1f.h */
...
static void n1fv_128(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(256, is), MAKE_VOLATILE_STRIDE(256, os)) {
      V Tr, T5J, Ted, Tgf, Tfq, TgH, T4U, T6b, T6Z, T8T, Tad, TcZ, Tcc, Td0,
          T84;
      V T9l, Tb6, Tbt, T2G, T5X, TeV, Tgr, T3p, T5V, T7B, T95, TeK, Tgt, T7q,
          T97;
      V Td8, TdK, TbD, Tc0, T3V, T61, Tfg, TgB, T4E, T65, T7U, T9f, Tf5, Tgx,
          T7J;
      V T9b, Tdf, TdN, Td2, Td3, TI, T4V, Tft, Tgg, TZ, T4W, T75, T86, Tek, TgG;
      V T72, T85, Tas, Tcd, Tdp, Tdq, TdG, Teq, Tgm, Tet, Tgl, T1s, T5P, T1B,
          T5Q;
      V T7d, T8Z, TaI, Tcf, T7a, T90, Tdm, Tdn, TdH, Tez, Tgi, TeC, Tgj, T23,
          T5N;
      V T2c, T5M, T7k, T8X, TaX, Tcg, T7h, T8W, Tbl, Tbu, Tdb, TdL, TeY, Tgu,
          TeR;
      V Tgq, T7x, T98, T7E, T94, T3f, T5Y, T3s, T5U, TbS, Tc1, Tdi, TdO, Tfj,
          Tgy;
      V Tfc, TgA, T7Q, T9e, T7X, T9c, T4u, T64, T4H, T62;
      {
        V T3, Ta7, T4P, Ta8, Ta, Tab, T4M, Taa, Tc9, Tca, Ti, Tea, T4S, Tc6,
            Tc7;
        V Tp, Teb, T4R;
        {
          V T1, T2, T4N, T4O;
      ...
      {
        V Tb0, Tb1, T2i, Tb2, T3k, Tb3, Tb4, T2p, Tb5, T3h, T2x, TeH, T3n, Tbs,
            T2E;
      ...
      {
        V Tbx, Tby, T3x, Tbz, T4z, TbA, TbB, T3E, TbC, T4w, T3M, Tf2, T4C, TbZ,
            T3T;
      ...
      {
        V Tav, Tau, T1b, Taw, T1v, Tay, Tax, T18, Taz, T1w, T1j, Teo, T1z, TaD,
            T1q;
      ...
      {
        V TaJ, TaK, T1F, TaL, T27, TaM, TaN, T1M, TaO, T24, T1U, Tew, T2a, TaV,
            T21;
      ...
      {
        V T2J, TeL, T2V, Tb9, T30, TeO, T3c, Tbg, T2Q, TeM, T2S, Tbc, T37, TeP,
            T39;
        V Tbj;
        {
      ...
      {
        V T3Y, Tf6, T4a, TbG, T4f, Tf9, T4r, TbN, T45, Tf7, T47, TbJ, T4m, Tfa,
            T4o;
        V TbQ;
        {
      ...
      {
        V TeF, Tg8, TfI, Tg0, Tfy, Tga, TfG, TfP, Tfm, TfJ, TfB, TfF, TfW, Tgb,
            Tg3;
        V Tg7;
        {
          V Tel, TfY, TeE, TfZ, Teu, TeD;
      ...
      {
        V Tgp, Thm, TgW, The, TgM, Tho, TgU, Th3, TgE, TgX, TgP, TgT, Tha, Thp,
            Thh;
        V Thl;
        {
          V Tgh, Thc, Tgo, Thd, Tgk, Tgn;
      ...
      {
        V T80, T8n, T8f, T8j, T8A, T8P, T8H, T8L, T7n, T8M, T8O, T8c, T8k, T8t,
            T8E;
        V T8m;
        {
          V T7G, T8d, T7Z, T8e;
      ...
      {
        V T4K, T5d, T55, T59, T5q, T5F, T5x, T5B, T2f, T5C, T5E, T52, T5a, T5j,
            T5u;
        V T5c;
        {
          V T3u, T53, T4J, T54;
...
static const kdft_desc desc = {
    128, XSIMD_STRING("n1fv_128"), {938, 186, 144, 0}, &GENUS, 0, 0, 0, 0};
