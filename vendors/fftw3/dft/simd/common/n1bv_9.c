 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 9 -name n1bv_9 -include
 * dft/simd/n1b.h */
...
static void n1bv_9(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    9, XSIMD_STRING("n1bv_9"), {12, 4, 34, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 9 -name n1bv_9 -include dft/simd/n1b.h */
  ...
  DVK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
      ...
      }
      {
        ...
        Tt = VFMA(
            LDK(KP852868531), Tb,
            VFMA(LDK(KP173648177), Ta,
                 VFMA(LDK(KP296198132), Ti, VFNMS(LDK(KP939692620), Th, T5))));
        Tu = VBYI(VSUB(
            VFMA(LDK(KP984807753), Ta,
                 VFMA(LDK(KP813797681), Ti,
                      VFNMS(LDK(KP150383733), Tb, VMUL(LDK(KP342020143), Th)))),
            Tm));
        ...
        ST(&(xo[WS(os, 2)]), VADD(Tt, Tu), ovs, &(xo[0]));
        {
          ...
          Tk = VADD(Tc, Tj);
          Tl = VADD(T5, Tk);
          Ts = VFMA(LDK(KP866025403), VSUB(To, Tn),
                    VFNMS(LDK(KP500000000), Tk, T5));
          Tp = VADD(Tn, To);
          Tq = VBYI(VADD(Tm, Tp));
          Tr = VBYI(VADD(Tm, VFNMS(LDK(KP500000000), Tp,
                                   VMUL(LDK(KP866025403), VSUB(Tc, Tj)))));
...
static const kdft_desc desc = {
    9, XSIMD_STRING("n1bv_9"), {30, 10, 16, 0}, &GENUS, 0, 0, 0, 0};
