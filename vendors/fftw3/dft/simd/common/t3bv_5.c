 ...
 * -no-generate-bytw -n 5 -name t3bv_5 -include dft/simd/t3b.h -sign 1 */
...
static void t3bv_5(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  ...
  DVK(KP951056516, +0.951056516295153572116439333379382143405698634);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 4)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 4), MAKE_VOLATILE_STRIDE(5, rs)) {
      V T2, T5, T6, Ta;
      T2 = LDW(&(W[0]));
      T5 = LDW(&(W[TWVL * 2]));
      T6 = VZMUL(T2, T5);
...
static const ct_desc desc = {
    5, XSIMD_STRING("t3bv_5"), twinstr, &GENUS, {13, 14, 9, 0}, 0, 0, 0};
 ...
 * 5 -name t3bv_5 -include dft/simd/t3b.h -sign 1 */
...
static const ct_desc desc = {
    5, XSIMD_STRING("t3bv_5"), twinstr, &GENUS, {19, 15, 3, 0}, 0, 0, 0};
