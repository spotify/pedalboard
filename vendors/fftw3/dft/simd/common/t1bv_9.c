 ...
 * -variables 4 -pipeline-latency 8 -n 9 -name t1bv_9 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_9(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
...
static const ct_desc desc = {
    9, XSIMD_STRING("t1bv_9"), twinstr, &GENUS, {20, 20, 34, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 9 -name t1bv_9 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {
    9, XSIMD_STRING("t1bv_9"), twinstr, &GENUS, {38, 26, 16, 0}, 0, 0, 0};
