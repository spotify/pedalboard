 ...
 * -variables 4 -pipeline-latency 8 -n 13 -name n1fv_13 -include dft/simd/n1f.h
 */
...
static void n1fv_13(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(26, is), MAKE_VOLATILE_STRIDE(26, os)) {
...
static const kdft_desc desc = {
    13, XSIMD_STRING("n1fv_13"), {31, 6, 57, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 13 -name n1fv_13 -include dft/simd/n1f.h */
...
static const kdft_desc desc = {
    13, XSIMD_STRING("n1fv_13"), {69, 15, 19, 0}, &GENUS, 0, 0, 0, 0};
