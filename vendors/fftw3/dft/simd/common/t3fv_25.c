 ...
 * -no-generate-bytw -n 25 -name t3fv_25 -include dft/simd/t3f.h */
...
static void t3fv_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    25, XSIMD_STRING("t3fv_25"), twinstr, &GENUS, {87, 100, 181, 0}, 0, 0, 0};
 ...
 * 25 -name t3fv_25 -include dft/simd/t3f.h */
      ...
      TU = VZMULJ(Td, T8);
      {
        ...
        }
        {
          V T3J, T3K, T3D, T3E, T3C, T3F, T3L, T3G;
          {
            ...
            T3I = VSUB(T3z, T3A);
            T3J =
                VBYI(VFMA(LDK(KP951056516), T3H, VMUL(LDK(KP587785252), T3I)));
            T3K =
                VBYI(VFNMS(LDK(KP587785252), T3H, VMUL(LDK(KP951056516), T3I)));
            T3D = VADD(Tl, Tm);
            T3y = VADD(T3w, T3x);
            T3B = VADD(T3z, T3A);
            T3E = VADD(T3y, T3B);
        ...
        {
          V To, T2n, T2o, T2p, T2x, T2y, T2z, T2u, T2v, T2w, T2q, T2r, T2s, T29,
              T2i;
          ...
          T2B = VBYI(VADD(T22, VFMA(LDK(KP309016994), T2w,
                                    VFMA(LDK(KP587785252), VSUB(T2r, T2q),
                                         VFNMS(LDK(KP951056516), VADD(T2n, T2o),
                                               VMUL(LDK(KP809016994), T2z))))));
          T2C = VFMA(LDK(KP309016994), T2p,
                     VFMA(LDK(KP951056516), VSUB(T2u, T2v),
                          VFMA(LDK(KP587785252), VSUB(T2y, T2x),
                               VFNMS(LDK(KP809016994), T2s, To))));
          ...
          ST(&(x[WS(rs, 16)]), VSUB(T2C, T2B), ms, &(x[0]));
          {
            ...
            T2f = VBYI(
                VADD(VFMA(LDK(KP587785252), T2b, VMUL(LDK(KP951056516), T2c)),
                     VSUB(T2d, T2e)));
            T2l = VBYI(
                VADD(VFNMS(LDK(KP587785252), T2c, VMUL(LDK(KP951056516), T2b)),
                     VADD(T2d, T2e)));
            T2h = VFNMS(LDK(KP250000000), T1Y, To);
            T2k = VFMA(LDK(KP587785252), T2g,
                       VFNMS(LDK(KP951056516), T2i, VSUB(T2h, T2j)));
            T2m = VFMA(LDK(KP951056516), T2g,
                       VADD(T2j, VFMA(LDK(KP587785252), T2i, T2h)));
        ...
        {
          V T2S, T2U, T2F, T2I, T2J, T2Y, T2Z, T30, T2M, T2P, T2Q, T2V, T2W,
              T2X, T3a;
          ...
          T32 =
              VFMA(LDK(KP309016994), T2X,
                   VFNMS(LDK(KP809016994), T30,
                         VFNMS(LDK(KP587785252), VADD(T2P, T2M),
                               VFNMS(LDK(KP951056516), VADD(T2I, T2F), T2U))));
          T33 = VBYI(VSUB(VFNMS(LDK(KP587785252), VADD(T2Y, T2Z),
                                VFNMS(LDK(KP809016994), T2Q,
                                      VFNMS(LDK(KP951056516), VADD(T2V, T2W),
                                            VMUL(LDK(KP309016994), T2J)))),
                          T2S));
          ...
          ST(&(x[WS(rs, 8)]), VADD(T32, T33), ms, &(x[0]));
          {
            ...
            T3j =
                VBYI(VADD(T3a, VADD(T3c, VFNMS(LDK(KP587785252), T3i,
                                               VMUL(LDK(KP951056516), T3f)))));
            T3s = VBYI(VADD(T3c, VSUB(VFMA(LDK(KP587785252), T3f,
                                           VMUL(LDK(KP951056516), T3i)),
                                      T3a)));
            T3q = VFNMS(LDK(KP250000000), T3p, T2U);
            T3r = VFMA(LDK(KP951056516), T3k,
                       VFMA(LDK(KP587785252), T3l, VADD(T3o, T3q)));
            T3t = VFMA(LDK(KP587785252), T3k,
                       VSUB(VFNMS(LDK(KP951056516), T3l, T3q), T3o));
...
static const ct_desc desc = {
    25, XSIMD_STRING("t3fv_25"), twinstr, &GENUS, {190, 150, 78, 0}, 0, 0, 0};
