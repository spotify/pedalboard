 ...
 * -variables 4 -pipeline-latency 8 -n 6 -name t1buv_6 -include dft/simd/t1bu.h
 * -sign 1 */
...
static void t1buv_6(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP866025403, +0.866025403784438646763723170752936183471402627);
  {
    ...
    R *x;
    x = ii;
    for (m = mb, W = W + (mb * ((TWVL / VL) * 10)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 10), MAKE_VOLATILE_STRIDE(6, rs)) {
...
static const tw_instr twinstr[] = {VTW(0, 1), VTW(0, 2), VTW(0, 3),
                                   VTW(0, 4), VTW(0, 5), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    6, XSIMD_STRING("t1buv_6"), twinstr, &GENUS, {17, 12, 6, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 6 -name t1buv_6 -include dft/simd/t1bu.h -sign 1 */
...
static const ct_desc desc = {
    6, XSIMD_STRING("t1buv_6"), twinstr, &GENUS, {21, 12, 2, 0}, 0, 0, 0};
