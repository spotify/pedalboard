 ...
 * -variables 4 -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -n 32
 * -name t2sv_32 -include dft/simd/ts.h */
...
static void t2sv_32(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * 8); m < me; m = m + (2 * VL),
      ...
      {
        V Tq, T46, T8H, T97, TH, T98, T4b, T8D, TZ, T7f, T4j, T6t, T1g, T7g,
            T4q;
        V T6u, T1v, T1I, T7m, T7j, T7k, T7l, T4z, T6x, T4G, T6y, T22, T2j, T7o,
            T7p;
        V T7q, T7r, T4O, T6A, T4V, T6B, T3G, T7L, T7I, T8n, T5E, T6P, T61, T6M,
            T2N;
        V T7A, T7x, T8i, T55, T6I, T5s, T6F, T43, T7J, T7O, T8o, T5L, T62, T5S,
            T63;
        ...
        {
          V T1i, T8c, T8z, T8A, T8J, T8O, T2l, T8N, T45, T8L, T8l, T8t, T8q,
              T8u, T8f;
          V T8B;
          {
            V TI, T1h, T8x, T8y;
          ...
          }
          {
            ...
            T8g = VADD(T8c, T8f);
            T8r = VADD(T8l, T8q);
            ST(&(ri[WS(rs, 20)]), VFNMS(LDK(KP707106781), T8r, T8g), ms,
               &(ri[0]));
            ST(&(ri[WS(rs, 4)]), VFMA(LDK(KP707106781), T8r, T8g), ms,
               &(ri[0]));
            T8P = VADD(T8N, T8O);
            T8Q = VADD(T8t, T8u);
            ST(&(ii[WS(rs, 4)]), VFMA(LDK(KP707106781), T8Q, T8P), ms,
               &(ii[0]));
            ST(&(ii[WS(rs, 20)]), VFNMS(LDK(KP707106781), T8Q, T8P), ms,
               &(ii[0]));
          }
          {
            V T8s, T8v, T8R, T8S;
            T8s = VSUB(T8c, T8f);
            T8v = VSUB(T8t, T8u);
            ST(&(ri[WS(rs, 28)]), VFNMS(LDK(KP707106781), T8v, T8s), ms,
               &(ri[0]));
            ST(&(ri[WS(rs, 12)]), VFMA(LDK(KP707106781), T8v, T8s), ms,
               &(ri[0]));
            T8R = VSUB(T8O, T8N);
            T8S = VSUB(T8q, T8l);
            ST(&(ii[WS(rs, 12)]), VFMA(LDK(KP707106781), T8S, T8R), ms,
               &(ii[0]));
            ST(&(ii[WS(rs, 28)]), VFNMS(LDK(KP707106781), T8S, T8R), ms,
               &(ii[0]));
          }
        }
        {
          V T7i, T7W, T86, T8a, T8V, T91, T7t, T8W, T7F, T7T, T7Z, T92, T83,
              T89, T7Q;
          V T7U;
          {
            V T7e, T7h, T84, T85;
          ...
          }
          {
            ...
            T7R = VSUB(T7F, T7Q);
            ST(&(ri[WS(rs, 22)]), VFNMS(LDK(KP923879532), T7R, T7u), ms,
               &(ri[0]));
            ST(&(ri[WS(rs, 6)]), VFMA(LDK(KP923879532), T7R, T7u), ms,
               &(ri[0]));
            T93 = VFMA(LDK(KP707106781), T92, T91);
            T94 = VSUB(T7U, T7T);
            ST(&(ii[WS(rs, 6)]), VFMA(LDK(KP923879532), T94, T93), ms,
               &(ii[0]));
            ST(&(ii[WS(rs, 22)]), VFNMS(LDK(KP923879532), T94, T93), ms,
               &(ii[0]));
          }
          {
            V T7S, T7V, T95, T96;
            ...
            T7V = VADD(T7T, T7U);
            ST(&(ri[WS(rs, 14)]), VFNMS(LDK(KP923879532), T7V, T7S), ms,
               &(ri[0]));
            ST(&(ri[WS(rs, 30)]), VFMA(LDK(KP923879532), T7V, T7S), ms,
               &(ri[0]));
            T95 = VFNMS(LDK(KP707106781), T92, T91);
            T96 = VADD(T7F, T7Q);
            ST(&(ii[WS(rs, 14)]), VFNMS(LDK(KP923879532), T96, T95), ms,
               &(ii[0]));
            ST(&(ii[WS(rs, 30)]), VFMA(LDK(KP923879532), T96, T95), ms,
               &(ii[0]));
          }
          {
            V T80, T87, T8X, T8Y;
            ...
            T87 = VADD(T83, T86);
            ST(&(ri[WS(rs, 18)]), VFNMS(LDK(KP923879532), T87, T80), ms,
               &(ri[0]));
            ST(&(ri[WS(rs, 2)]), VFMA(LDK(KP923879532), T87, T80), ms,
               &(ri[0]));
            T8X = VFMA(LDK(KP707106781), T8W, T8V);
            T8Y = VADD(T89, T8a);
            ST(&(ii[WS(rs, 2)]), VFMA(LDK(KP923879532), T8Y, T8X), ms,
               &(ii[0]));
            ST(&(ii[WS(rs, 18)]), VFNMS(LDK(KP923879532), T8Y, T8X), ms,
               &(ii[0]));
          }
          {
            V T88, T8b, T8Z, T90;
            ...
            T8b = VSUB(T89, T8a);
            ST(&(ri[WS(rs, 26)]), VFNMS(LDK(KP923879532), T8b, T88), ms,
               &(ri[0]));
            ST(&(ri[WS(rs, 10)]), VFMA(LDK(KP923879532), T8b, T88), ms,
               &(ri[0]));
            T8Z = VFNMS(LDK(KP707106781), T8W, T8V);
            T90 = VSUB(T86, T83);
            ST(&(ii[WS(rs, 10)]), VFMA(LDK(KP923879532), T90, T8Z), ms,
               &(ii[0]));
            ST(&(ii[WS(rs, 26)]), VFNMS(LDK(KP923879532), T90, T8Z), ms,
               &(ii[0]));
          }
        }
        {
          V T4s, T6c, T4X, T9c, T9b, T9h, T6f, T9i, T66, T6q, T6a, T6m, T5x,
              T6p, T69;
          V T6j;
          {
            V T4c, T4r, T6d, T6e;
          ...
          }
          {
            ...
            T67 = VSUB(T5x, T66);
            ST(&(ri[WS(rs, 21)]), VFNMS(LDK(KP831469612), T67, T4Y), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 5)]), VFMA(LDK(KP831469612), T67, T4Y), ms,
               &(ri[WS(rs, 1)]));
            T9j = VFMA(LDK(KP923879532), T9i, T9h);
            T9k = VSUB(T6a, T69);
            ST(&(ii[WS(rs, 5)]), VFMA(LDK(KP831469612), T9k, T9j), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 21)]), VFNMS(LDK(KP831469612), T9k, T9j), ms,
               &(ii[WS(rs, 1)]));
          }
          {
            V T68, T6b, T9l, T9m;
            ...
            T6b = VADD(T69, T6a);
            ST(&(ri[WS(rs, 13)]), VFNMS(LDK(KP831469612), T6b, T68), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 29)]), VFMA(LDK(KP831469612), T6b, T68), ms,
               &(ri[WS(rs, 1)]));
            T9l = VFNMS(LDK(KP923879532), T9i, T9h);
            T9m = VADD(T5x, T66);
            ST(&(ii[WS(rs, 13)]), VFNMS(LDK(KP831469612), T9m, T9l), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 29)]), VFMA(LDK(KP831469612), T9m, T9l), ms,
               &(ii[WS(rs, 1)]));
          }
          {
            V T6g, T6n, T9d, T9e;
            ...
            T6n = VADD(T6j, T6m);
            ST(&(ri[WS(rs, 17)]), VFNMS(LDK(KP980785280), T6n, T6g), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 1)]), VFMA(LDK(KP980785280), T6n, T6g), ms,
               &(ri[WS(rs, 1)]));
            T9d = VFMA(LDK(KP923879532), T9c, T9b);
            T9e = VADD(T6p, T6q);
            ST(&(ii[WS(rs, 1)]), VFMA(LDK(KP980785280), T9e, T9d), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 17)]), VFNMS(LDK(KP980785280), T9e, T9d), ms,
               &(ii[WS(rs, 1)]));
          }
          {
            V T6o, T6r, T9f, T9g;
            ...
            T6r = VSUB(T6p, T6q);
            ST(&(ri[WS(rs, 25)]), VFNMS(LDK(KP980785280), T6r, T6o), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 9)]), VFMA(LDK(KP980785280), T6r, T6o), ms,
               &(ri[WS(rs, 1)]));
            T9f = VFNMS(LDK(KP923879532), T9c, T9b);
            T9g = VSUB(T6m, T6j);
            ST(&(ii[WS(rs, 9)]), VFMA(LDK(KP980785280), T9g, T9f), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 25)]), VFNMS(LDK(KP980785280), T9g, T9f), ms,
               &(ii[WS(rs, 1)]));
          }
        }
        {
          V T6w, T6Y, T6D, T9w, T9p, T9v, T71, T9q, T6S, T7c, T6W, T78, T6L,
              T7b, T6V;
          V T75;
          {
            V T6s, T6v, T6Z, T70;
          ...
          }
          {
            ...
            T6T = VADD(T6L, T6S);
            ST(&(ri[WS(rs, 19)]), VFNMS(LDK(KP831469612), T6T, T6E), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 3)]), VFMA(LDK(KP831469612), T6T, T6E), ms,
               &(ri[WS(rs, 1)]));
            T9r = VFMA(LDK(KP923879532), T9q, T9p);
            T9s = VADD(T6V, T6W);
            ST(&(ii[WS(rs, 3)]), VFMA(LDK(KP831469612), T9s, T9r), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 19)]), VFNMS(LDK(KP831469612), T9s, T9r), ms,
               &(ii[WS(rs, 1)]));
          }
          {
            V T6U, T6X, T9t, T9u;
            ...
            T6X = VSUB(T6V, T6W);
            ST(&(ri[WS(rs, 27)]), VFNMS(LDK(KP831469612), T6X, T6U), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 11)]), VFMA(LDK(KP831469612), T6X, T6U), ms,
               &(ri[WS(rs, 1)]));
            T9t = VFNMS(LDK(KP923879532), T9q, T9p);
            T9u = VSUB(T6S, T6L);
            ST(&(ii[WS(rs, 11)]), VFMA(LDK(KP831469612), T9u, T9t), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 27)]), VFNMS(LDK(KP831469612), T9u, T9t), ms,
               &(ii[WS(rs, 1)]));
          }
          {
            V T72, T79, T9x, T9y;
            ...
            T79 = VSUB(T75, T78);
            ST(&(ri[WS(rs, 23)]), VFNMS(LDK(KP980785280), T79, T72), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 7)]), VFMA(LDK(KP980785280), T79, T72), ms,
               &(ri[WS(rs, 1)]));
            T9x = VFNMS(LDK(KP923879532), T9w, T9v);
            T9y = VSUB(T7c, T7b);
            ST(&(ii[WS(rs, 7)]), VFMA(LDK(KP980785280), T9y, T9x), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 23)]), VFNMS(LDK(KP980785280), T9y, T9x), ms,
               &(ii[WS(rs, 1)]));
          }
          {
            V T7a, T7d, T9z, T9A;
            ...
            T7d = VADD(T7b, T7c);
            ST(&(ri[WS(rs, 15)]), VFNMS(LDK(KP980785280), T7d, T7a), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 31)]), VFMA(LDK(KP980785280), T7d, T7a), ms,
               &(ri[WS(rs, 1)]));
            T9z = VFMA(LDK(KP923879532), T9w, T9v);
            T9A = VADD(T75, T78);
            ST(&(ii[WS(rs, 15)]), VFNMS(LDK(KP980785280), T9A, T9z), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 31)]), VFMA(LDK(KP980785280), T9A, T9z), ms,
               &(ii[WS(rs, 1)]));
          }
        }
      }
...
static const tw_instr twinstr[] = {
    VTW(0, 1), VTW(0, 3), VTW(0, 9), VTW(0, 27), {TW_NEXT, (2 * VL), 0}};

static const ct_desc desc = {
    32, XSIMD_STRING("t2sv_32"), twinstr, &GENUS, {236, 98, 252, 0}, 0, 0, 0};
 ...
 * -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -n 32 -name t2sv_32
 * -include dft/simd/ts.h */
...
static void t2sv_32(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * 8); m < me; m = m + (2 * VL),
      ...
      V T1H, T15, T1A, T11, T1F, T1n, T1p, T2q, T2I, T2u, T2K, T2V, T3b, T2Z,
          T3d;
      ...
      {
        V TL, T6f, T8c, T8q, T3F, T5t, T7I, T7W, T2y, T6B, T6y, T7j, T4k, T5J,
            T4B;
        V T5G, T3h, T6H, T6O, T7o, T4L, T5N, T52, T5Q, T1i, T7V, T6i, T7D, T3K,
            T5u;
        V T3P, T5v, T1E, T6n, T6m, T7e, T3W, T5y, T41, T5z, T29, T6p, T6s, T7f,
            T47;
        V T5B, T4c, T5C, T2R, T6z, T6E, T7k, T4v, T5H, T4E, T5K, T3y, T6P, T6K,
            T7p;
        V T4W, T5R, T55, T5O;
        {
        ...
        {
          V T6j, T7X, T83, T6X, T6u, T7U, T77, T7b, T70, T82, T6G, T6U, T74,
              T7a, T6R;
          V T6V;
          {
            V T6o, T6t, T6A, T6F;
        ...
        {
          V T3R, T5d, T8r, T8x, T4e, T8o, T5n, T5r, T4G, T5a, T5g, T8w, T5k,
              T5q, T57;
          V T5b, T3Q, T8p;
        ...
        {
          V T5x, T5Z, T8d, T8j, T5E, T88, T69, T6d, T5M, T5W, T62, T8i, T66,
              T6c, T5T;
          V T5X, T5w, T89;
...
static const ct_desc desc = {
    32, XSIMD_STRING("t2sv_32"), twinstr, &GENUS, {376, 168, 112, 0}, 0, 0, 0};
