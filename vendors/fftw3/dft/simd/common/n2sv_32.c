 ...
 * 4 -pipeline-latency 8 -n 32 -name n2sv_32 -with-ostride 1 -include
...
static void n2sv_32(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP414213562, +0.414213562373095048801688724209698078569671875);
  {
    ...
    for (i = v; i > 0; i = i - (2 * VL), ri = ri + ((2 * VL) * ivs),
        ...
        io = io + ((2 * VL) * ovs), MAKE_VOLATILE_STRIDE(128, is),
      ...
      {
        V T61, T62, T63, T64, T65, T66, T67, T68, T69, T6a, T6b, T6c, T6d, T6e,
            T6f;
        V T6g, T6h, T6i, T6j, T6k, T6l, T6m, T6n, T6o, T6p, T6q, T6r, T6s, T6t,
            T6u;
        V T6v, T6w;
        {
        ...
        {
          V T6x, T6y, T6z, T6A, T6B, T6C, T6D, T6E, T6F, T6G, T6H, T6I, T6J,
              T6K, T6L;
          V T6M;
          {
...
static const kdft_desc desc = {
    32, XSIMD_STRING("n2sv_32"), {236, 0, 136, 0}, &GENUS, 0, 1, 0, 0};
 ...
 * -pipeline-latency 8 -n 32 -name n2sv_32 -with-ostride 1 -include
 * dft/simd/n2s.h -store-multiple 4 */
...
static const kdft_desc desc = {
    32, XSIMD_STRING("n2sv_32"), {340, 52, 32, 0}, &GENUS, 0, 1, 0, 0};
