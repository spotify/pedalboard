 ...
 * -variables 4 -pipeline-latency 8 -n 20 -name n1fv_20 -include dft/simd/n1f.h
 */
...
static void n1fv_20(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    20, XSIMD_STRING("n1fv_20"), {58, 4, 46, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 20 -name n1fv_20 -include dft/simd/n1f.h */
...
static const kdft_desc desc = {
    20, XSIMD_STRING("n1fv_20"), {92, 12, 12, 0}, &GENUS, 0, 0, 0, 0};
