 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 14 -name n1bv_14 -include
 * dft/simd/n1b.h */
...
static void n1bv_14(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP356895867, +0.356895867892209443894399510021300583399127187);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(28, is), MAKE_VOLATILE_STRIDE(28, os)) {
      ...
      ST(&(xo[WS(os, 7)]), VADD(T3, VADD(Ta, VADD(Th, To))), ovs,
         &(xo[WS(os, 1)]));
...
static const kdft_desc desc = {
    14, XSIMD_STRING("n1bv_14"), {32, 6, 42, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 14 -name n1bv_14 -include dft/simd/n1b.h */
...
static void n1bv_14(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP433883739, +0.433883739117558120475768332848358754609990728);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
      ...
      ST(&(xo[WS(os, 7)]), VADD(Tp, VADD(Ts, VADD(Tq, Tr))), ovs,
         &(xo[WS(os, 1)]));
      ST(&(xo[0]), VADD(Ty, VADD(TB, VADD(TE, TH))), ovs, &(xo[0]));
      {
        V Tm, Tt, TQ, TP;
        Tm =
            VBYI(VFMA(LDK(KP433883739), T7,
                      VFNMS(LDK(KP781831482), Tl, VMUL(LDK(KP974927912), Te))));
        Tt = VFMA(LDK(KP623489801), Tq,
                  VFNMS(LDK(KP222520933), Tr, VFNMS(LDK(KP900968867), Ts, Tp)));
        ST(&(xo[WS(os, 3)]), VADD(Tm, Tt), ovs, &(xo[WS(os, 1)]));
        ST(&(xo[WS(os, 11)]), VSUB(Tt, Tm), ovs, &(xo[WS(os, 1)]));
        TQ = VBYI(VFMA(LDK(KP974927912), TJ,
                       VFMA(LDK(KP433883739), TL, VMUL(LDK(KP781831482), TK))));
        TP = VFMA(LDK(KP623489801), TH,
                  VFNMS(LDK(KP900968867), TE, VFNMS(LDK(KP222520933), TB, Ty)));
        ST(&(xo[WS(os, 12)]), VSUB(TP, TQ), ovs, &(xo[0]));
        ST(&(xo[WS(os, 2)]), VADD(TP, TQ), ovs, &(xo[0]));
      }
      {
        V Tu, Tv, TM, TI;
        Tu = VBYI(VFMA(LDK(KP781831482), T7,
                       VFMA(LDK(KP974927912), Tl, VMUL(LDK(KP433883739), Te))));
        Tv = VFMA(LDK(KP623489801), Ts,
                  VFNMS(LDK(KP900968867), Tr, VFNMS(LDK(KP222520933), Tq, Tp)));
        ST(&(xo[WS(os, 1)]), VADD(Tu, Tv), ovs, &(xo[WS(os, 1)]));
        ST(&(xo[WS(os, 13)]), VSUB(Tv, Tu), ovs, &(xo[WS(os, 1)]));
        TM = VBYI(
            VFNMS(LDK(KP433883739), TK,
                  VFNMS(LDK(KP974927912), TL, VMUL(LDK(KP781831482), TJ))));
        TI = VFMA(LDK(KP623489801), TB,
                  VFNMS(LDK(KP900968867), TH, VFNMS(LDK(KP222520933), TE, Ty)));
      ...
      }
      {
        V TO, TN, Tx, Tw;
        TO =
            VBYI(VFMA(LDK(KP433883739), TJ,
                      VFNMS(LDK(KP974927912), TK, VMUL(LDK(KP781831482), TL))));
        TN = VFMA(LDK(KP623489801), TE,
                  VFNMS(LDK(KP222520933), TH, VFNMS(LDK(KP900968867), TB, Ty)));
        ST(&(xo[WS(os, 4)]), VSUB(TN, TO), ovs, &(xo[0]));
        ST(&(xo[WS(os, 10)]), VADD(TN, TO), ovs, &(xo[0]));
        Tx = VBYI(
            VFNMS(LDK(KP781831482), Te,
                  VFNMS(LDK(KP433883739), Tl, VMUL(LDK(KP974927912), T7))));
        Tw = VFMA(LDK(KP623489801), Tr,
                  VFNMS(LDK(KP900968867), Tq, VFNMS(LDK(KP222520933), Ts, Tp)));
...
static const kdft_desc desc = {
    14, XSIMD_STRING("n1bv_14"), {50, 12, 24, 0}, &GENUS, 0, 0, 0, 0};
