 ...
 * -variables 4 -pipeline-latency 8 -n 20 -name t1bv_20 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_20(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP250000000, +0.250000000000000000000000000000000000000000000);
  {
    ...
    R *x;
    x = ii;
    for (m = mb, W = W + (mb * ((TWVL / VL) * 38)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 38), MAKE_VOLATILE_STRIDE(20, rs)) {
...
static const tw_instr twinstr[] = {
    ...
    VTW(0, 16), VTW(0, 17), VTW(0, 18), VTW(0, 19), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    20, XSIMD_STRING("t1bv_20"), twinstr, &GENUS, {77, 42, 46, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 20 -name t1bv_20 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {
    20, XSIMD_STRING("t1bv_20"), twinstr, &GENUS, {111, 50, 12, 0}, 0, 0, 0};
