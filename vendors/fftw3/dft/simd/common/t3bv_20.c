 ...
 * -no-generate-bytw -n 20 -name t3bv_20 -include dft/simd/t3b.h -sign 1 */
...
static void t3bv_20(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP250000000, +0.250000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 8)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 8), MAKE_VOLATILE_STRIDE(20, rs)) {
...
static const tw_instr twinstr[] = {
    VTW(0, 1), VTW(0, 3), VTW(0, 9), VTW(0, 19), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    20, XSIMD_STRING("t3bv_20"), twinstr, &GENUS, {92, 72, 46, 0}, 0, 0, 0};
 ...
 * 20 -name t3bv_20 -include dft/simd/t3b.h -sign 1 */
...
static const ct_desc desc = {
    20, XSIMD_STRING("t3bv_20"), twinstr, &GENUS, {126, 80, 12, 0}, 0, 0, 0};
