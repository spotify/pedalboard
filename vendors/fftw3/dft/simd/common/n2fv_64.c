 ...
 * -variables 4 -pipeline-latency 8 -n 64 -name n2fv_64 -with-ostride 2 -include
...
static void n2fv_64(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(128, is), MAKE_VOLATILE_STRIDE(128, os)) {
      V T7, T26, T47, T69, T5k, T6A, T2V, T3z, Tm, T27, T5n, T6a, T2Y, T3M, T4e;
      V T6B, TC, T2a, T6e, T6E, T3l, T3A, T4o, T5p, TR, T29, T6h, T6D, T3i, T3B;
      V T4x, T5q, T1N, T2x, T6t, T71, T6w, T72, T1W, T2y, T39, T3H, T57, T5N,
          T5e;
      V T5O, T3c, T3I, T1g, T2u, T6m, T6Y, T6p, T6Z, T1p, T2v, T32, T3E, T4M,
          T5K;
      V T4T, T5L, T35, T3F;
      {
      ...
      {
        V T1t, T4V, T1w, T58, T1Q, T59, T1T, T4Y, T1A, T1D, T1E, T5b, T52, T1H,
            T1K;
        V T1L, T5c, T55;
        {
          V T1r, T1s, T1u, T1v;
      ...
      {
        V TW, T4A, TZ, T4N, T1j, T4O, T1m, T4D, T13, T16, T17, T4Q, T4H, T1a,
            T1d;
        V T1e, T4R, T4K;
        {
          V TU, TV, TX, TY;
      ...
      {
        V T7n, T7o, T7p, T7q, T7r, T7s, T7t, T7u, T7w, T7y, T7A, T7B, T7E, T7G,
            T7I;
        V T7J;
        {
          V T3t, T3x, T3w, T3y;
...
static const kdft_desc desc = {
    64, XSIMD_STRING("n2fv_64"), {198, 0, 258, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -n 64 -name n2fv_64 -with-ostride 2 -include
 * dft/simd/n2f.h -store-multiple 2 */
...
static void n2fv_64(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
      ...
      V T4E, T5t, T23, T2N, T6t, T71, T6w, T72, T2c, T2O, T3t, T41, T5f, T5R,
          T5k;
      V T5S, T3w, T42, T1s, T2K, T6m, T6Y, T6p, T6Z, T1B, T2L, T3m, T3Y, T4Y,
          T5O;
      V T53, T5P, T3p, T3Z;
      {
      ...
      {
        V T1F, T55, T2a, T56, T1M, T5h, T27, T5g, T58, T59, T1U, T5a, T25, T5b,
            T5c;
        V T21, T5d, T24;
        {
          V T1D, T1E, T28, T29;
      ...
      {
        V T1q, T4P, T1v, T4O, T1n, T50, T1w, T4Z, T4U, T4V, T18, T4W, T1z, T4R,
            T4S;
        V T1f, T4T, T1y;
        {
          V T1o, T1p, T1t, T1u;
      ...
      {
        V T7n, T7o, T7p, T7q, T7r, T7s, T7t, T7u, T7v, T7w, T7x, T7y, T7z, T7A,
            T7B;
...
static const kdft_desc desc = {
    64, XSIMD_STRING("n2fv_64"), {404, 72, 52, 0}, &GENUS, 0, 2, 0, 0};
