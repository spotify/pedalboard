 ...
 * -variables 4 -pipeline-latency 8 -n 12 -name t1fv_12 -include dft/simd/t1f.h
 */
...
static void t1fv_12(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    12, XSIMD_STRING("t1fv_12"), twinstr, &GENUS, {41, 24, 18, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 12 -name t1fv_12 -include dft/simd/t1f.h */
...
static const ct_desc desc = {
    12, XSIMD_STRING("t1fv_12"), twinstr, &GENUS, {55, 26, 4, 0}, 0, 0, 0};
