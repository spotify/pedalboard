 ...
 * -variables 4 -pipeline-latency 8 -n 4 -name n2fv_4 -with-ostride 2 -include
...
static void n2fv_4(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    4, XSIMD_STRING("n2fv_4"), {6, 0, 2, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -n 4 -name n2fv_4 -with-ostride 2 -include dft/simd/n2f.h
 * -store-multiple 2 */
...
static const kdft_desc desc = {
    4, XSIMD_STRING("n2fv_4"), {8, 0, 0, 0}, &GENUS, 0, 2, 0, 0};
