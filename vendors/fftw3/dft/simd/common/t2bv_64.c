 ...
 * -variables 4 -pipeline-latency 8 -n 64 -name t2bv_64 -include dft/simd/t2b.h
 * -sign 1 */
...
static void t2bv_64(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    R *x;
    x = ii;
    for (m = mb, W = W + (mb * ((TWVL / VL) * 126)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 126), MAKE_VOLATILE_STRIDE(64, rs)) {
      V Ta, T3U, T6l, T7B, T37, T3V, T58, T7a, T1v, T24, T43, T4F, T5F, T7l,
          T5Q;
      V T7o, T2i, T2R, T4a, T4I, T60, T7s, T6b, T7v, T4k, T4l, T4C, T5x, T7g,
          T1i;
      V T3b, T5u, T7h, T4h, T4i, T4B, T5o, T7d, TV, T3a, T5l, T7e, T3X, T3Y, Tx;
      V T38, T5f, T7C, T6o, T7b, T1S, T25, T5T, T7m, T46, T4G, T5M, T7p, T2F,
          T2S;
      ...
      {
        V T7k, T8j, T7O, T89, T7H, T8g, T7R, T7Y, T7z, T7S, T7K, T7P, T85, T8k,
            T8c;
        V T8h;
        {
      ...
      {
        V T5A, T75, T6A, T6V, T6t, T72, T6D, T6K, T6h, T6E, T6w, T6B, T6R, T76,
            T6Y;
        V T73;
        {
...
static const tw_instr twinstr[] = {
    ...
    VTW(0, 13), VTW(0, 14), VTW(0, 15), VTW(0, 16),      VTW(0, 17), VTW(0, 18),
    VTW(0, 19), VTW(0, 20), VTW(0, 21), VTW(0, 22),      VTW(0, 23), VTW(0, 24),
    VTW(0, 25), VTW(0, 26), VTW(0, 27), VTW(0, 28),      VTW(0, 29), VTW(0, 30),
    VTW(0, 31), VTW(0, 32), VTW(0, 33), VTW(0, 34),      VTW(0, 35), VTW(0, 36),
    VTW(0, 37), VTW(0, 38), VTW(0, 39), VTW(0, 40),      VTW(0, 41), VTW(0, 42),
    VTW(0, 43), VTW(0, 44), VTW(0, 45), VTW(0, 46),      VTW(0, 47), VTW(0, 48),
    VTW(0, 49), VTW(0, 50), VTW(0, 51), VTW(0, 52),      VTW(0, 53), VTW(0, 54),
    VTW(0, 55), VTW(0, 56), VTW(0, 57), VTW(0, 58),      VTW(0, 59), VTW(0, 60),
    VTW(0, 61), VTW(0, 62), VTW(0, 63), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    64, XSIMD_STRING("t2bv_64"), twinstr, &GENUS, {261, 126, 258, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 64 -name t2bv_64 -include dft/simd/t2b.h -sign 1 */
...
static void t2bv_64(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 126)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 126), MAKE_VOLATILE_STRIDE(64, rs)) {
      V Tg, T4B, T6v, T7G, T3r, T4w, T5q, T7F, T5Y, T62, T28, T4d, T2g, T4a,
          T7g;
      V T7Y, T6f, T6j, T2Z, T4k, T37, T4h, T7n, T81, T7w, T7x, T7y, T5M, T6q,
          T1k;
      V T4s, T1r, T4t, T7t, T7u, T7v, T5F, T6p, TV, T4p, T12, T4q, T7A, T7B, TD;
      V T4x, T3k, T4C, T5x, T6s, T1R, T4b, T7j, T7Z, T2j, T4e, T5V, T63, T2I,
          T4i;
      ...
      {
        V T4z, T5g, T4R, T59, T4H, T5j, T4O, T55, T4o, T4S, T4K, T4P, T52, T5k,
            T5c;
        V T5h;
        {
      ...
      {
        V T1u, T43, T3D, T3V, T3t, T45, T3B, T3K, T3d, T3E, T3w, T3A, T3R, T46,
            T3Y;
        V T42;
        {
...
static const ct_desc desc = {
    64, XSIMD_STRING("t2bv_64"), twinstr, &GENUS, {467, 198, 52, 0}, 0, 0, 0};
