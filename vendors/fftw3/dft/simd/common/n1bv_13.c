 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 13 -name n1bv_13 -include
 * dft/simd/n1b.h */
...
static void n1bv_13(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    13, XSIMD_STRING("n1bv_13"), {31, 6, 57, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 13 -name n1bv_13 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {
    13, XSIMD_STRING("n1bv_13"), {69, 15, 19, 0}, &GENUS, 0, 0, 0, 0};
