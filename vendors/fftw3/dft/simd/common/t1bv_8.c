 ...
 * -variables 4 -pipeline-latency 8 -n 8 -name t1bv_8 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_8(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
...
static const ct_desc desc = {
    8, XSIMD_STRING("t1bv_8"), twinstr, &GENUS, {23, 14, 10, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 8 -name t1bv_8 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {
    8, XSIMD_STRING("t1bv_8"), twinstr, &GENUS, {33, 16, 0, 0}, 0, 0, 0};
