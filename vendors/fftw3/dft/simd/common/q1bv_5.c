 ...
 * -variables 4 -pipeline-latency 8 -n 5 -dif -name q1bv_5 -include
...
static void q1bv_5(R *ri, R *ii, const R *W, stride rs, stride vs, INT mb,
                   INT me, INT ms) {
  ...
  DVK(KP951056516, +0.951056516295153572116439333379382143405698634);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 8)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 8), MAKE_VOLATILE_STRIDE(10, rs),
        MAKE_VOLATILE_STRIDE(10, vs)) {
...
static const ct_desc desc = {
    5, XSIMD_STRING("q1bv_5"), twinstr, &GENUS, {55, 50, 45, 0}, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 5 -dif -name q1bv_5 -include dft/simd/q1b.h -sign 1 */
...
static const ct_desc desc = {
    5, XSIMD_STRING("q1bv_5"), twinstr, &GENUS, {85, 55, 15, 0}, 0, 0, 0};
