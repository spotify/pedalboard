 ...
 * -variables 4 -pipeline-latency 8 -n 5 -dif -name q1fv_5 -include
 * dft/simd/q1f.h */
...
static void q1fv_5(R *ri, R *ii, const R *W, stride rs, stride vs, INT mb,
                   INT me, INT ms) {
...
static const ct_desc desc = {
    5, XSIMD_STRING("q1fv_5"), twinstr, &GENUS, {55, 50, 45, 0}, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 5 -dif -name q1fv_5 -include dft/simd/q1f.h */
...
static const ct_desc desc = {
    5, XSIMD_STRING("q1fv_5"), twinstr, &GENUS, {85, 55, 15, 0}, 0, 0, 0};
