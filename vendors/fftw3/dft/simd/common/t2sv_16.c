 ...
 * -variables 4 -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -n 16
 * -name t2sv_16 -include dft/simd/ts.h */
...
static void t2sv_16(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * 8); m < me; m = m + (2 * VL),
        ...
        W = W + ((2 * VL) * 8), MAKE_VOLATILE_STRIDE(32, rs)) {
      ...
      {
        V Te, T1U, T3A, T3L, T1G, T2D, T2A, T3h, T1R, T2B, T2I, T3i, Tx, T3M,
            T1Z;
        V T3w, TL, T26, T25, T37, T1d, T2o, T2l, T3c, T1s, T2m, T2t, T3d, T12,
            T28;
        V T2d, T38;
        {
        ...
        }
        {
          ...
          }
          {
            V T3l, T3I, T3p, T3K;
            T3l = VADD(T3f, T3k);
            ST(&(ri[WS(rs, 10)]), VFNMS(LDK(KP707106781), T3l, T3a), ms,
               &(ri[0]));
            ST(&(ri[WS(rs, 2)]), VFMA(LDK(KP707106781), T3l, T3a), ms,
               &(ri[0]));
            T3I = VADD(T3n, T3o);
            ST(&(ii[WS(rs, 2)]), VFMA(LDK(KP707106781), T3I, T3H), ms,
               &(ii[0]));
            ST(&(ii[WS(rs, 10)]), VFNMS(LDK(KP707106781), T3I, T3H), ms,
               &(ii[0]));
            T3p = VSUB(T3n, T3o);
            ST(&(ri[WS(rs, 14)]), VFNMS(LDK(KP707106781), T3p, T3m), ms,
               &(ri[0]));
            ST(&(ri[WS(rs, 6)]), VFMA(LDK(KP707106781), T3p, T3m), ms,
               &(ri[0]));
            T3K = VSUB(T3k, T3f);
            ST(&(ii[WS(rs, 6)]), VFMA(LDK(KP707106781), T3K, T3J), ms,
               &(ii[0]));
            ST(&(ii[WS(rs, 14)]), VFNMS(LDK(KP707106781), T3K, T3J), ms,
               &(ii[0]));
          }
        }
        {
          V T20, T3N, T3T, T2Q, T2f, T3O, T30, T34, T2T, T3U, T2v, T2N, T2X,
              T33, T2K;
          V T2O;
          {
            V T27, T2e, T2n, T2u;
          ...
          }
          {
            ...
            T2L = VSUB(T2v, T2K);
            ST(&(ri[WS(rs, 11)]), VFNMS(LDK(KP923879532), T2L, T2g), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 3)]), VFMA(LDK(KP923879532), T2L, T2g), ms,
               &(ri[WS(rs, 1)]));
            T3V = VFMA(LDK(KP707106781), T3U, T3T);
            T3W = VSUB(T2O, T2N);
            ST(&(ii[WS(rs, 3)]), VFMA(LDK(KP923879532), T3W, T3V), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 11)]), VFNMS(LDK(KP923879532), T3W, T3V), ms,
               &(ii[WS(rs, 1)]));
          }
          {
            V T2M, T2P, T3X, T3Y;
            ...
            T2P = VADD(T2N, T2O);
            ST(&(ri[WS(rs, 7)]), VFNMS(LDK(KP923879532), T2P, T2M), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 15)]), VFMA(LDK(KP923879532), T2P, T2M), ms,
               &(ri[WS(rs, 1)]));
            T3X = VFNMS(LDK(KP707106781), T3U, T3T);
            T3Y = VADD(T2v, T2K);
            ST(&(ii[WS(rs, 7)]), VFNMS(LDK(KP923879532), T3Y, T3X), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 15)]), VFMA(LDK(KP923879532), T3Y, T3X), ms,
               &(ii[WS(rs, 1)]));
          }
          {
            V T2U, T31, T3P, T3Q;
            ...
            T31 = VADD(T2X, T30);
            ST(&(ri[WS(rs, 9)]), VFNMS(LDK(KP923879532), T31, T2U), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 1)]), VFMA(LDK(KP923879532), T31, T2U), ms,
               &(ri[WS(rs, 1)]));
            T3P = VFMA(LDK(KP707106781), T3O, T3N);
            T3Q = VADD(T33, T34);
            ST(&(ii[WS(rs, 1)]), VFMA(LDK(KP923879532), T3Q, T3P), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 9)]), VFNMS(LDK(KP923879532), T3Q, T3P), ms,
               &(ii[WS(rs, 1)]));
          }
          {
            V T32, T35, T3R, T3S;
            ...
            T35 = VSUB(T33, T34);
            ST(&(ri[WS(rs, 13)]), VFNMS(LDK(KP923879532), T35, T32), ms,
               &(ri[WS(rs, 1)]));
            ST(&(ri[WS(rs, 5)]), VFMA(LDK(KP923879532), T35, T32), ms,
               &(ri[WS(rs, 1)]));
            T3R = VFNMS(LDK(KP707106781), T3O, T3N);
            T3S = VSUB(T30, T2X);
            ST(&(ii[WS(rs, 5)]), VFMA(LDK(KP923879532), T3S, T3R), ms,
               &(ii[WS(rs, 1)]));
            ST(&(ii[WS(rs, 13)]), VFNMS(LDK(KP923879532), T3S, T3R), ms,
               &(ii[WS(rs, 1)]));
          }
        }
      }
...
static const tw_instr twinstr[] = {
    VTW(0, 1), VTW(0, 3), VTW(0, 9), VTW(0, 15), {TW_NEXT, (2 * VL), 0}};

static const ct_desc desc = {
    16, XSIMD_STRING("t2sv_16"), twinstr, &GENUS, {104, 42, 92, 0}, 0, 0, 0};
 ...
 * -pipeline-latency 8 -twiddle-log3 -precompute-twiddles -n 16 -name t2sv_16
 * -include dft/simd/ts.h */
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * 8); m < me; m = m + (2 * VL),
      ...
      }
      {
        ...
        V T2x, T1B, T1K, T2V, T2W, T2X, T2Y, T2j, T2D, T2o, T2E, T18, T1n, T2Q,
            T2R;
...
static const ct_desc desc = {
    16, XSIMD_STRING("t2sv_16"), twinstr, &GENUS, {156, 68, 40, 0}, 0, 0, 0};
