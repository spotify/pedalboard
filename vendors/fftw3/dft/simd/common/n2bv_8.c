 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 8 -name n2bv_8 -with-ostride 2
...
static void n2bv_8(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    8, XSIMD_STRING("n2bv_8"), {16, 0, 10, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 8 -name n2bv_8 -with-ostride 2 -include
...
static const kdft_desc desc = {
    8, XSIMD_STRING("n2bv_8"), {26, 2, 0, 0}, &GENUS, 0, 2, 0, 0};
