 ...
 * -variables 4 -pipeline-latency 8 -n 25 -name t1bv_25 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP250000000, +0.250000000000000000000000000000000000000000000);
  {
    ...
    R *x;
    x = ii;
    for (m = mb, W = W + (mb * ((TWVL / VL) * 48)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 48), MAKE_VOLATILE_STRIDE(25, rs)) {
      ...
      {
        V T2Z, T35, T3B, T3I, T2W, T38, T2O, T32, T2z, T3t, T3h, T3s, T3p, T3F,
            T3r;
        V T3v, T3C, T3z, T3A;
      ...
      {
        V T2n, T2t, T1V, T22, T2l, T2w, T2d, T2q, Tf, T1I, T1A, T1E, T1B, T1Z,
            T1J;
        V T1R, T1W, T1T, T1U;
...
static const tw_instr twinstr[] = {
    VTW(0, 1),  VTW(0, 2),  VTW(0, 3),  VTW(0, 4),  VTW(0, 5),
    VTW(0, 6),  VTW(0, 7),  VTW(0, 8),  VTW(0, 9),  VTW(0, 10),
    VTW(0, 11), VTW(0, 12), VTW(0, 13), VTW(0, 14), VTW(0, 15),
    VTW(0, 16), VTW(0, 17), VTW(0, 18), VTW(0, 19), VTW(0, 20),
    VTW(0, 21), VTW(0, 22), VTW(0, 23), VTW(0, 24), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    25, XSIMD_STRING("t1bv_25"), twinstr, &GENUS, {67, 60, 181, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 25 -name t1bv_25 -include dft/simd/t1b.h -sign 1 */
...
static void t1bv_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
  ...
  DVK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 48)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 48), MAKE_VOLATILE_STRIDE(25, rs)) {
      V T1A, T1z, T1R, T1S, T1B, T1C, T1Q, T2L, T1l, T2v, T1i, T3e, T2u, Tb,
          T2i;
      ...
      {
        V T2z, T2M, T2U, T2V, T2W, T34, T35, T36, T2X, T2Y, T2Z, T31, T32, T33,
            T2n;
        ...
        T38 =
            VBYI(VSUB(VFMA(LDK(KP951056516), VSUB(T2U, T2V),
                           VFMA(LDK(KP309016994), T33,
                                VFNMS(LDK(KP809016994), T36,
                                      VMUL(LDK(KP587785252), VSUB(T2X, T2Y))))),
                      T2M));
        T39 = VFMA(LDK(KP309016994), T2W,
                   VFMA(LDK(KP951056516), VSUB(T32, T31),
                        VFMA(LDK(KP587785252), VSUB(T35, T34),
                             VFNMS(LDK(KP809016994), T2Z, T2z))));
        ...
        ST(&(x[WS(rs, 17)]), VSUB(T39, T38), ms, &(x[WS(rs, 1)]));
        {
          ...
          T2F = VFMA(LDK(KP951056516), T2n,
                     VADD(T2y, VFNMS(LDK(KP587785252), T2E, T2B)));
          T2Q = VFMA(LDK(KP587785252), T2n,
                     VFMA(LDK(KP951056516), T2E, VSUB(T2B, T2y)));
          T2O = VFNMS(LDK(KP250000000), T2N, T2M);
          T2P = VBYI(
              VADD(VFMA(LDK(KP951056516), T2G, VMUL(LDK(KP587785252), T2H)),
                   VADD(T2K, T2O)));
          T2R = VBYI(
              VADD(VFNMS(LDK(KP951056516), T2H, VMUL(LDK(KP587785252), T2G)),
                   VSUB(T2O, T2K)));
      ...
      {
        V T1D, T1T, T21, T22, T23, T2b, T2c, T2d, T24, T25, T26, T28, T29, T2a,
            TF;
        ...
        T2f =
            VBYI(VSUB(VFMA(LDK(KP309016994), T2a,
                           VFMA(LDK(KP951056516), VADD(T21, T22),
                                VFNMS(LDK(KP809016994), T2d,
                                      VMUL(LDK(KP587785252), VSUB(T24, T25))))),
                      T1T));
        T2g = VFMA(LDK(KP951056516), VSUB(T29, T28),
                   VFMA(LDK(KP309016994), T23,
                        VFMA(LDK(KP587785252), VSUB(T2c, T2b),
                             VFNMS(LDK(KP809016994), T26, T1D))));
        ...
        ST(&(x[WS(rs, 16)]), VSUB(T2g, T2f), ms, &(x[0]));
        {
          ...
          T1J = VFMA(LDK(KP951056516), TF,
                     VADD(T1o, VFNMS(LDK(KP587785252), T1I, T1F)));
          T1X = VFMA(LDK(KP587785252), TF,
                     VFMA(LDK(KP951056516), T1I, VSUB(T1F, T1o)));
          T1V = VFNMS(LDK(KP250000000), T1U, T1T);
          T1W = VBYI(
              VADD(VFMA(LDK(KP951056516), T1K, VMUL(LDK(KP587785252), T1L)),
                   VADD(T1O, T1V)));
          T1Y = VBYI(
              VADD(VFNMS(LDK(KP951056516), T1L, VMUL(LDK(KP587785252), T1K)),
                   VSUB(T1V, T1O)));
...
static const ct_desc desc = {
    25, XSIMD_STRING("t1bv_25"), twinstr, &GENUS, {171, 111, 77, 0}, 0, 0, 0};
