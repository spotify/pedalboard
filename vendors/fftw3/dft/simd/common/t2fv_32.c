 ...
 * -variables 4 -pipeline-latency 8 -n 32 -name t2fv_32 -include dft/simd/t2f.h
 */
...
static void t2fv_32(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    32, XSIMD_STRING("t2fv_32"), twinstr, &GENUS, {119, 62, 98, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 32 -name t2fv_32 -include dft/simd/t2f.h */
...
static const ct_desc desc = {
    32, XSIMD_STRING("t2fv_32"), twinstr, &GENUS, {201, 88, 16, 0}, 0, 0, 0};
