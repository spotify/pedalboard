 ...
 * -variables 4 -pipeline-latency 8 -n 8 -name n2fv_8 -with-ostride 2 -include
...
static void n2fv_8(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(16, is), MAKE_VOLATILE_STRIDE(16, os)) {
...
static const kdft_desc desc = {
    8, XSIMD_STRING("n2fv_8"), {16, 0, 10, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -n 8 -name n2fv_8 -with-ostride 2 -include dft/simd/n2f.h
 * -store-multiple 2 */
...
static const kdft_desc desc = {
    8, XSIMD_STRING("n2fv_8"), {26, 2, 0, 0}, &GENUS, 0, 2, 0, 0};
