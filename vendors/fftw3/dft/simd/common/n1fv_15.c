 ...
 * -variables 4 -pipeline-latency 8 -n 15 -name n1fv_15 -include dft/simd/n1f.h
 */
...
static void n1fv_15(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(30, is), MAKE_VOLATILE_STRIDE(30, os)) {
...
static const kdft_desc desc = {
    15, XSIMD_STRING("n1fv_15"), {36, 7, 42, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 15 -name n1fv_15 -include dft/simd/n1f.h */
...
static const kdft_desc desc = {
    15, XSIMD_STRING("n1fv_15"), {64, 11, 14, 0}, &GENUS, 0, 0, 0, 0};
