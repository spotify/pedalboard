 ...
 * -no-generate-bytw -n 25 -name t3bv_25 -include dft/simd/t3b.h -sign 1 */
...
static void t3bv_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP250000000, +0.250000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 8)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 8), MAKE_VOLATILE_STRIDE(25, rs)) {
      ...
      TU = VZMULJ(T6, T9);
      {
        ...
        V T3a, T2D, T4a, TN, T32, TK, T31, TO, T2y, T3C, T3i, T33, T2G, T4b,
            T11;
        V T2Z, T19, T2Y, T1a, T2z, T3D, T3h, T30, T2H, T4d, T1y, T35, T1v, T36,
            T1z;
        ...
        {
          V T3n, T3t, T3Z, T46, T3k, T3w, T3c, T3q, T2X, T3R, T3F, T3Q, T3N,
              T43, T3P;
          V T3T, T40, T3X, T3Y;
        ...
        {
          V T2L, T2R, T2j, T2q, T2J, T2U, T2B, T2O, To, T26, T1Y, T22, T1Z, T2n,
              T27;
          V T2f, T2k, T2h, T2i;
...
static const tw_instr twinstr[] = {
    VTW(0, 1), VTW(0, 3), VTW(0, 9), VTW(0, 24), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    25, XSIMD_STRING("t3bv_25"), twinstr, &GENUS, {87, 100, 181, 0}, 0, 0, 0};
 ...
 * 25 -name t3bv_25 -include dft/simd/t3b.h -sign 1 */
...
static void t3bv_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
  ...
  DVK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 8)); m < me; m = m + VL,
      ...
      T11 = VZMULJ(TB, T4);
      {
        V T1Y, T1X, T2f, T2g, T1Z, T20, T2e, T39, T1H, T2T, T1E, T3C, T2S, Tk,
            T2G;
        ...
        }
        {
          V T3E, T3M, T3I, T3J, T3H, T3K, T3N, T3L;
          {
            ...
            T3D = VSUB(T3B, T3C);
            T3E =
                VBYI(VFMA(LDK(KP951056516), T3A, VMUL(LDK(KP587785252), T3D)));
            T3M =
                VBYI(VFNMS(LDK(KP951056516), T3D, VMUL(LDK(KP587785252), T3A)));
            T3I = VADD(T1Y, T1Z);
            T3F = VADD(T3y, T3z);
            T3G = VADD(T3B, T3C);
            T3J = VADD(T3F, T3G);
        ...
        {
          V T2X, T3a, T3i, T3j, T3k, T3s, T3t, T3u, T3l, T3m, T3n, T3p, T3q,
              T3r, T2L;
          ...
          T3w = VBYI(
              VSUB(VFMA(LDK(KP951056516), VSUB(T3i, T3j),
                        VFMA(LDK(KP309016994), T3r,
                             VFNMS(LDK(KP809016994), T3u,
                                   VMUL(LDK(KP587785252), VSUB(T3l, T3m))))),
                   T3a));
          T3x = VFMA(LDK(KP309016994), T3k,
                     VFMA(LDK(KP951056516), VSUB(T3q, T3p),
                          VFMA(LDK(KP587785252), VSUB(T3t, T3s),
                               VFNMS(LDK(KP809016994), T3n, T2X))));
          ...
          ST(&(x[WS(rs, 17)]), VSUB(T3x, T3w), ms, &(x[WS(rs, 1)]));
          {
            ...
            T33 = VFMA(LDK(KP951056516), T2L,
                       VADD(T2W, VFNMS(LDK(KP587785252), T32, T2Z)));
            T3e = VFMA(LDK(KP587785252), T2L,
                       VFMA(LDK(KP951056516), T32, VSUB(T2Z, T2W)));
            T3c = VFNMS(LDK(KP250000000), T3b, T3a);
            T3d = VBYI(
                VADD(VFMA(LDK(KP951056516), T34, VMUL(LDK(KP587785252), T35)),
                     VADD(T38, T3c)));
            T3f = VBYI(
                VADD(VFNMS(LDK(KP951056516), T35, VMUL(LDK(KP587785252), T34)),
                     VSUB(T3c, T38)));
        ...
        {
          V T21, T2h, T2p, T2q, T2r, T2z, T2A, T2B, T2s, T2t, T2u, T2w, T2x,
              T2y, TU;
          ...
          T2D = VBYI(
              VSUB(VFMA(LDK(KP309016994), T2y,
                        VFMA(LDK(KP951056516), VADD(T2p, T2q),
                             VFNMS(LDK(KP809016994), T2B,
                                   VMUL(LDK(KP587785252), VSUB(T2s, T2t))))),
                   T2h));
          T2E = VFMA(LDK(KP951056516), VSUB(T2x, T2w),
                     VFMA(LDK(KP309016994), T2r,
                          VFMA(LDK(KP587785252), VSUB(T2A, T2z),
                               VFNMS(LDK(KP809016994), T2u, T21))));
          ...
          ST(&(x[WS(rs, 16)]), VSUB(T2E, T2D), ms, &(x[0]));
          {
            ...
            T27 = VFMA(LDK(KP951056516), TU,
                       VADD(T1K, VFNMS(LDK(KP587785252), T26, T23)));
            T2l = VFMA(LDK(KP587785252), TU,
                       VFMA(LDK(KP951056516), T26, VSUB(T23, T1K)));
            T2j = VFNMS(LDK(KP250000000), T2i, T2h);
            T2k = VBYI(
                VADD(VFMA(LDK(KP951056516), T28, VMUL(LDK(KP587785252), T29)),
                     VADD(T2c, T2j)));
            T2m = VBYI(
                VADD(VFNMS(LDK(KP951056516), T29, VMUL(LDK(KP587785252), T28)),
                     VSUB(T2j, T2c)));
...
static const ct_desc desc = {
    25, XSIMD_STRING("t3bv_25"), twinstr, &GENUS, {191, 151, 77, 0}, 0, 0, 0};
