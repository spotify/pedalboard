 ...
 * -variables 4 -pipeline-latency 8 -n 6 -name t1fv_6 -include dft/simd/t1f.h */
...
static void t1fv_6(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
...
static const ct_desc desc = {
    6, XSIMD_STRING("t1fv_6"), twinstr, &GENUS, {17, 12, 6, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 6 -name t1fv_6 -include dft/simd/t1f.h */
...
static const ct_desc desc = {
    6, XSIMD_STRING("t1fv_6"), twinstr, &GENUS, {21, 12, 2, 0}, 0, 0, 0};
