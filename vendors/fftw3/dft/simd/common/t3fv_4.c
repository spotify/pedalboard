 ...
 * -no-generate-bytw -n 4 -name t3fv_4 -include dft/simd/t3f.h */
...
static void t3fv_4(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  {
    INT m;
    R *x;
...
static const ct_desc desc = {
    4, XSIMD_STRING("t3fv_4"), twinstr, &GENUS, {10, 8, 2, 0}, 0, 0, 0};
 ...
 * 4 -name t3fv_4 -include dft/simd/t3f.h */
...
static const ct_desc desc = {
    4, XSIMD_STRING("t3fv_4"), twinstr, &GENUS, {12, 8, 0, 0}, 0, 0, 0};
