 ...
 * -variables 4 -pipeline-latency 8 -n 25 -name n1fv_25 -include dft/simd/n1f.h
 */
...
static void n1fv_25(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(50, is), MAKE_VOLATILE_STRIDE(50, os)) {
      ...
      {
        V T2B, T2H, T2q, T2E, T2y, T2K, T31, T3a, T3l, T3f, T2b, T35, T34, T2T,
            T33;
        V T3h, T37;
      ...
      {
        V T1Z, T25, T1P, T22, T1X, T28, T1t, T1u, T1F, T1z, Tb, T1k, T1g, T1c,
            T1d;
        V T1B, T1l;
...
static const kdft_desc desc = {
    25, XSIMD_STRING("n1fv_25"), {43, 12, 181, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 25 -name n1fv_25 -include dft/simd/n1f.h */
...
static void n1fv_25(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
      ...
      {
        V T2t, T2y, T2z, T2w, T1T, T1W, T1X, T2c, T2d, T2e, T29, T2a, T2b, T20,
            T23;
        ...
        T2x = VBYI(VADD(T2o, VADD(T2q, VFNMS(LDK(KP587785252), T2w,
                                             VMUL(LDK(KP951056516), T2t)))));
        T2F = VFMA(LDK(KP951056516), T2y,
                   VFMA(LDK(KP587785252), T2z, VADD(T2C, T2E)));
        ST(&(xo[WS(os, 7)]), VADD(T2x, T2F), ovs, &(xo[WS(os, 1)]));
        ST(&(xo[WS(os, 18)]), VSUB(T2F, T2x), ovs, &(xo[0]));
        {
          V T2G, T2H, T2g, T2h;
          T2G = VBYI(VADD(T2q, VSUB(VFMA(LDK(KP587785252), T2t,
                                         VMUL(LDK(KP951056516), T2w)),
                                    T2o)));
          T2H = VFMA(LDK(KP587785252), T2y,
                     VSUB(VFNMS(LDK(KP951056516), T2z, T2E), T2C));
          ST(&(xo[WS(os, 12)]), VADD(T2G, T2H), ovs, &(xo[0]));
          ST(&(xo[WS(os, 13)]), VSUB(T2H, T2G), ovs, &(xo[WS(os, 1)]));
          T2g =
              VFMA(LDK(KP309016994), T2b,
                   VFNMS(LDK(KP809016994), T2e,
                         VFNMS(LDK(KP587785252), VADD(T23, T20),
                               VFNMS(LDK(KP951056516), VADD(T1W, T1T), T28))));
          T2h = VBYI(VSUB(VFNMS(LDK(KP587785252), VADD(T2c, T2d),
                                VFNMS(LDK(KP809016994), T24,
                                      VFNMS(LDK(KP951056516), VADD(T29, T2a),
                                            VMUL(LDK(KP309016994), T1X)))),
                          T26));
      ...
      {
        V T1p, T1u, T1w, T1q, T1B, T1C, T1D, T1L, T1M, T1N, T1I, T1J, T1K, T1E,
            T1F;
        ...
        T1t =
            VBYI(VADD(VFMA(LDK(KP587785252), T1p, VMUL(LDK(KP951056516), T1q)),
                      VSUB(T1r, T1s)));
        T1y = VFMA(LDK(KP587785252), T1u,
                   VFNMS(LDK(KP951056516), T1w, VSUB(T1v, T1x)));
        ST(&(xo[WS(os, 11)]), VADD(T1t, T1y), ovs, &(xo[WS(os, 1)]));
        ST(&(xo[WS(os, 14)]), VSUB(T1y, T1t), ovs, &(xo[0]));
        {
          V T1z, T1A, T1P, T1Q;
          T1z = VBYI(
              VADD(VFNMS(LDK(KP587785252), T1q, VMUL(LDK(KP951056516), T1p)),
                   VADD(T1r, T1s)));
          T1A = VFMA(LDK(KP951056516), T1u,
                     VADD(T1x, VFMA(LDK(KP587785252), T1w, T1v)));
          ST(&(xo[WS(os, 6)]), VADD(T1z, T1A), ovs, &(xo[0]));
          ST(&(xo[WS(os, 19)]), VSUB(T1A, T1z), ovs, &(xo[WS(os, 1)]));
          T1P = VBYI(VADD(T1g, VFMA(LDK(KP309016994), T1K,
                                    VFMA(LDK(KP587785252), VSUB(T1F, T1E),
                                         VFNMS(LDK(KP951056516), VADD(T1B, T1C),
                                               VMUL(LDK(KP809016994), T1N))))));
          T1Q = VFMA(LDK(KP309016994), T1D,
                     VFMA(LDK(KP951056516), VSUB(T1I, T1J),
                          VFMA(LDK(KP587785252), VSUB(T1M, T1L),
                               VFNMS(LDK(KP809016994), T1G, Tb))));
...
static const kdft_desc desc = {
    25, XSIMD_STRING("n1fv_25"), {146, 62, 78, 0}, &GENUS, 0, 0, 0, 0};
