 ...
 * -variables 4 -pipeline-latency 8 -n 16 -name t1fv_16 -include dft/simd/t1f.h
 */
...
static void t1fv_16(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    16, XSIMD_STRING("t1fv_16"), twinstr, &GENUS, {53, 30, 34, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 16 -name t1fv_16 -include dft/simd/t1f.h */
...
static const ct_desc desc = {
    16, XSIMD_STRING("t1fv_16"), twinstr, &GENUS, {83, 38, 4, 0}, 0, 0, 0};
