 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 64 -name n1bv_64 -include
 * dft/simd/n1b.h */
...
static void n1bv_64(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    64, XSIMD_STRING("n1bv_64"), {198, 0, 258, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 64 -name n1bv_64 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {
    64, XSIMD_STRING("n1bv_64"), {404, 72, 52, 0}, &GENUS, 0, 0, 0, 0};
