 ...
 * -variables 4 -pipeline-latency 8 -n 4 -name t2bv_4 -include dft/simd/t2b.h
 * -sign 1 */
...
static void t2bv_4(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  {
    INT m;
    R *x;
...
static const ct_desc desc = {
    4, XSIMD_STRING("t2bv_4"), twinstr, &GENUS, {9, 6, 2, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 4 -name t2bv_4 -include dft/simd/t2b.h -sign 1 */
...
static const ct_desc desc = {
    4, XSIMD_STRING("t2bv_4"), twinstr, &GENUS, {11, 6, 0, 0}, 0, 0, 0};
