 ...
 * -variables 4 -pipeline-latency 8 -n 25 -name t1fv_25 -include dft/simd/t1f.h
 */
...
static void t1fv_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    25, XSIMD_STRING("t1fv_25"), twinstr, &GENUS, {67, 60, 181, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 25 -name t1fv_25 -include dft/simd/t1f.h */
...
static void t1fv_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
  ...
  DVK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 48)); m < me; m = m + VL,
      ...
      {
        V Tf, T1Z, T20, T21, T29, T2a, T2b, T26, T27, T28, T22, T23, T24, T1L,
            T1U;
        ...
        T2d = VBYI(VADD(T1E, VFMA(LDK(KP309016994), T28,
                                  VFMA(LDK(KP587785252), VSUB(T23, T22),
                                       VFNMS(LDK(KP951056516), VADD(T1Z, T20),
                                             VMUL(LDK(KP809016994), T2b))))));
        T2e = VFMA(LDK(KP309016994), T21,
                   VFMA(LDK(KP951056516), VSUB(T26, T27),
                        VFMA(LDK(KP587785252), VSUB(T2a, T29),
                             VFNMS(LDK(KP809016994), T24, Tf))));
        ...
        ST(&(x[WS(rs, 16)]), VSUB(T2e, T2d), ms, &(x[0]));
        {
          ...
          T1R = VBYI(
              VADD(VFMA(LDK(KP587785252), T1N, VMUL(LDK(KP951056516), T1O)),
                   VSUB(T1P, T1Q)));
          T1X = VBYI(
              VADD(VFNMS(LDK(KP587785252), T1O, VMUL(LDK(KP951056516), T1N)),
                   VADD(T1P, T1Q)));
          T1T = VFNMS(LDK(KP250000000), T1A, Tf);
          T1W = VFMA(LDK(KP587785252), T1S,
                     VFNMS(LDK(KP951056516), T1U, VSUB(T1T, T1V)));
          T1Y = VFMA(LDK(KP951056516), T1S,
                     VADD(T1V, VFMA(LDK(KP587785252), T1U, T1T)));
      ...
      {
        V T2u, T2w, T2h, T2k, T2l, T2A, T2B, T2C, T2o, T2r, T2s, T2x, T2y, T2z,
            T2M;
        ...
        T2E = VFMA(LDK(KP309016994), T2z,
                   VFNMS(LDK(KP809016994), T2C,
                         VFNMS(LDK(KP587785252), VADD(T2r, T2o),
                               VFNMS(LDK(KP951056516), VADD(T2k, T2h), T2w))));
        T2F = VBYI(VSUB(VFNMS(LDK(KP587785252), VADD(T2A, T2B),
                              VFNMS(LDK(KP809016994), T2s,
                                    VFNMS(LDK(KP951056516), VADD(T2x, T2y),
                                          VMUL(LDK(KP309016994), T2l)))),
                        T2u));
        ...
        ST(&(x[WS(rs, 8)]), VADD(T2E, T2F), ms, &(x[0]));
        {
          ...
          T2V = VBYI(VADD(T2M, VADD(T2O, VFNMS(LDK(KP587785252), T2U,
                                               VMUL(LDK(KP951056516), T2R)))));
          T34 = VBYI(VADD(T2O, VSUB(VFMA(LDK(KP587785252), T2R,
                                         VMUL(LDK(KP951056516), T2U)),
                                    T2M)));
          T32 = VFNMS(LDK(KP250000000), T31, T2w);
          T33 = VFMA(LDK(KP951056516), T2W,
                     VFMA(LDK(KP587785252), T2X, VADD(T30, T32)));
          T35 = VFMA(LDK(KP587785252), T2W,
                     VSUB(VFNMS(LDK(KP951056516), T2X, T32), T30));
...
static const ct_desc desc = {
    25, XSIMD_STRING("t1fv_25"), twinstr, &GENUS, {170, 110, 78, 0}, 0, 0, 0};
