 ...
 * -variables 4 -pipeline-latency 8 -n 10 -name n2fv_10 -with-ostride 2 -include
...
static void n2fv_10(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    10, XSIMD_STRING("n2fv_10"), {24, 4, 18, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -n 10 -name n2fv_10 -with-ostride 2 -include
 * dft/simd/n2f.h -store-multiple 2 */
...
static const kdft_desc desc = {
    10, XSIMD_STRING("n2fv_10"), {36, 6, 6, 0}, &GENUS, 0, 2, 0, 0};
