 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 4 -name n1bv_4 -include
 * dft/simd/n1b.h */
...
static void n1bv_4(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
...
static const kdft_desc desc = {
    4, XSIMD_STRING("n1bv_4"), {6, 0, 2, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 4 -name n1bv_4 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {
    4, XSIMD_STRING("n1bv_4"), {8, 0, 0, 0}, &GENUS, 0, 0, 0, 0};
