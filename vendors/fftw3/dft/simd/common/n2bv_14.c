 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 14 -name n2bv_14 -with-ostride 2
 * -include dft/simd/n2b.h -store-multiple 2 */
...
static void n2bv_14(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    14, XSIMD_STRING("n2bv_14"), {32, 6, 42, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 14 -name n2bv_14 -with-ostride 2 -include
 * dft/simd/n2b.h -store-multiple 2 */
...
static const kdft_desc desc = {
    14, XSIMD_STRING("n2bv_14"), {50, 12, 24, 0}, &GENUS, 0, 2, 0, 0};
