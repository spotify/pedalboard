 ...
 * -variables 4 -pipeline-latency 8 -n 6 -name n2fv_6 -with-ostride 2 -include
...
static void n2fv_6(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DVK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(12, is), MAKE_VOLATILE_STRIDE(12, os)) {
...
static const kdft_desc desc = {
    6, XSIMD_STRING("n2fv_6"), {12, 2, 6, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -n 6 -name n2fv_6 -with-ostride 2 -include dft/simd/n2f.h
 * -store-multiple 2 */
...
static const kdft_desc desc = {
    6, XSIMD_STRING("n2fv_6"), {16, 2, 2, 0}, &GENUS, 0, 2, 0, 0};
