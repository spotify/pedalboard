 ...
 * -variables 4 -pipeline-latency 8 -n 9 -name n1fv_9 -include dft/simd/n1f.h */
...
static void n1fv_9(const R *ri, const R *ii, R *ro, R *io, stride is, stride os,
  ...
  DVK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
        MAKE_VOLATILE_STRIDE(18, is), MAKE_VOLATILE_STRIDE(18, os)) {
...
static const kdft_desc desc = {
    9, XSIMD_STRING("n1fv_9"), {12, 4, 34, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -n 9 -name n1fv_9 -include dft/simd/n1f.h */
  ...
  DVK(KP866025403, +0.866025403784438646763723170752936183471402627);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
      ...
      }
      {
        ...
        Tz = VFMA(LDK(KP173648177), Tk,
                  VFNMS(LDK(KP296198132), To,
                        VFNMS(LDK(KP939692620), Tn,
                              VFNMS(LDK(KP852868531), Tl, Tj))));
        TA = VBYI(VSUB(VFNMS(LDK(KP342020143), Tn,
                             VFNMS(LDK(KP150383733), Tl,
                                   VFNMS(LDK(KP984807753), Tk,
                                         VMUL(LDK(KP813797681), To)))),
                       Ts));
        ...
        ST(&(xo[WS(os, 2)]), VADD(Tz, TA), ovs, &(xo[0]));
        {
          ...
          Tq = VADD(Tm, Tp);
          Tr = VADD(Tj, Tq);
          Tx = VFMA(LDK(KP866025403), VSUB(Tt, Tu),
                    VFNMS(LDK(KP500000000), Tq, Tj));
          Tv = VADD(Tt, Tu);
          Tw = VBYI(VADD(Ts, Tv));
          Ty = VBYI(VADD(Ts, VFNMS(LDK(KP500000000), Tv,
                                   VMUL(LDK(KP866025403), VSUB(Tp, Tm)))));
...
static const kdft_desc desc = {
    9, XSIMD_STRING("n1fv_9"), {30, 10, 16, 0}, &GENUS, 0, 0, 0, 0};
