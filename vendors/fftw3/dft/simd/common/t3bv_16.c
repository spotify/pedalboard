 ...
 * -no-generate-bytw -n 16 -name t3bv_16 -include dft/simd/t3b.h -sign 1 */
...
static void t3bv_16(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    16, XSIMD_STRING("t3bv_16"), twinstr, &GENUS, {64, 52, 34, 0}, 0, 0, 0};
 ...
 * 16 -name t3bv_16 -include dft/simd/t3b.h -sign 1 */
...
static const ct_desc desc = {
    16, XSIMD_STRING("t3bv_16"), twinstr, &GENUS, {94, 60, 4, 0}, 0, 0, 0};
