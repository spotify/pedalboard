 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 15 -name n1bv_15 -include
 * dft/simd/n1b.h */
...
static void n1bv_15(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    15, XSIMD_STRING("n1bv_15"), {36, 7, 42, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 15 -name n1bv_15 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {
    15, XSIMD_STRING("n1bv_15"), {64, 11, 14, 0}, &GENUS, 0, 0, 0, 0};
