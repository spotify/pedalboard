 ...
 * -variables 4 -pipeline-latency 8 -n 20 -name n2fv_20 -with-ostride 2 -include
...
static void n2fv_20(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    20, XSIMD_STRING("n2fv_20"), {58, 4, 46, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -n 20 -name n2fv_20 -with-ostride 2 -include
 * dft/simd/n2f.h -store-multiple 2 */
      ...
      }
      {
        ...
        }
        {
          V T1O, T1P, T1R, T1S;
          {
            ...
            T1e = VSUB(T1a, T1d);
            T1f =
                VBYI(VFNMS(LDK(KP587785252), T1e, VMUL(LDK(KP951056516), T17)));
            T1q =
                VBYI(VFMA(LDK(KP951056516), T1e, VMUL(LDK(KP587785252), T17)));
            T1O = VADD(T1i, T1l);
            STM2(&(xo[20]), T1O, ovs, &(xo[0]));
            T1p = VADD(T1n, T1m);
            T1P = VSUB(T1p, T1q);
...
static const kdft_desc desc = {
    20, XSIMD_STRING("n2fv_20"), {92, 12, 12, 0}, &GENUS, 0, 2, 0, 0};
