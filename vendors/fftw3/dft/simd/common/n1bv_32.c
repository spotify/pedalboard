 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 32 -name n1bv_32 -include
 * dft/simd/n1b.h */
...
static void n1bv_32(const R *ri, const R *ii, R *ro, R *io, stride is,
...
static const kdft_desc desc = {
    32, XSIMD_STRING("n1bv_32"), {88, 0, 98, 0}, &GENUS, 0, 0, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 32 -name n1bv_32 -include dft/simd/n1b.h */
...
static const kdft_desc desc = {
    32, XSIMD_STRING("n1bv_32"), {170, 26, 16, 0}, &GENUS, 0, 0, 0, 0};
