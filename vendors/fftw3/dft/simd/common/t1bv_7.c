 ...
 * -variables 4 -pipeline-latency 8 -n 7 -name t1bv_7 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_7(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
...
static const ct_desc desc = {
    7, XSIMD_STRING("t1bv_7"), twinstr, &GENUS, {15, 15, 21, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 7 -name t1bv_7 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {
    7, XSIMD_STRING("t1bv_7"), twinstr, &GENUS, {24, 18, 12, 0}, 0, 0, 0};
