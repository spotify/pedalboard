 ...
 * -variables 4 -pipeline-latency 8 -n 64 -name t1fv_64 -include dft/simd/t1f.h
 */
...
static void t1fv_64(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 126)); m < me; m = m + VL,
      ...
      V Ta, T3U, T6l, T7B, T37, T3V, T58, T7a, T1v, T24, T43, T4F, T5F, T7l,
          T5Q;
      V T7o, T2i, T2R, T4a, T4I, T60, T7s, T6b, T7v, T4h, T4i, T4C, T5x, T7g,
          T1i;
...
static const ct_desc desc = {
    64, XSIMD_STRING("t1fv_64"), twinstr, &GENUS, {261, 126, 258, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 64 -name t1fv_64 -include dft/simd/t1f.h */
...
static void t1fv_64(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + (mb * ((TWVL / VL) * 126)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 126), MAKE_VOLATILE_STRIDE(64, rs)) {
      V Tg, T4a, T6r, T7f, T3o, T4B, T5q, T7e, T5R, T62, T28, T4o, T2g, T4l,
          T7n;
      V T7Z, T68, T6j, T2C, T4s, T3a, T4v, T7u, T82, T7E, T7F, T7V, T5F, T6u,
          T1k;
      V T4e, T1r, T4d, T7B, T7C, T7W, T5M, T6v, TV, T4g, T12, T4h, T7h, T7i, TD;
      V T4C, T3h, T4b, T5x, T6s, T1R, T4m, T7q, T80, T2j, T4p, T5Y, T63, T2Z,
          T4w;
      ...
      {
        V T4k, T5h, T4R, T59, T4H, T5j, T4P, T4Y, T4z, T4S, T4K, T4O, T55, T5k,
            T5c;
        V T5g;
        {
...
static const ct_desc desc = {
    64, XSIMD_STRING("t1fv_64"), twinstr, &GENUS, {467, 198, 52, 0}, 0, 0, 0};
