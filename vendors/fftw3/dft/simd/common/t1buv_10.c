 ...
 * -variables 4 -pipeline-latency 8 -n 10 -name t1buv_10 -include
 * dft/simd/t1bu.h -sign 1 */
...
static void t1buv_10(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                     INT ms) {
...
static const ct_desc desc = {
    10, XSIMD_STRING("t1buv_10"), twinstr, &GENUS, {33, 22, 18, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 10 -name t1buv_10 -include dft/simd/t1bu.h -sign 1
 */
...
static const ct_desc desc = {
    10, XSIMD_STRING("t1buv_10"), twinstr, &GENUS, {45, 24, 6, 0}, 0, 0, 0};
