 ...
 * -variables 4 -pipeline-latency 8 -n 12 -name t1bv_12 -include dft/simd/t1b.h
 * -sign 1 */
...
static void t1bv_12(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
  ...
  DVK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    R *x;
    x = ii;
    for (m = mb, W = W + (mb * ((TWVL / VL) * 22)); m < me; m = m + VL,
        x = x + (VL * ms), W = W + (TWVL * 22), MAKE_VOLATILE_STRIDE(12, rs)) {
...
static const tw_instr twinstr[] = {
    ...
    VTW(0, 7), VTW(0, 8), VTW(0, 9), VTW(0, 10), VTW(0, 11), {TW_NEXT, VL, 0}};

static const ct_desc desc = {
    12, XSIMD_STRING("t1bv_12"), twinstr, &GENUS, {41, 24, 18, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 12 -name t1bv_12 -include dft/simd/t1b.h -sign 1 */
...
static const ct_desc desc = {
    12, XSIMD_STRING("t1bv_12"), twinstr, &GENUS, {55, 26, 4, 0}, 0, 0, 0};
