 ...
 * -variables 4 -pipeline-latency 8 -sign 1 -n 64 -name n2bv_64 -with-ostride 2
...
static void n2bv_64(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
      ...
      {
        V T7n, T7o, T7p, T7q, T7r, T7s, T7t, T7u, T7w, T7y, T7A, T7B, T7D, T7G,
            T7H;
        V T7J;
        {
          V T3t, T3x, T3w, T3y;
...
static const kdft_desc desc = {
    64, XSIMD_STRING("n2bv_64"), {198, 0, 258, 0}, &GENUS, 0, 2, 0, 0};
 ...
 * -pipeline-latency 8 -sign 1 -n 64 -name n2bv_64 -with-ostride 2 -include
...
static void n2bv_64(const R *ri, const R *ii, R *ro, R *io, stride is,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - VL, xi = xi + (VL * ivs), xo = xo + (VL * ovs),
      ...
      V T4L, T5p, T23, T2N, T6m, T70, T6p, T71, T2c, T2O, T3i, T3Y, T5f, T5R,
          T5k;
      V T5S, T3l, T3Z, T1s, T2K, T6f, T6X, T6i, T6Y, T1B, T2L, T3b, T3V, T4Y,
          T5O;
      V T53, T5P, T3e, T3W;
      {
      ...
      {
        V T21, T5h, T26, T5g, T1Y, T5d, T27, T5c, T55, T56, T1J, T57, T29, T58,
            T59;
        V T1Q, T5a, T2a;
        {
          V T1Z, T20, T24, T25;
      ...
      {
        V T1q, T50, T1v, T4Z, T1n, T4W, T1w, T4V, T4O, T4P, T18, T4Q, T1y, T4R,
            T4S;
        V T1f, T4T, T1z;
        {
          V T1o, T1p, T1t, T1u;
...
static const kdft_desc desc = {
    64, XSIMD_STRING("n2bv_64"), {404, 72, 52, 0}, &GENUS, 0, 2, 0, 0};
