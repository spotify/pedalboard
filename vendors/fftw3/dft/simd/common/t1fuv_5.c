 ...
 * -variables 4 -pipeline-latency 8 -n 5 -name t1fuv_5 -include dft/simd/t1fu.h
 */
...
static void t1fuv_5(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    5, XSIMD_STRING("t1fuv_5"), twinstr, &GENUS, {11, 10, 9, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 5 -name t1fuv_5 -include dft/simd/t1fu.h */
...
static const ct_desc desc = {
    5, XSIMD_STRING("t1fuv_5"), twinstr, &GENUS, {17, 11, 3, 0}, 0, 0, 0};
