 ...
 * -variables 4 -pipeline-latency 8 -n 25 -name t2bv_25 -include dft/simd/t2b.h
 * -sign 1 */
...
static void t2bv_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me,
                    INT ms) {
...
static const ct_desc desc = {
    25, XSIMD_STRING("t2bv_25"), twinstr, &GENUS, {67, 60, 181, 0}, 0, 0, 0};
 ...
 * 4 -pipeline-latency 8 -n 25 -name t2bv_25 -include dft/simd/t2b.h -sign 1 */
...
static const ct_desc desc = {
    25, XSIMD_STRING("t2bv_25"), twinstr, &GENUS, {171, 111, 77, 0}, 0, 0, 0};
