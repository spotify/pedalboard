...
typedef struct {
  int (*okp)(const kdft_desc *desc, const R *ri, const R *ii, const R *ro,
...
typedef void (*kdft)(const R *ri, const R *ii, R *ro, R *io, stride is,
                     stride os, INT vl, INT ivs, INT ovs);
void X(kdft_register)(planner *p, kdft codelet, const kdft_desc *desc);

typedef struct ct_desc_s ct_desc;

typedef struct {
  int (*okp)(const struct ct_desc_s *desc, const R *rio, const R *iio, INT rs,
             INT vs, INT m, INT mb, INT me, INT ms, const planner *plnr);
  INT vl;
} ct_genus;
...
typedef void (*kdftw)(R *rioarray, R *iioarray, const R *W, stride ios, INT mb,
                      INT me, INT ms);
...
typedef void (*kdftwsq)(R *rioarray, R *iioarray, const R *W, stride is,
                        stride vs, INT mb, INT me, INT ms);
