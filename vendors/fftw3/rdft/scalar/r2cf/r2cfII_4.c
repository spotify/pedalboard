 ...
 * -pipeline-latency 4 -n 4 -name r2cfII_4 -dft-II -include rdft/scalar/r2cfII.h
 */
...
static void r2cfII_4(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
                     stride csi, INT v, INT ivs, INT ovs) {
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    INT i;
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(16, rs),
