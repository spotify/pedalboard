 ...
 * -pipeline-latency 4 -twiddle-log3 -precompute-twiddles -n 25 -dit -name
 * hf2_25 -include rdft/scalar/hf.h */
...
static void hf2_25(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 8, MAKE_VOLATILE_STRIDE(50, rs)) {
      ...
      {
        E T1, T7l, T4s, T6a, T7u, T7U, TM, T4f, T4g, T7o, T7p, T7q, T4z, T6n,
            T4G;
        E T6k, T3a, T6m, T4w, T4a, T6j, T4D, T54, T6C, T5b, T6z, T1v, T6y, T58,
            T3t;
        E T6B, T51, T5j, T6v, T5q, T6s, T21, T6r, T5n, T3H, T6u, T5g, T4O, T6d,
            T4V;
        ...
        {
          E T2G, T3Y, T2Z, T37, T38, T45, T47, T48, T2K, T2S, T2T, T40, T42,
              T43;
          {
            E T2D, T2E, T2F, T3X;
            T2D = cr[WS(rs, 3)];
        ...
        {
          E T1z, T3v, T1Q, T1Y, T1Z, T3C, T3E, T3F, T1D, T1H, T1I, T3x, T3z,
              T3A;
          {
            E T1w, T1x, T1y, T3u;
            T1w = cr[WS(rs, 4)];
        ...
        {
          E T26, T3K, T2r, T2z, T2A, T3R, T3T, T3U, T2c, T2k, T2l, T3M, T3O,
              T3P;
          {
            E T23, T24, T25, T3J;
            T23 = cr[WS(rs, 2)];
        ...
        {
          E T4t, T5H, T7V, T87, T5A, T5D, T8f, T8e, T88, T89, T8a, T4Y, T5t,
              T5u, T62;
        ...
        {
          E T6b, T6T, T7v, T7H, T6M, T6P, T7P, T7O, T7I, T7J, T7K, T6q, T6F,
              T6G, T7e;
...
static const hc2hc_desc desc = {
    25, "hf2_25", twinstr, &GENUS, {84, 78, 356, 0}};

void X(codelet_hf2_25)(planner *p) { X(khc2hc_register)(p, hf2_25, &desc); }
#else
...
static void hf2_25(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
      ...
      {
        E T1, T6v, T2F, T6A, TK, T2G, T6y, T6z, T6u, T71, T2O, T52, T2C, T6k,
            T4c;
        E T5X, T4L, T5s, T4j, T5W, T4K, T5v, T1o, T6g, T30, T5M, T4A, T56, T3b,
            T5N;
        E T4B, T59, T1L, T6h, T3r, T5P, T4E, T5d, T3y, T5Q, T4D, T5g, T2d, T6j,
            T3P;
        ...
        {
          E T2g, T48, T3Y, T3Z, T4h, T4g, T43, T46, T49, T2p, T2A, T2B, T2e,
              T2f;
          T2e = cr[WS(rs, 3)];
          T2f = ci[WS(rs, 3)];
        ...
        {
          E T1r, T3n, T3d, T3e, T3w, T3v, T3i, T3l, T3o, T1y, T1J, T1K, T1p,
              T1q;
          T1p = cr[WS(rs, 4)];
          T1q = ci[WS(rs, 4)];
        ...
        {
          E T1P, T3L, T3B, T3C, T3U, T3T, T3G, T3J, T3M, T20, T2b, T2c, T1N,
              T1O;
          T1N = cr[WS(rs, 2)];
          T1O = ci[WS(rs, 2)];
        ...
        {
          E T2P, T4z, T72, T7e, T4m, T7j, T4n, T7i, T4U, T77, T4X, T75, T4O,
              T6Y, T4P;
        ...
        {
          E T53, T5L, T6C, T6O, T5y, T6T, T5z, T6S, T66, T6H, T69, T6F, T60,
              T6q, T61;
...
static const hc2hc_desc desc = {
    25, "hf2_25", twinstr, &GENUS, {280, 180, 160, 0}};
