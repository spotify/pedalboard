 ...
 * -pipeline-latency 4 -n 8 -dit -name hc2cfdft_8 -include rdft/scalar/hc2cf.h
 */
...
static void hc2cfdft_8(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    8, "hc2cfdft_8", twinstr, &GENUS, {60, 30, 22, 0}};
...
static const hc2c_desc desc = {
    8, "hc2cfdft_8", twinstr, &GENUS, {68, 30, 14, 0}};
