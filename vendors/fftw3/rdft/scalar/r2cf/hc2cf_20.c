 ...
 * -pipeline-latency 4 -n 20 -dit -name hc2cf_20 -include rdft/scalar/hc2cf.h */
...
static void hc2cf_20(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                     INT me, INT ms) {
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 38); m < me; m = m + 1, Rp = Rp + ms,
      ...
      E T3F, T27, T2f, T43, T4b, T2R, T3z, T33, T3J, T1G, T2e, T40, T4c, T2K,
          T3y;
...
static const hc2c_desc desc = {
    20, "hc2cf_20", twinstr, &GENUS, {136, 38, 110, 0}};
...
static void hc2cf_20(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 38); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 38,
        MAKE_VOLATILE_STRIDE(80, rs)) {
      E Tj, T1R, T4j, T4s, T2q, T37, T3Q, T42, T1r, T1O, T1P, T3p, T3s, T3K,
          T3A;
      E T3B, T3Z, T1V, T1W, T1X, T23, T28, T4q, T2W, T2X, T4f, T33, T34, T35,
          T2G;
      E T2L, T2M, TG, T13, T14, T3i, T3l, T3J, T3D, T3E, T40, T1S, T1T, T1U,
          T2e;
      ...
      {
        E T1f, T3n, T21, T2C, T1N, T3r, T27, T2K, T1q, T3o, T22, T2F, T1C, T3q,
            T26;
        E T2H;
        {
          E T19, T1Z, T1e, T20;
      ...
      {
        E Tu, T3g, T2c, T2r, T12, T3k, T2f, T2z, TF, T3h, T2d, T2u, TR, T3j,
            T2i;
        E T2w;
        {
          E To, T2a, Tt, T2b;
...
static const hc2c_desc desc = {
    20, "hc2cf_20", twinstr, &GENUS, {184, 62, 62, 0}};
