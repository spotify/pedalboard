 ...
 * -pipeline-latency 4 -n 32 -dit -name hc2cf_32 -include rdft/scalar/hc2cf.h */
...
static void hc2cf_32(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                     INT me, INT ms) {
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 62); m < me; m = m + 1, Rp = Rp + ms,
      ...
      E T5U, T11, T1e, T6M, T6J, T6K, T6L, T3Z, T5Y, T46, T5X, T1s, T1F, T6O,
          T6P;
      E T6Q, T6R, T4e, T61, T4l, T60, T32, T7b, T79, T7N, T54, T6c, T5r, T6f,
          T29;
      E T70, T6X, T7I, T4v, T65, T4S, T68, T3t, T76, T7e, T7O, T5b, T5s, T5i,
          T5t;
      ...
      {
        E TO, T7C, T7Z, T80, T89, T8e, T1H, T8d, T3v, T8b, T7L, T7T, T7Q, T7U,
            T7F;
        E T81;
        {
          E Tm, TN, T7X, T7Y;
      ...
      {
        E T6I, T7m, T7w, T7A, T8l, T8r, T6T, T8m, T75, T7j, T7p, T8s, T7t, T7z,
            T7g;
        E T7k;
        {
          E T6E, T6H, T7u, T7v;
      ...
      {
        E T3S, T5C, T4n, T8I, T8B, T8H, T5F, T8C, T5w, T5Q, T5A, T5M, T4X, T5P,
            T5z;
        E T5J;
        {
          E T3C, T3R, T5D, T5E;
      ...
      {
        E T5W, T6o, T63, T8W, T8P, T8V, T6r, T8Q, T6i, T6C, T6m, T6y, T6b, T6B,
            T6l;
        E T6v;
        {
          E T5S, T5V, T6p, T6q;
...
static const hc2c_desc desc = {
    32, "hc2cf_32", twinstr, &GENUS, {236, 62, 198, 0}};
...
static void hc2cf_32(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 62); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 62,
        MAKE_VOLATILE_STRIDE(128, rs)) {
      E Tj, T5F, T7C, T7Q, T35, T4T, T78, T7m, T1Q, T61, T5Y, T6J, T3K, T59,
          T41;
      E T56, T2B, T67, T6e, T6O, T4b, T5d, T4s, T5g, TG, T7l, T5I, T73, T3a,
          T4U;
      E T3f, T4V, T14, T5N, T5M, T6E, T3m, T4Y, T3r, T4Z, T1r, T5P, T5S, T6F,
          T3x;
      E T51, T3C, T52, T2d, T5Z, T64, T6K, T3V, T57, T44, T5a, T2Y, T6f, T6a,
          T6P;
      E T4m, T5h, T4v, T5e;
      {
      ...
      {
        E T5J, T7n, T7t, T6n, T5U, T7k, T6x, T6B, T6q, T7s, T66, T6k, T6u, T6A,
            T6h;
        E T6l;
        {
          E T5O, T5T, T60, T65;
      ...
      {
        E T3h, T4D, T7R, T7X, T3E, T7O, T4N, T4R, T46, T4A, T4G, T7W, T4K, T4Q,
            T4x;
        E T4B, T3g, T7P;
      ...
      {
        E T4X, T5p, T7D, T7J, T54, T7y, T5z, T5D, T5c, T5m, T5s, T7I, T5w, T5C,
            T5j;
        E T5n, T4W, T7z;
...
static const hc2c_desc desc = {
    32, "hc2cf_32", twinstr, &GENUS, {340, 114, 94, 0}};
