 ...
 * -pipeline-latency 4 -n 7 -name r2cf_7 -include rdft/scalar/r2cf.h */
...
static void r2cf_7(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP356895867, +0.356895867892209443894399510021300583399127187);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(28, rs),
...
static void r2cf_7(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP974927912, +0.974927912181823607018131682993931217232785801);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
      ...
      Ci[WS(csi, 2)] =
          FNMS(KP781831482, Tc, KP974927912 * Tb) - (KP433883739 * Td);
      Ci[WS(csi, 1)] =
          FMA(KP781831482, Tb, KP974927912 * Td) + (KP433883739 * Tc);
      Cr[WS(csr, 2)] =
          FMA(KP623489801, T7, T1) + FNMA(KP900968867, T4, KP222520933 * Ta);
      Ci[WS(csi, 3)] =
          FMA(KP433883739, Tb, KP974927912 * Tc) - (KP781831482 * Td);
      Cr[WS(csr, 3)] =
          FMA(KP623489801, T4, T1) + FNMA(KP222520933, T7, KP900968867 * Ta);
      Cr[WS(csr, 1)] =
          FMA(KP623489801, Ta, T1) + FNMA(KP900968867, T7, KP222520933 * T4);
      Cr[0] = T1 + Ta + T4 + T7;
    }
  }
}
