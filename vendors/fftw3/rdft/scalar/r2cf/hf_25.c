 ...
 * -pipeline-latency 4 -n 25 -dit -name hf_25 -include rdft/scalar/hf.h */
...
static void hf_25(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 48); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 48, MAKE_VOLATILE_STRIDE(50, rs)) {
      E T1, T6R, T3Y, T5G, T70, T7q, Ts, T3L, T3M, T6U, T6V, T6W, T45, T5T, T4c;
      E T5Q, T2G, T5S, T42, T3G, T5P, T49, T4A, T68, T4H, T65, T11, T64, T4E,
          T2Z;
      E T67, T4x, T4P, T61, T4W, T5Y, T1z, T5X, T4T, T3d, T60, T4M, T4k, T5J,
          T4r;
      ...
      {
        E T3Z, T5d, T7r, T7D, T56, T59, T7L, T7K, T7E, T7F, T7G, T4u, T4Z, T50,
            T5y;
      ...
      {
        E T5H, T6p, T71, T7d, T6i, T6l, T7l, T7k, T7e, T7f, T7g, T5W, T6b, T6c,
            T6K;
...
static const tw_instr twinstr[] = {{TW_FULL, 1, 25}, {TW_NEXT, 1, 0}};

static const hc2hc_desc desc = {25, "hf_25", twinstr, &GENUS, {84, 48, 316, 0}};

void X(codelet_hf_25)(planner *p) { X(khc2hc_register)(p, hf_25, &desc); }
#else
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 48); m < me; m = m + 1, cr = cr + ms,
      ...
      E T5D, T4r, T58, T3Z, T5C, T4q, T5b, TS, T5W, T2G, T5s, T4g, T4M, T2R,
          T5t;
      E T4h, T4P, T1l, T5X, T37, T5v, T4k, T4T, T3e, T5w, T4j, T4W, T1P, T5Z,
          T3v;
      ...
      {
        E T2v, T4f, T6I, T6U, T42, T6Z, T43, T6Y, T4A, T6N, T4D, T6L, T4u, T6E,
            T4v;
      ...
      {
        E T4J, T5r, T6i, T6u, T5e, T6z, T5f, T6y, T5M, T6n, T5P, T6l, T5G, T66,
            T5H;
...
static const hc2hc_desc desc = {
    25, "hf_25", twinstr, &GENUS, {260, 140, 140, 0}};
