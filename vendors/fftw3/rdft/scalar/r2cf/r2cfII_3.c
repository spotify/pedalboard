 ...
 * -pipeline-latency 4 -n 3 -name r2cfII_3 -dft-II -include rdft/scalar/r2cfII.h
 */
...
static void r2cfII_3(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP866025403, +0.866025403784438646763723170752936183471402627);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(12, rs),
