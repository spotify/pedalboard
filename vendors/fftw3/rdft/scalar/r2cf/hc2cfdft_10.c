 ...
 * -pipeline-latency 4 -n 10 -dit -name hc2cfdft_10 -include rdft/scalar/hc2cf.h
 */
...
static void hc2cfdft_10(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    10, "hc2cfdft_10", twinstr, &GENUS, {68, 38, 54, 0}};
...
static const hc2c_desc desc = {
    10, "hc2cfdft_10", twinstr, &GENUS, {92, 38, 30, 0}};
