 ...
 * -pipeline-latency 4 -n 10 -dit -name hc2cf_10 -include rdft/scalar/hc2cf.h */
...
static void hc2cf_10(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                     INT me, INT ms) {
...
static const hc2c_desc desc = {
    10, "hc2cf_10", twinstr, &GENUS, {48, 18, 54, 0}};
...
static const hc2c_desc desc = {
    10, "hc2cf_10", twinstr, &GENUS, {72, 30, 30, 0}};
