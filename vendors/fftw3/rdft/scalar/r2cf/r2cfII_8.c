 ...
 * -pipeline-latency 4 -n 8 -name r2cfII_8 -dft-II -include rdft/scalar/r2cfII.h
 */
...
static void r2cfII_8(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP414213562, +0.414213562373095048801688724209698078569671875);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(32, rs),
        MAKE_VOLATILE_STRIDE(32, csr), MAKE_VOLATILE_STRIDE(32, csi)) {
