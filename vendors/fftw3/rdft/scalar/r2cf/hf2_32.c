 ...
 * hf2_32 -include rdft/scalar/hf.h */
...
static void hf2_32(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
      ...
      {
        E Tq, T46, T8H, T98, TH, T97, T4b, T8D, TZ, T7g, T4j, T6t, T1g, T7f,
            T4q;
        E T6u, T1v, T1I, T7j, T7k, T7l, T7m, T4z, T6y, T4G, T6x, T22, T2j, T7o,
            T7p;
        E T7q, T7r, T4O, T6B, T4V, T6A, T3G, T7G, T7N, T8n, T5E, T6M, T61, T6P,
            T2N;
        E T7v, T7C, T8i, T55, T6F, T5s, T6I, T43, T7O, T7J, T8o, T5L, T63, T5S,
            T62;
        ...
        {
          E T4s, T6c, T4X, T9c, T9b, T9h, T6f, T9i, T66, T6q, T6a, T6m, T5x,
              T6p, T69;
          E T6j;
          {
            E T4c, T4r, T6d, T6e;
        ...
        {
          E T7i, T7W, T86, T8a, T8V, T91, T7t, T8W, T7F, T7U, T7Z, T92, T83,
              T89, T7Q;
          E T7T;
          {
            E T7e, T7h, T84, T85;
        ...
        {
          E T6w, T6Y, T6D, T9w, T9p, T9v, T71, T9q, T6S, T7c, T6V, T78, T6L,
              T7b, T6W;
          E T75;
          {
            E T6s, T6v, T6Z, T70;
...
static const hc2hc_desc desc = {
    32, "hf2_32", twinstr, &GENUS, {236, 98, 252, 0}};

void X(codelet_hf2_32)(planner *p) { X(khc2hc_register)(p, hf2_32, &desc); }
#else
...
static void hf2_32(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
      ...
      {
        E TL, T6f, T8c, T8q, T3F, T5t, T7I, T7W, T2y, T6B, T6y, T7j, T4k, T5G,
            T4B;
        E T5J, T3h, T6H, T6O, T7o, T4L, T5Q, T52, T5N, T1i, T7V, T6i, T7D, T3K,
            T5u;
        E T3P, T5v, T1E, T6k, T6n, T7f, T3W, T5z, T41, T5y, T29, T6p, T6s, T7e,
            T47;
        E T5C, T4c, T5B, T2R, T6z, T6E, T7k, T4v, T5K, T4E, T5H, T3y, T6P, T6K,
            T7p;
        E T4W, T5O, T55, T5R;
        {
...
static const hc2hc_desc desc = {
    32, "hf2_32", twinstr, &GENUS, {376, 168, 112, 0}};
