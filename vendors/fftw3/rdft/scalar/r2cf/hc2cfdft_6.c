 ...
 * -pipeline-latency 4 -n 6 -dit -name hc2cfdft_6 -include rdft/scalar/hc2cf.h
 */
...
static void hc2cfdft_6(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
                       INT mb, INT me, INT ms) {
  DK(KP866025403, +0.866025403784438646763723170752936183471402627);
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 10); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 10,
...
static const tw_instr twinstr[] = {{TW_FULL, 1, 6}, {TW_NEXT, 1, 0}};

static const hc2c_desc desc = {
    6, "hc2cfdft_6", twinstr, &GENUS, {36, 22, 22, 0}};
...
static const hc2c_desc desc = {
    6, "hc2cfdft_6", twinstr, &GENUS, {44, 22, 14, 0}};
