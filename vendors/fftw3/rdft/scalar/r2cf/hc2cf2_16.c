 ...
 * hc2cf2_16 -include rdft/scalar/hc2cf.h */
...
static void hc2cf2_16(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                      INT me, INT ms) {
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, Rp = Rp + ms,
      ...
      {
        E Te, T1U, T3A, T3L, T1G, T2D, T2B, T3h, T1R, T2w, T2I, T3i, Tx, T3M,
            T1Z;
...
static const hc2c_desc desc = {
    16, "hc2cf2_16", twinstr, &GENUS, {104, 42, 92, 0}};
...
static const hc2c_desc desc = {
    16, "hc2cf2_16", twinstr, &GENUS, {156, 68, 40, 0}};
