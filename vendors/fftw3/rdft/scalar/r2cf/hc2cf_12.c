 ...
 * -pipeline-latency 4 -n 12 -dit -name hc2cf_12 -include rdft/scalar/hc2cf.h */
...
static void hc2cf_12(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                     INT me, INT ms) {
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 22); m < me; m = m + 1, Rp = Rp + ms,
      ...
      {
        E T1m, T1K, T2q, T2z, T2t, T2y, T1t, T1L, T1B, T1N, T1W, T25, T22, T26,
            T1I;
        E T1O;
        {
          E T1g, T2o, T2r, T1n;
...
static const hc2c_desc desc = {
    12, "hc2cf_12", twinstr, &GENUS, {72, 22, 46, 0}};
...
static const hc2c_desc desc = {
    12, "hc2cf_12", twinstr, &GENUS, {88, 30, 30, 0}};
