 ...
 * -pipeline-latency 4 -n 4 -dit -name hc2cfdft_4 -include rdft/scalar/hc2cf.h
 */
...
static void hc2cfdft_4(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    4, "hc2cfdft_4", twinstr, &GENUS, {24, 14, 6, 0}};
