 ...
 * -pipeline-latency 4 -n 32 -name r2cf_32 -include rdft/scalar/r2cf.h */
...
static void r2cf_32(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP414213562, +0.414213562373095048801688724209698078569671875);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(128, rs),
        MAKE_VOLATILE_STRIDE(128, csr), MAKE_VOLATILE_STRIDE(128, csi)) {
      E T7, T2b, Tv, T1h, Te, T2n, Ty, T1i, Tt, T2d, TF, T1l, Tm, T2c, TC;
      E T1k, T1Z, T22, T2k, T2j, T1e, T1C, T19, T1B, T1S, T1V, T2h, T2g, TX,
          T1z;
      E TS, T1y;
      {
        E T1, T2, T3, T4, T5, T6;
...
static void r2cf_32(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
      ...
      E T1i, T1Z, T22, T2k, T2j, T1e, T1C, T19, T1B, T1S, T1V, T2h, T2g, TX,
          T1z;
      E TS, T1y;
      {
        E T1, T2, T3, T4, T5, T6;
