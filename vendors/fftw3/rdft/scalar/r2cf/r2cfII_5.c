 ...
 * -pipeline-latency 4 -n 5 -name r2cfII_5 -dft-II -include rdft/scalar/r2cfII.h
 */
...
static void r2cfII_5(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP951056516, +0.951056516295153572116439333379382143405698634);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(20, rs),
        MAKE_VOLATILE_STRIDE(20, csr), MAKE_VOLATILE_STRIDE(20, csi)) {
