 ...
 * hc2cf2_20 -include rdft/scalar/hc2cf.h */
...
static void hc2cf2_20(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                      INT me, INT ms) {
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, Rp = Rp + ms,
      ...
      {
        E Te, T2C, T4L, T57, TD, T58, T2H, T4H, T11, T2v, T4d, T4z, T2P, T3P,
            T3J;
        E T3Z, T2r, T2z, T4n, T4v, T3b, T3T, T3n, T43, T20, T2y, T4k, T4w, T34,
            T3S;
...
static const hc2c_desc desc = {
    20, "hc2cf2_20", twinstr, &GENUS, {136, 58, 140, 0}};
...
static void hc2cf2_20(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, Rp = Rp + ms,
      ...
      {
        E TF, T2b, T4D, T4M, T2K, T3r, T4a, T4m, T1N, T28, T29, T3J, T3M, T44,
            T3U;
        E T3V, T4j, T2f, T2g, T2h, T2n, T2s, T4K, T3g, T3h, T4z, T3n, T3o, T3p,
            T30;
        E T35, T36, TW, T1r, T1s, T3C, T3F, T43, T3X, T3Y, T4k, T2c, T2d, T2e,
            T2y;
        ...
        {
          E T1D, T3H, T2l, T2W, T27, T3L, T2r, T34, T1M, T3I, T2m, T2Z, T1W,
              T3K, T2q;
          E T31;
          {
            E T1x, T2j, T1C, T2k;
        ...
        {
          E TO, T3A, T2w, T2L, T1q, T3E, T2z, T2T, TV, T3B, T2x, T2O, T1b, T3D,
              T2C;
          E T2Q;
          {
            E TI, T2u, TN, T2v;
...
static const hc2c_desc desc = {
    20, "hc2cf2_20", twinstr, &GENUS, {204, 92, 72, 0}};
