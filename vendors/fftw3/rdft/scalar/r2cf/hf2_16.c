 ...
 * hf2_16 -include rdft/scalar/hf.h */
...
static void hf2_16(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
      ...
      {
        E Te, T1U, T3A, T3M, T1G, T2w, T2I, T3h, T1R, T2D, T2B, T3i, Tx, T3L,
            T1Z;
        E T3w, TL, T21, T26, T38, T1d, T2h, T2s, T3c, T1s, T2t, T2m, T3d, T12,
            T28;
        E T2d, T37;
        {
        ...
        {
          E T20, T3N, T3T, T2Q, T2f, T3U, T30, T33, T2T, T3O, T2v, T2N, T2X,
              T34, T2K;
          E T2O;
          {
            E T27, T2e, T2n, T2u;
...
static const hc2hc_desc desc = {
    16, "hf2_16", twinstr, &GENUS, {104, 42, 92, 0}};

void X(codelet_hf2_16)(planner *p) { X(khc2hc_register)(p, hf2_16, &desc); }
#else
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
      ...
      }
      {
        ...
        E T2x, T1B, T1K, T2V, T2W, T2X, T2Y, T2j, T2E, T2o, T2D, T18, T1n, T2Q,
            T2R;
...
static const hc2hc_desc desc = {
    16, "hf2_16", twinstr, &GENUS, {156, 68, 40, 0}};
