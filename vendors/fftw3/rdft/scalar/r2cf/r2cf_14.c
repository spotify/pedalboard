 ...
 * -pipeline-latency 4 -n 14 -name r2cf_14 -include rdft/scalar/r2cf.h */
...
static void r2cf_14(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP554958132, +0.554958132087371191422194871006410481067288862);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(56, rs),
        MAKE_VOLATILE_STRIDE(56, csr), MAKE_VOLATILE_STRIDE(56, csi)) {
  ...
  DK(KP781831482, +0.781831482468029808708444526674057750232334519);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
      ...
      }
      {
        ...
        Tq = T9 - T6;
        Ci[WS(csi, 1)] =
            FMA(KP781831482, Tp, KP974927912 * Tq) + (KP433883739 * Tr);
        Ci[WS(csi, 5)] =
            FMA(KP433883739, Tq, KP781831482 * Tr) - (KP974927912 * Tp);
        Ci[WS(csi, 3)] =
            FMA(KP433883739, Tp, KP974927912 * Tr) - (KP781831482 * Tq);
        Ta = T6 + T9;
        To = Tk + Tn;
        Th = Td + Tg;
        Cr[WS(csr, 3)] =
            FMA(KP623489801, Ta, T3) + FNMA(KP222520933, Th, KP900968867 * To);
        Cr[WS(csr, 7)] = T3 + To + Ta + Th;
        Cr[WS(csr, 1)] =
            FMA(KP623489801, To, T3) + FNMA(KP900968867, Th, KP222520933 * Ta);
        Cr[WS(csr, 5)] =
            FMA(KP623489801, Th, T3) + FNMA(KP900968867, Ta, KP222520933 * To);
      }
      {
        E Tu, TA, Tx, TC, TE, TD;
        Tu = Ts - Tt;
        ...
        Tx = Tv - Tw;
        Ci[WS(csi, 2)] =
            FMA(KP974927912, Tu, KP433883739 * Tx) + (KP781831482 * TA);
        Ci[WS(csi, 6)] =
            FMA(KP974927912, Tx, KP433883739 * TA) - (KP781831482 * Tu);
        Ci[WS(csi, 4)] =
            FNMS(KP781831482, Tx, KP974927912 * TA) - (KP433883739 * Tu);
        TC = Tt + Ts;
        TE = Tv + Tw;
        TD = Ty + Tz;
        Cr[WS(csr, 6)] =
            FMA(KP623489801, TC, TB) + FNMA(KP900968867, TD, KP222520933 * TE);
        Cr[WS(csr, 2)] =
            FMA(KP623489801, TD, TB) + FNMA(KP900968867, TE, KP222520933 * TC);
        Cr[WS(csr, 4)] =
            FMA(KP623489801, TE, TB) + FNMA(KP222520933, TD, KP900968867 * TC);
        Cr[0] = TB + TC + TE + TD;
      }
    }
  }
