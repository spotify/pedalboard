 ...
 * -pipeline-latency 4 -n 64 -name r2cfII_64 -dft-II -include
...
static void r2cfII_64(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(256, rs),
        MAKE_VOLATILE_STRIDE(256, csr), MAKE_VOLATILE_STRIDE(256, csi)) {
      E Tm, T35, T3Z, T5h, Tv, T34, T3W, T5g, Td, T33, T6z, T6N, T3T, T5f, T65;
      E T6j, T2b, T3n, T4O, T5C, T2C, T3q, T4D, T5z, TK, T3b, T4e, T5l, TR, T3c;
      E T4b, T5k, T15, T38, T47, T5o, T1c, T39, T44, T5n, T1s, T3g, T4v, T5v,
          T1T;
      E T3j, T4k, T5s, T2u, T3r, T4R, T5A, T2F, T3o, T4K, T5D, T1L, T3k, T4y,
          T5t;
      E T1W, T3h, T4r, T5w;
      {
        E Te, Tj, Th, Tk, Tf, Tg;
      ...
      {
        E Tx, T2N, T6P, T6V, T1e, T6Q, T2X, T31, T1Y, T2L, T2Q, T6W, T2U, T30,
            T2H;
        E T2K, Tw, T6O;
        Tw = Tm - Tv;
      ...
      {
        E T5j, T5L, T67, T6d, T5q, T68, T5V, T5Z, T5y, T5J, T5O, T6e, T5S, T5Y,
            T5F;
        E T5I, T5i, T66;
        T5i = T5g - T5h;
      ...
      {
        E T37, T3z, T6B, T6H, T3e, T6C, T3J, T3M, T3m, T3w, T3C, T6I, T3G, T3N,
            T3t;
        E T3x, T36, T6A;
        T36 = T34 - T35;
      ...
      {
        E T41, T4Z, T6l, T6r, T4g, T6m, T59, T5c, T4A, T4W, T52, T6s, T56, T5d,
            T4T;
        E T4X, T40, T6k;
        T40 = T3W - T3Z;
...
static void r2cfII_64(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
      ...
      E T44, T5o, T15, T38, T4e, T5l, T1c, T39, T4b, T5k, T1s, T3g, T4v, T5w,
          T1W;
      E T3k, T4k, T5s, T2u, T3q, T4R, T5A, T2y, T3o, T4H, T5C, T1L, T3j, T4y,
          T5t;
      E T1P, T3h, T4r, T5v;
      {
        E Te, Tk, Th, Tj, Tf, Tg;
      ...
      {
        E Tx, T2N, T69, T6f, T1e, T6e, T2X, T30, T1Y, T2L, T2Q, T62, T2U, T31,
            T2H;
        E T2K, Tw, T63;
        Tw = Tm + Tv;
        Tx = Td + Tw;
      ...
      {
        E T5j, T5L, T6R, T6X, T5q, T6W, T5V, T5Y, T5y, T5J, T5O, T6O, T5S, T5Z,
            T5F;
        E T5I, T5i, T6P;
        T5i = T5g - T5h;
        T5j = T5f - T5i;
      ...
      {
        E T37, T3z, T6n, T6t, T3e, T6s, T3J, T3M, T3m, T3x, T3C, T6k, T3G, T3N,
            T3t;
        E T3w, T36, T6l;
        T36 = T34 + T35;
        T37 = T33 - T36;
      ...
      {
        E T41, T4Z, T6D, T6J, T4g, T6I, T59, T5d, T4A, T4X, T52, T6y, T56, T5c,
            T4T;
        E T4W, T40, T6C;
        T40 = T3W - T3Z;
        T41 = T3T + T40;
