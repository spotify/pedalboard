 ...
 * -pipeline-latency 4 -twiddle-log3 -precompute-twiddles -n 20 -dit -name
 * hf2_20 -include rdft/scalar/hf.h */
...
static void hf2_20(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
      ...
      {
        E Te, T2C, T4K, T57, TD, T58, T2H, T4L, T11, T2v, T4n, T4v, T2P, T3P,
            T3u;
        E T3Z, T2r, T2z, T4d, T4z, T3b, T3T, T3C, T43, T20, T2y, T4g, T4y, T34,
            T3S;
...
static const hc2hc_desc desc = {
    20, "hf2_20", twinstr, &GENUS, {136, 58, 140, 0}};

void X(codelet_hf2_20)(planner *p) { X(khc2hc_register)(p, hf2_20, &desc); }
#else
...
static void hf2_20(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
      ...
      {
        E TF, T2b, T4D, T4M, T2K, T3r, T4a, T4m, T1N, T28, T29, T3C, T3F, T43,
            T3X;
        E T3Y, T4o, T2f, T2g, T2h, T2y, T2D, T2E, T3g, T3h, T4z, T3n, T3o, T3p,
            T33;
        E T38, T4K, TW, T1r, T1s, T3J, T3M, T44, T3U, T3V, T4n, T2c, T2d, T2e,
            T2n;
        ...
        {
          E T1D, T3A, T2u, T31, T27, T3D, T2C, T37, T1M, T3B, T2x, T32, T1W,
              T3E, T2z;
          E T36;
          {
            E T1x, T2Z, T1C, T30;
        ...
        {
          E TO, T3H, T2j, T2Q, T1q, T3L, T2r, T2T, TV, T3I, T2m, T2R, T1b, T3K,
              T2o;
          E T2W;
          {
            E TI, T2O, TN, T2P;
...
static const hc2hc_desc desc = {
    20, "hf2_20", twinstr, &GENUS, {204, 92, 72, 0}};
