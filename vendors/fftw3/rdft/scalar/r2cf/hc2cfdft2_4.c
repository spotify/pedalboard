 ...
 * -pipeline-latency 4 -twiddle-log3 -precompute-twiddles -n 4 -dit -name
 * hc2cfdft2_4 -include rdft/scalar/hc2cf.h */
...
static void hc2cfdft2_4(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
                        INT mb, INT me, INT ms) {
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 4); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 4,
...
static const hc2c_desc desc = {
    4, "hc2cfdft2_4", twinstr, &GENUS, {24, 16, 8, 0}};
