 ...
 * -pipeline-latency 4 -n 32 -dit -name hf_32 -include rdft/scalar/hf.h */
...
static void hf_32(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 62); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 62, MAKE_VOLATILE_STRIDE(64, rs)) {
      E T8, T8y, T3w, T87, Tl, T8x, T3B, T83, Tz, T6G, T3J, T5T, TM, T6F, T3Q;
      E T5U, T11, T1e, T6J, T6K, T6L, T6M, T3Z, T5Y, T46, T5X, T1s, T1F, T6O,
          T6P;
      E T6Q, T6R, T4e, T61, T4l, T60, T32, T76, T7d, T7N, T54, T6c, T5r, T6f,
          T29;
      E T6V, T72, T7I, T4v, T65, T4S, T68, T3t, T7e, T79, T7O, T5b, T5t, T5i,
          T5s;
      ...
      {
        E T6I, T7m, T7w, T7A, T8l, T8r, T6T, T8m, T75, T7k, T7p, T8s, T7t, T7z,
            T7g;
        E T7j;
        {
          E T6E, T6H, T7u, T7v;
      ...
      {
        E T5W, T6o, T63, T8W, T8P, T8V, T6r, T8Q, T6i, T6C, T6l, T6y, T6b, T6B,
            T6m;
        E T6v;
        {
          E T5S, T5V, T6p, T6q;
...
static const hc2hc_desc desc = {
    32, "hf_32", twinstr, &GENUS, {236, 62, 198, 0}};

void X(codelet_hf_32)(planner *p) { X(khc2hc_register)(p, hf_32, &desc); }
#else
...
static void hf_32(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 62); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 62, MAKE_VOLATILE_STRIDE(64, rs)) {
      E Tj, T5F, T7C, T7Q, T35, T4T, T78, T7m, T1Q, T61, T5Y, T6J, T3K, T56,
          T41;
      E T59, T2B, T67, T6e, T6O, T4b, T5g, T4s, T5d, TG, T7l, T5I, T73, T3a,
          T4U;
      E T3f, T4V, T14, T5K, T5N, T6F, T3m, T4Z, T3r, T4Y, T1r, T5P, T5S, T6E,
          T3x;
      E T52, T3C, T51, T2d, T5Z, T64, T6K, T3V, T5a, T44, T57, T2Y, T6f, T6a,
          T6P;
      E T4m, T5e, T4v, T5h;
      {
...
static const hc2hc_desc desc = {
    32, "hf_32", twinstr, &GENUS, {340, 114, 94, 0}};
