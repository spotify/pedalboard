 ...
 * -pipeline-latency 4 -n 16 -dit -name hc2cfdft_16 -include rdft/scalar/hc2cf.h
 */
...
static void hc2cfdft_16(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 30); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 30,
        MAKE_VOLATILE_STRIDE(64, rs)) {
      E T1f, T2e, T1c, T2g, T1K, T3D, T2W, T3H, TR, T2j, T2R, T3E, T11, T2l,
          T1v;
      E T3G, Ta, T2p, Tk, T2r, T3o, T3p, T1Y, T3z, T2G, T3w, Tv, T2u, TF, T2w;
      E T3r, T3s, T2b, T3A, T2L, T3x;
      {
        E T1d, T1e, T1I, T16, T1A, T1D, T1E, T1C, T1G, T1H, T2U, T1b, T1z, T2S,
            T1w;
        E T1y, T14, T15;
        T1d = Ip[0];
        T1e = Im[0];
      ...
      {
        E TH, T3c, T36, T3g, T39, T3h, T1h, T32, T2d, T2A, T2y, T31, T2Y, T30,
            T2n;
        E T3b;
        {
          E Tl, TG, T34, T35;
      ...
      {
        E T3n, T3Z, T44, T4e, T47, T4f, T3u, T4a, T3C, T3U, T3N, T49, T3Q, T40,
            T3J;
        E T3V;
        {
          E T3l, T3m, T42, T43;
...
static const hc2c_desc desc = {
    16, "hc2cfdft_16", twinstr, &GENUS, {136, 62, 70, 0}};
...
static void hc2cfdft_16(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 30); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 30,
        MAKE_VOLATILE_STRIDE(64, rs)) {
      E T19, T3h, T21, T2Y, T1o, T3d, T2s, T39, TW, T3i, T24, T2Z, T1z, T3c,
          T2p;
      ...
      {
        E T30, T3w, T3F, T3j, T2X, T3G, T3D, T3L, T3m, T3v, T38, T3q, T3A, T3K,
            T3f;
        E T3r;
        {
          E T2T, T2W, T34, T37;
...
static const hc2c_desc desc = {
    16, "hc2cfdft_16", twinstr, &GENUS, {168, 62, 38, 0}};
