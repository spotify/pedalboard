 ...
 * -pipeline-latency 4 -n 20 -dit -name hf_20 -include rdft/scalar/hf.h */
...
static void hf_20(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 38); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 38, MAKE_VOLATILE_STRIDE(40, rs)) {
      E T8, T4N, T2i, T4q, Tl, T4O, T2n, T4r, TN, T2b, T43, T4b, T2v, T3v, T3a;
      E T3F, T27, T2f, T3T, T4f, T2R, T3z, T3i, T3J, T1G, T2e, T3W, T4e, T2K,
          T3y;
...
static const hc2hc_desc desc = {
    20, "hf_20", twinstr, &GENUS, {136, 38, 110, 0}};

void X(codelet_hf_20)(planner *p) { X(khc2hc_register)(p, hf_20, &desc); }
#else
...
static void hf_20(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 38); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 38, MAKE_VOLATILE_STRIDE(40, rs)) {
      E Tj, T1R, T4j, T4s, T2q, T37, T3Q, T42, T1r, T1O, T1P, T3i, T3l, T3J,
          T3D;
      E T3E, T44, T1V, T1W, T1X, T2e, T2j, T2k, T2W, T2X, T4f, T33, T34, T35,
          T2J;
      E T2O, T4q, TG, T13, T14, T3p, T3s, T3K, T3A, T3B, T43, T1S, T1T, T1U,
          T23;
      ...
      {
        E T1f, T3g, T2a, T2H, T1N, T3j, T2i, T2N, T1q, T3h, T2d, T2I, T1C, T3k,
            T2f;
        E T2M;
        {
          E T19, T2F, T1e, T2G;
      ...
      {
        E Tu, T3n, T1Z, T2w, T12, T3r, T27, T2z, TF, T3o, T22, T2x, TR, T3q,
            T24;
        E T2C;
        {
          E To, T2u, Tt, T2v;
