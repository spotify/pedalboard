 ...
 * -pipeline-latency 4 -n 64 -dit -name hf_64 -include rdft/scalar/hf.h */
...
static void hf_64(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 126); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 126, MAKE_VOLATILE_STRIDE(128, rs)) {
      E Tm, TeM, TjR, Tkl, T7e, TcA, TiV, Tjm, T1G, TeW, TeZ, Thr, T7Q, TcI,
          T7X;
      E TcJ, T29, Tf8, Tf5, Thw, T87, TcN, T8u, TcQ, T5K, TfS, Tgc, ThX, Taq,
          Tdm;
      E Tbj, Tdx, TN, Tjl, TeP, TiP, T7l, TcB, T7s, TcC, T1f, TeR, TeU, Ths,
          T7B;
      E TcF, T7I, TcG, T32, Tfj, Tfg, ThB, T8G, TcU, T93, TcX, T3X, Tfr, TfK,
          ThM;
      E T9h, Td3, Taa, Tde, T2A, Tf6, Tfb, Thx, T8m, TcR, T8x, TcO, T3t, Tfh,
          Tfm;
      E ThC, T8V, TcY, T96, TcV, T4o, TfL, Tfu, ThN, T9w, Tdf, Tad, Td4, T6b,
          Tg9;
      E TfV, ThY, TaF, Tdy, Tbm, Tdn, T4Q, ThJ, TfA, TfN, T9M, Tdh, Taf, Td8,
          T5h;
      E ThI, TfF, TfO, Ta1, Tdi, Tag, Tdb, T6D, ThU, Tg1, Tgf, TaV, TdA, Tbo,
          Tdr;
      ...
      {
        E T1I, Tio, T3v, Tj1, TiX, Tj2, Tir, TiN, T76, TiJ, TiC, TiG, T5j, TiK,
            Tix;
        E TiF;
        {
          E TO, T1H, Tip, Tiq;
      ...
      {
        E T99, Tk2, TbB, TjW, Taj, TbL, Tbv, TbF, Tce, Tcy, Tci, Tcu, Tc7, Tcx,
            Tch;
        E Tcr, TbZ, Tkg, Tcn, Tka, Tbs, TbM, Tbw, TbI, T80, Tk9, Tkf, Tby, TbS,
            TjV;
        E Tk1, Tck;
        {
          E T8z, Tbz, T98, TbA;
      ...
      {
        E Thu, Ti8, Tj9, Tjf, ThF, Tjg, Tib, Tja, ThR, Til, Ti6, Tif, Ti2, Tim,
            Ti5;
        E Tii;
        {
          E Thq, Tht, Tj7, Tj8;
      ...
      }
      {
        E Tf2, TjJ, Tgo, TjD, TgI, Tjv, Tha, Tjp, Tfp, Tjw, Tgr, Tjq, Th4, Tho,
            Th7;
        E Thk, TfR, TgB, Tgl, Tgv, TgP, TjK, Thd, TjE, TgX, Thn, Th8, Thh, Tgi,
            TgC;
        E Tgm, Tgy;
        {
      ...
      {
        E Td1, Tkw, TdN, Tkq, Tdl, TdX, TdI, TdR, Teq, TeK, Tet, TeG, Tej, TeJ,
            Teu;
        E TeD, Teb, TkK, Tez, TkE, TdE, TdY, TdH, TdU, TcM, TkD, TkJ, TdK, Te4,
            Tkp;
        E Tkv, Tew;
        {
          E TcT, TdM, Td0, TdL;
...
static const tw_instr twinstr[] = {{TW_FULL, 1, 64}, {TW_NEXT, 1, 0}};

static const hc2hc_desc desc = {
    64, "hf_64", twinstr, &GENUS, {520, 126, 518, 0}};

void X(codelet_hf_64)(planner *p) { X(khc2hc_register)(p, hf_64, &desc); }
#else
...
static void hf_64(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 126); m < me; m = m + 1, cr = cr + ms,
      ...
      E ThQ, T14, Tfr, T6y, T9O, TaG, Tc0, TcU, TeE, T1r, Tfq, T6J, T9P, TaJ,
          Tc1;
      E TcZ, TeF, T1Q, T2d, Tfu, Tfv, Tfw, Tfx, T6Q, TaM, Tdb, TeI, T71, TaQ,
          T7a;
      E TaN, Td6, TeJ, T77, TaP, T2B, T2Y, Tfz, TfA, TfB, TfC, T7h, TaW, Tdm,
          TeL;
      E T7s, TaU, T7B, TaX, Tdh, TeM, T7y, TaT, T5j, TfR, Tec, TeX, TfY, Tgy,
          T8D;
      E Tbl, T8O, Tbx, T9l, Tbm, TdV, Tf0, T9i, Tbw, T3M, TfL, TdL, TeT, TfI,
          Tgt;
      E T7K, Tbd, T7V, Tb3, T8s, Tbe, Tdu, TeQ, T8p, Tb2, T4x, TfJ, TdE, TdM,
          TfO;
      E Tgu, T87, T8u, T8i, T8v, Tba, Tbh, Tdz, TdN, Tb7, Tbg, T64, TfZ, Te5,
          Ted;
      ...
      {
        E T1y, T73, T1D, T74, T1E, Td7, T1J, T6N, T1O, T6O, T1P, Td8, T21, Td4,
            T6R;
      ...
      {
        E T2j, T7u, T2o, T7v, T2p, Tdd, T2u, T7e, T2z, T7f, T2A, Tde, T2M, Tdk,
            T7i;
      ...
      {
        E T4D, T9e, T4I, T9f, T4J, TdR, T4O, T8A, T4T, T8B, T4U, TdS, T56, Tea,
            T8E;
      ...
      {
        E T36, T7G, T3b, T7H, T3c, TdH, T3h, T8m, T3m, T8n, T3n, TdI, T3z, Tds,
            T7L;
      ...
      {
        E T3X, Tdw, T7Z, T82, T4v, TdB, T8b, T8g, T48, Tdx, T80, T85, T4k, TdA,
            T8a;
        E T8d;
        {
          E T3R, T7X, T3W, T7Y;
      ...
      {
        E T5u, Te2, T8Q, T8X, T62, TdY, T94, T99, T5F, Te3, T8T, T8Y, T5R, TdX,
            T93;
        E T96;
        {
          E T5o, T8V, T5t, T8W;
      ...
      {
        E T6L, T9x, ThV, Ti1, T7E, Ti0, T9A, ThO, T8y, T9K, T9u, T9E, T9r, T9L,
            T9v;
        E T9H;
        {
          E T6n, T6K, ThP, ThU;
      ...
      {
        E Tc3, Tcv, TiD, TiJ, Tca, TiI, Tcy, TiA, Tci, TcI, Tcs, TcC, Tcp, TcJ,
            Tct;
        E TcF;
        {
          E TbZ, Tc2, TiB, TiC;
      ...
      {
        E TaL, TbJ, Tip, Tiv, Tb0, Tiu, TbM, Tik, Tbk, TbW, TbG, TbQ, TbD, TbX,
            TbH;
        E TbT;
        {
          E TaD, TaK, Til, Tio;
      ...
      {
        E T9R, Taj, Ti9, Tif, T9Y, Tie, Tam, Ti6, Ta6, Taw, Tag, Taq, Tad, Tax,
            Tah;
        E Tat;
        {
          E T9N, T9Q, Ti7, Ti8;
...
static const hc2hc_desc desc = {
    64, "hf_64", twinstr, &GENUS, {808, 270, 230, 0}};
