 ...
 * -pipeline-latency 4 -n 20 -name r2cfII_20 -dft-II -include
...
static void r2cfII_20(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(80, rs),
        MAKE_VOLATILE_STRIDE(80, csr), MAKE_VOLATILE_STRIDE(80, csi)) {
