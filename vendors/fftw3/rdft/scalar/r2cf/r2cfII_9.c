 ...
 * -pipeline-latency 4 -n 9 -name r2cfII_9 -dft-II -include rdft/scalar/r2cfII.h
 */
...
static void r2cfII_9(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(36, rs),
        MAKE_VOLATILE_STRIDE(36, csr), MAKE_VOLATILE_STRIDE(36, csi)) {
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
      ...
      Cr[WS(csr, 4)] = T5 + Tg;
      {
        ...
        Ci[WS(csi, 2)] =
            FMA(KP866025403, To - (Tu + Tt), KP500000000 * (Tw - Tv));
        Cr[WS(csr, 2)] =
            FMA(KP500000000, Tt - Tu, Tr) + (KP866025403 * (Tv + Tw));
      }
    }
  }
}
