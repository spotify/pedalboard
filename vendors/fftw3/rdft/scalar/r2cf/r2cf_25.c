 ...
 * -pipeline-latency 4 -n 25 -name r2cf_25 -include rdft/scalar/r2cf.h */
...
static void r2cf_25(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP951056516, +0.951056516295153572116439333379382143405698634);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
      ...
      }
      {
        ...
        Ci[WS(csi, 9)] = FMA(KP309016994, T1D, T1l) +
                         FMA(KP587785252, T1a - TV, KP809016994 * T1G) -
                         (KP951056516 * (Tq + TF));
        Cr[WS(csr, 9)] =
            FMA(KP309016994, TG, Tb) +
            FMA(KP951056516, T1B - T1C, KP587785252 * (T1F - T1E)) -
            (KP809016994 * T1b);
        {
          E T1v, T1w, T1y, T1A;
          ...
          Ci[WS(csi, 11)] =
              FMA(KP587785252, T1t, KP951056516 * T1u) + T1v - T1w;
          Ci[WS(csi, 6)] =
              FMA(KP951056516, T1t, T1v) + FNMS(KP587785252, T1u, T1w);
          T1y = FNMS(KP250000000, T1i, Tb);
          T1A = KP559016994 * (T1e - T1h);
          Cr[WS(csr, 11)] =
              FMA(KP587785252, T1x, T1y) + FNMA(KP951056516, T1z, T1A);
          Cr[WS(csr, 6)] =
              FMA(KP951056516, T1x, T1A) + FMA(KP587785252, T1z, T1y);
        }
      }
      {
        E T1W, T1X, T1J, T1M, T1N, T21, T22, T23, T1Q, T1T, T1U, T1Y, T1Z, T20,
            T26;
        ...
        Cr[WS(csr, 8)] = FMA(KP309016994, T20, T1X) +
                         FNMA(KP809016994, T23, KP587785252 * (T1T + T1Q)) -
                         (KP951056516 * (T1M + T1J));
        Ci[WS(csi, 8)] = FNMS(KP587785252, T21 + T22, KP309016994 * T1N) +
                         FNMA(KP809016994, T1U, KP951056516 * (T1Y + T1Z)) -
                         T1W;
        {
          E T2e, T2f, T2n, T2p;
          ...
          Ci[WS(csi, 7)] =
              FMA(KP951056516, T2d, T2e) + FNMS(KP587785252, T2i, T2f);
          Ci[WS(csi, 12)] =
              FMA(KP587785252, T2d, T2f) + FMS(KP951056516, T2i, T2e);
          T2n = KP559016994 * (T2l - T2m);
          T2p = FNMS(KP250000000, T2o, T1X);
          Cr[WS(csr, 7)] = FMA(KP951056516, T2j, KP587785252 * T2k) + T2n + T2p;
          Cr[WS(csr, 12)] =
              FMA(KP587785252, T2j, T2p) + FNMA(KP951056516, T2k, T2n);
        }
      }
    }
  }
