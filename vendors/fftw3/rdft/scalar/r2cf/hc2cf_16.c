 ...
 * -pipeline-latency 4 -n 16 -dit -name hc2cf_16 -include rdft/scalar/hc2cf.h */
...
static void hc2cf_16(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                     INT me, INT ms) {
...
static const hc2c_desc desc = {
    16, "hc2cf_16", twinstr, &GENUS, {104, 30, 70, 0}};
...
static const hc2c_desc desc = {
    16, "hc2cf_16", twinstr, &GENUS, {136, 46, 38, 0}};
