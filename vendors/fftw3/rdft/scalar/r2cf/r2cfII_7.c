 ...
 * -pipeline-latency 4 -n 7 -name r2cfII_7 -dft-II -include rdft/scalar/r2cfII.h
 */
...
static void r2cfII_7(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
...
static void r2cfII_7(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP781831482, +0.781831482468029808708444526674057750232334519);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
      ...
      Ci[WS(csi, 1)] =
          FNMS(KP974927912, Td, KP781831482 * Tc) - (KP433883739 * Tb);
      Cr[0] = FMA(KP623489801, T4, T1) + FMA(KP222520933, T7, KP900968867 * Ta);
      Ci[WS(csi, 2)] =
          FNMS(KP781831482, Td, KP974927912 * Tb) - (KP433883739 * Tc);
      Cr[WS(csr, 2)] =
          FMA(KP900968867, T7, T1) + FNMA(KP623489801, Ta, KP222520933 * T4);
      Cr[WS(csr, 1)] =
          FMA(KP222520933, Ta, T1) + FNMA(KP623489801, T7, KP900968867 * T4);
