 ...
 * -pipeline-latency 4 -twiddle-log3 -precompute-twiddles -n 8 -dit -name
 * hc2cfdft2_8 -include rdft/scalar/hc2cf.h */
...
static void hc2cfdft2_8(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    8, "hc2cfdft2_8", twinstr, &GENUS, {60, 36, 30, 0}};
...
static const hc2c_desc desc = {
    8, "hc2cfdft2_8", twinstr, &GENUS, {72, 38, 18, 0}};
