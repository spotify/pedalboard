 ...
 * -pipeline-latency 4 -n 12 -name r2cfII_12 -dft-II -include
...
static void r2cfII_12(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ivs, R1 = R1 + ivs, Cr = Cr + ovs,
        Ci = Ci + ovs, MAKE_VOLATILE_STRIDE(48, rs),
