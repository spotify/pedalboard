 ...
 * -pipeline-latency 4 -twiddle-log3 -precompute-twiddles -n 16 -dit -name
 * hc2cfdft2_16 -include rdft/scalar/hc2cf.h */
...
static void hc2cfdft2_16(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, Rp = Rp + ms,
      ...
      {
        E T1v, T2q, T1s, T2s, T38, T3T, T1Y, T3P, T17, T1h, T2x, T2v, T33, T3Q,
            T1N;
        E T3S, Tg, Tu, T3A, T2B, T2D, T3B, T2c, T3L, T2S, T3I, TJ, TV, T3E, T2G;
        E T2I, T3D, T2n, T3J, T2X, T3M;
        {
          E T1t, T1u, T1W, T1m, T1Q, T1S, T1T, T1V, T36, T1r, T34, T1P, T1k,
              T1l, T1n;
          E T2r;
          T1t = Ip[0];
          T1u = Im[0];
        ...
        {
          E TX, T3o, T3i, T3s, T3l, T3t, T1x, T3e, T2p, T2M, T2K, T3d, T3a, T3c,
              T2z;
          E T3n;
          {
            E Tv, TW, T3g, T3h;
        ...
        {
          E T3z, T4b, T4g, T4q, T4j, T4r, T3G, T4m, T3O, T46, T3Z, T4l, T42,
              T4c, T3V;
          E T47;
          {
            E T3x, T3y, T4e, T4f;
...
static const hc2c_desc desc = {
    16, "hc2cfdft2_16", twinstr, &GENUS, {136, 74, 92, 0}};
...
static void hc2cfdft2_16(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, Rp = Rp + ms,
      ...
      {
        E T1t, T3i, T2l, T3B, T1E, T3t, T2M, T3x, T1g, T3C, T2J, T3u, T1T, T3w,
            T2o;
        E T3j, Tx, T3b, T2C, T3q, T27, T3m, T2s, T3c, TW, T3f, T2F, T3n, T2g,
            T3p;
        E T2v, T3e;
        {
        ...
        {
          E T3k, T3Q, T3Z, T3D, T3h, T40, T3X, T45, T3G, T3P, T3s, T3K, T3U,
              T44, T3z;
          E T3L;
          {
            E T3d, T3g, T3o, T3r;
...
static const hc2c_desc desc = {
    16, "hc2cfdft2_16", twinstr, &GENUS, {188, 84, 40, 0}};
