 ...
 * -name hc2cb2_32 -include rdft/scalar/hc2cb.h */
...
static void hc2cb2_32(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                      INT me, INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 8,
        MAKE_VOLATILE_STRIDE(128, rs)) {
      ...
      }
      {
        ...
        E T6q, T7u, T4C, T5K;
        {
          E T3, T1d, T2S, T6Q, T6, T2P, T1g, T6R, Td, T6U, T1r, T2V, Ta, T6T,
              T1m;
          E T2U;
          {
            E T1, T2, T1e, T1f;
        ...
        {
          E Ti, T6n, Tl, T6o, T1J, T1O, T80, T7Z, T4x, T4w, Tp, T6k, Ts, T6l,
              T1y;
...
static const hc2c_desc desc = {
    32, "hc2cb2_32", twinstr, &GENUS, {236, 98, 252, 0}};
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, Rp = Rp + ms,
      ...
      }
      {
        ...
        E T65, T6N, T3K, T4A;
        {
          E T3, T54, T2h, T6b, T6, T6a, T2k, T55, Ta, T57, T2o, T58, Td, T5a,
              T2r;
          E T5b;
          {
            E T1, T2, T2f, T2g;
        ...
        {
          E Ti, T5p, T1w, T5n, Tl, T5m, T1z, T5q, Tp, T5i, T1p, T5g, Ts, T5f,
              T1s;
          E T5j;
          {
            E Tg, Th, T1u, T1v;
        ...
        {
          E Ty, T5v, T1G, T5H, TB, T5G, T1J, T5w, TI, T5K, T1Q, T5D, TF, T5J,
              T1N;
          E T5A;
          {
            E Tw, Tx, T1H, T1I;
        ...
        {
          E TN, T5O, T1X, T60, TQ, T5Z, T20, T5P, TX, T63, T27, T5W, TU, T62,
              T24;
          E T5T;
          {
            E TL, TM, T1Y, T1Z;
...
static const hc2c_desc desc = {
    32, "hc2cb2_32", twinstr, &GENUS, {376, 168, 112, 0}};
