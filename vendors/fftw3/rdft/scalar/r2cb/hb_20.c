 ...
 * -pipeline-latency 4 -sign 1 -n 20 -dif -name hb_20 -include rdft/scalar/hb.h
 */
...
static void hb_20(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 38); m < me; m = m + 1, cr = cr + ms,
      ...
      E T2d, T1B, T4u, T4r, T1A, T2s, T3l, T2t, T3s, T2m, T2n, T2o, T1u, T1v,
          T1w;
...
static const hc2hc_desc desc = {
    20, "hb_20", twinstr, &GENUS, {136, 38, 110, 0}};

void X(codelet_hb_20)(planner *p) { X(khc2hc_register)(p, hb_20, &desc); }
#else
...
static void hb_20(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP951056516, +0.951056516295153572116439333379382143405698634);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 38); m < me; m = m + 1, cr = cr + ms,
      ...
      E T46, T47, T4a, T2a, T2b, T2e, T1w, T1x, T1y, T3O, T3R, T3U, T3h, T3i,
          T3j;
      E TH, TK, TL;
      {
