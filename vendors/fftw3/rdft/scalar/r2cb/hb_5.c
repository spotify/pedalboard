 ...
 * -pipeline-latency 4 -sign 1 -n 5 -dif -name hb_5 -include rdft/scalar/hb.h */
...
static void hb_5(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 8, MAKE_VOLATILE_STRIDE(10, rs)) {
...
void X(codelet_hb_5)(planner *p) { X(khc2hc_register)(p, hb_5, &desc); }
#else
