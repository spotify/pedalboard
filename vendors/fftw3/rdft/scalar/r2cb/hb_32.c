 ...
 * -pipeline-latency 4 -sign 1 -n 32 -dif -name hb_32 -include rdft/scalar/hb.h
 */
...
static const hc2hc_desc desc = {
    32, "hb_32", twinstr, &GENUS, {236, 62, 198, 0}};

void X(codelet_hb_32)(planner *p) { X(khc2hc_register)(p, hb_32, &desc); }
#else
...
static const hc2hc_desc desc = {
    32, "hb_32", twinstr, &GENUS, {340, 114, 94, 0}};
