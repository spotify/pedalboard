 ...
 * -pipeline-latency 4 -sign 1 -twiddle-log3 -precompute-twiddles -n 16 -dif
 * -name hb2_16 -include rdft/scalar/hb.h */
...
static void hb2_16(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  ...
  DK(KP414213562, +0.414213562373095048801688724209698078569671875);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 8, MAKE_VOLATILE_STRIDE(32, rs)) {
      ...
      {
        E TL, T1Z, T2d, T1t, T31, T34, T3n, T3D, T3E, T3R, T1w, T20, Tf, T3M,
            T2L;
        E T3h, TW, T2e, T3G, T3H, T3N, T2Q, T36, T2V, T37, Tu, T3S, T18, T1z,
            T24;
        ...
        {
          E Ti, T1e, T1c, T2N, T1h, T2O, Tl, T19, Tp, T13, T11, T2S, T16, T2T,
              Ts;
          E TY, T2M, T2P;
          {
            E Tg, Th, T1a, T1b;
...
static const hc2hc_desc desc = {
    16, "hb2_16", twinstr, &GENUS, {104, 42, 92, 0}};

void X(codelet_hb2_16)(planner *p) { X(khc2hc_register)(p, hb2_16, &desc); }
#else
...
static void hb2_16(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
      ...
      E T17, T1L, T1N, T1v, T1w, T1x, T1B, T2F, T2T, T2b, T2R, T3j, T3x, T35,
          T3t;
      {
      ...
      }
      {
        ...
        E T3l, Tm, T1T, TT, T1h, T2A, T2N, T3b, T3n, Tt, T1U, T12, T1i, T2t,
            T2O;
        E T3e, T3o;
        {
...
static const hc2hc_desc desc = {
    16, "hb2_16", twinstr, &GENUS, {156, 68, 40, 0}};
