 ...
 * -pipeline-latency 4 -sign 1 -n 25 -name r2cb_25 -include rdft/scalar/r2cb.h
 */
...
static void r2cb_25(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs,
        Ci = Ci + ivs, MAKE_VOLATILE_STRIDE(100, rs),
