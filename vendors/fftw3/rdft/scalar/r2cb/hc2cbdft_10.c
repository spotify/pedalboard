 ...
 * -pipeline-latency 4 -sign 1 -n 10 -dif -name hc2cbdft_10 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft_10(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 18); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 18,
      ...
      {
        E Tj, T2y, T2a, T1A, T2q, T10, T1Q, T24, T2k, T1q, T1K, T26, T28, T29,
            T2c;
        E Tk, TM, TN, T2w, T1M, T1O, T1P, T1S, T1s, T1w, T1x, T1C, T2m, T2o,
            T2p;
        E T2s, T12, T1e, T1f, T1E, T1G, T1I, T1J, T1U, T1W, T20, T21, T2e, T2g,
            T2i;
...
static const tw_instr twinstr[] = {{TW_FULL, 1, 10}, {TW_NEXT, 1, 0}};

static const hc2c_desc desc = {
    10, "hc2cbdft_10", twinstr, &GENUS, {68, 18, 54, 0}};
...
static void hc2cbdft_10(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 18); m < me; m = m + 1, Rp = Rp + ms,
      ...
      {
        E Tj, T2g, TN, T1H, T1U, T26, TZ, T1J, T1Q, T24, T1c, T1C, T1t, T29,
            T1o;
...
static const hc2c_desc desc = {
    10, "hc2cbdft_10", twinstr, &GENUS, {92, 30, 30, 0}};
