 ...
 * -pipeline-latency 4 -sign 1 -n 16 -dif -name hc2cbdft_16 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft_16(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    16, "hc2cbdft_16", twinstr, &GENUS, {136, 30, 70, 0}};
...
static const hc2c_desc desc = {
    16, "hc2cbdft_16", twinstr, &GENUS, {168, 46, 38, 0}};
