 ...
 * -pipeline-latency 4 -sign 1 -twiddle-log3 -precompute-twiddles -n 4 -dif
 * -name hc2cb2_4 -include rdft/scalar/hc2cb.h */
...
static void hc2cb2_4(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                     INT me, INT ms) {
  {
    INT m;
