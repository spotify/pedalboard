 ...
 * -pipeline-latency 4 -sign 1 -n 64 -name r2cbIII_64 -dft-III -include
...
static void r2cbIII_64(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP414213562, +0.414213562373095048801688724209698078569671875);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs,
        Ci = Ci + ivs, MAKE_VOLATILE_STRIDE(256, rs),
        MAKE_VOLATILE_STRIDE(256, csr), MAKE_VOLATILE_STRIDE(256, csi)) {
      E T15, T3t, T3U, T2E, Tf, T6b, T6u, T6Q, T4L, T5J, T1g, T3V, T5q, T5U,
          T2H;
      E T3u, Tu, T6v, T4V, T5r, T6e, T6R, T1s, T2K, T1D, T2J, T3B, T3X, T4Q,
          T5s;
      E T3y, T3Y, TK, T6g, T57, T5M, T6j, T6N, T1W, T35, T25, T34, T3J, T4i,
          T52;
      E T5N, T3G, T4j, TZ, T6l, T5i, T5P, T6o, T6M, T2n, T38, T2w, T37, T3Q,
          T4l;
      E T5d, T5Q, T3N, T4m;
      {
...
static void r2cbIII_64(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs,
        Ci = Ci + ivs, MAKE_VOLATILE_STRIDE(256, rs),
        MAKE_VOLATILE_STRIDE(256, csr), MAKE_VOLATILE_STRIDE(256, csi)) {
      E T15, T3t, T3U, T2N, Tf, T6b, T6u, T6R, T4L, T5J, T1g, T3V, T5q, T5U,
          T2I;
      E T3u, Tu, T6v, T4V, T5s, T6e, T6Q, T1s, T2D, T1D, T2E, T3B, T3Y, T4Q,
          T5r;
      E T3y, T3X, TK, T6g, T57, T5N, T6j, T6N, T1W, T34, T25, T35, T3J, T4j,
          T52;
      E T5M, T3G, T4i, TZ, T6l, T5i, T5Q, T6o, T6M, T2n, T37, T2w, T38, T3Q,
          T4m;
      E T5d, T5P, T3N, T4l;
      {
