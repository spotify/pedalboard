 ...
 * -pipeline-latency 4 -sign 1 -twiddle-log3 -precompute-twiddles -n 8 -dif
 * -name hb2_8 -include rdft/scalar/hb.h */
...
static void hb2_8(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 6); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 6, MAKE_VOLATILE_STRIDE(16, rs)) {
...
static const tw_instr twinstr[] = {
    {TW_CEXP, 1, 1}, {TW_CEXP, 1, 3}, {TW_CEXP, 1, 7}, {TW_NEXT, 1, 0}};

static const hc2hc_desc desc = {8, "hb2_8", twinstr, &GENUS, {44, 20, 30, 0}};

void X(codelet_hb2_8)(planner *p) { X(khc2hc_register)(p, hb2_8, &desc); }
#else
