 ...
 * -pipeline-latency 4 -sign 1 -n 7 -name r2cb_7 -include rdft/scalar/r2cb.h */
...
static void r2cb_7(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
...
static void r2cb_7(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP1_563662964, +1.563662964936059617416889053348115500464669037);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs,
      ...
      T2 = Cr[WS(csr, 1)];
      T3 = Cr[WS(csr, 2)];
      T5 = FMA(KP1_246979603, T3, T1) +
           FNMA(KP445041867, T4, KP1_801937735 * T2);
      Tc = FMA(KP1_246979603, T4, T1) +
           FNMA(KP1_801937735, T3, KP445041867 * T2);
      Ta = FMA(KP1_246979603, T2, T1) +
           FNMA(KP1_801937735, T4, KP445041867 * T3);
      R0[WS(rs, 2)] = T5 - T9;
      R1[WS(rs, 1)] = T5 + T9;
      R0[WS(rs, 1)] = Tc + Td;
      R1[WS(rs, 2)] = Tc - Td;
