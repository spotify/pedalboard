 ...
 * -pipeline-latency 4 -sign 1 -twiddle-log3 -precompute-twiddles -n 5 -dif
 * -name hb2_5 -include rdft/scalar/hb.h */
...
void X(codelet_hb2_5)(planner *p) { X(khc2hc_register)(p, hb2_5, &desc); }
#else
