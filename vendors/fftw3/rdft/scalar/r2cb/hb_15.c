 ...
 * -pipeline-latency 4 -sign 1 -n 15 -dif -name hb_15 -include rdft/scalar/hb.h
 */
...
void X(codelet_hb_15)(planner *p) { X(khc2hc_register)(p, hb_15, &desc); }
#else
...
static void hb_15(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP866025403, +0.866025403784438646763723170752936183471402627);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 28); m < me; m = m + 1, cr = cr + ms,
      ...
      E Ts, T11, T12, T13, T2N, T2O, T2P, T1u, T1x, T1y, T1W, T1Z, T28, T1P,
          T1S;
