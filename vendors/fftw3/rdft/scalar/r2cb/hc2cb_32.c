 ...
 * -pipeline-latency 4 -sign 1 -n 32 -dif -name hc2cb_32 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cb_32(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                     INT me, INT ms) {
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 62); m < me; m = m + 1, Rp = Rp + ms,
      ...
      E Tf, T5K, T7k, T8k, T7N, T8x, T1i, T3i, T2L, T3v, T4v, T5f, T6m, T6T,
          T42;
      E T52, TZ, T6X, T1X, T3p, T8p, T8B, T26, T3o, T4n, T58, T7z, T7T, T4k,
          T59;
      E T6a, T6p, TK, T6W, T2o, T3m, T8s, T8A, T2x, T3l, T4g, T55, T7G, T7S,
          T4d;
      E T56, T61, T6o, Tu, T6f, T7r, T8y, T7Q, T8l, T1F, T3w, T2O, T3j, T4y,
          T53;
      E T5R, T6U, T49, T5g;
      {
      ...
      {
        E TR, T7w, T1H, T1Y, T1K, T7t, T21, T65, TY, T7u, T7x, T1Q, T1V, T24,
            T68;
        E T23, T7v, T7y;
        {
          E TL, TM, TN, TO, TP, TQ;
      ...
      {
        E TC, T7D, T28, T2p, T2b, T7A, T2s, T5W, TJ, T7B, T7E, T2h, T2m, T2v,
            T5Z;
        E T2u, T7C, T7F;
        {
          E Tw, Tx, Ty, Tz, TA, TB;
...
static const hc2c_desc desc = {
    32, "hc2cb_32", twinstr, &GENUS, {236, 62, 198, 0}};
...
static void hc2cb_32(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 62); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 62,
        MAKE_VOLATILE_STRIDE(128, rs)) {
      E T4o, T6y, T70, T5u, Tf, T12, T5x, T6z, T3m, T3Y, T29, T2y, T4v, T71,
          T2U;
      E T3M, Tu, T1U, T6D, T73, T6G, T74, T1h, T2z, T2X, T3o, T4D, T5A, T4K,
          T5z;
      E T30, T3n, TK, T1j, T6S, T7w, T6V, T7v, T1y, T2B, T3c, T3S, T4X, T61,
          T54;
      E T62, T3f, T3T, TZ, T1A, T6L, T7z, T6O, T7y, T1P, T2C, T35, T3P, T5g,
          T64;
      E T5n, T65, T38, T3Q;
      {
...
static const hc2c_desc desc = {
    32, "hc2cb_32", twinstr, &GENUS, {340, 114, 94, 0}};
