 ...
 * -pipeline-latency 4 -sign 1 -n 16 -dif -name hc2cb_16 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cb_16(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                     INT me, INT ms) {
...
static const hc2c_desc desc = {
    16, "hc2cb_16", twinstr, &GENUS, {104, 30, 70, 0}};
...
static const hc2c_desc desc = {
    16, "hc2cb_16", twinstr, &GENUS, {136, 46, 38, 0}};
