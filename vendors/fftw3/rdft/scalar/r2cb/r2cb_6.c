 ...
 * -pipeline-latency 4 -sign 1 -n 6 -name r2cb_6 -include rdft/scalar/r2cb.h */
...
static void r2cb_6(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP2_000000000, +2.000000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs,
        Ci = Ci + ivs, MAKE_VOLATILE_STRIDE(24, rs),
