 ...
 * -pipeline-latency 4 -sign 1 -n 20 -dif -name hc2cbdft_20 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft_20(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    20, "hc2cbdft_20", twinstr, &GENUS, {176, 38, 110, 0}};
...
static const hc2c_desc desc = {
    20, "hc2cbdft_20", twinstr, &GENUS, {224, 62, 62, 0}};
