 ...
 * -pipeline-latency 4 -sign 1 -twiddle-log3 -precompute-twiddles -n 32 -dif
 * -name hb2_32 -include rdft/scalar/hb.h */
...
static void hb2_32(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 8, MAKE_VOLATILE_STRIDE(64, rs)) {
      E T11, T14, T12, T37, T17, T1b, T39, T3a, T3v, T3d, T3x, T15, T16, T5X,
          T4p;
      E T3G, T78, T7e, T8S, T9s, T8P, T8V, T98, T9m, T7I, T7C, T3y, T4b, T3C,
          T4g;
      E T5u, T6b, T5I, T6e, T1a, T1c, T2O, T4r, T4s, T4W, T3J, T3K, T3Y, T5Z,
          T60;
      E T66, T3i, T3q, T3l, T3e, T7S, T8K, T8m, T8E, T5k, T5U, T5R, T5e, T6i,
          T7s;
      E T6O, T7o;
      {
      ...
      {
        E Tf, T6j, T7V, T8W, T8p, T99, T1t, T3L, T2X, T3Z, T4Z, T5J, T6W, T7t,
            T4v;
        E T5v, TZ, T7x, T28, T3S, T91, T9d, T2h, T3R, T4Q, T5B, T8a, T8v, T4N,
            T5C;
        E T6J, T6Z, TK, T7w, T2z, T3P, T94, T9c, T2I, T3O, T4J, T5y, T8h, T8u,
            T4G;
        E T5z, T6A, T6Y, Tu, T6P, T82, T9a, T8s, T8X, T1Q, T40, T30, T3M, T52,
            T5w;
        E T6q, T7u, T4C, T5K;
        {
          E T3, T1d, T6, T2P, T2S, T6Q, T1g, T6R, Td, T6U, T1r, T2V, Ta, T6T,
              T1m;
          E T2U;
          {
            E T1, T2, T1e, T1f;
        ...
        {
          E TR, T87, T1S, T29, T1V, T84, T2c, T6E, TY, T85, T88, T21, T26, T2f,
              T6H;
          E T2e, T86, T89;
          {
            E TL, TM, TN, TO, TP, TQ;
        ...
        {
          E TC, T8e, T2j, T2A, T2m, T8b, T2D, T6v, TJ, T8c, T8f, T2s, T2x, T2G,
              T6y;
          E T2F, T8d, T8g;
          {
            E Tw, Tx, Ty, Tz, TA, TB;
        ...
        {
          E Ti, T6o, Tl, T6n, T1J, T1O, T80, T7Z, T4x, T4w, Tp, T6l, Ts, T6k,
              T1y;
...
static const hc2hc_desc desc = {
    32, "hb2_32", twinstr, &GENUS, {236, 98, 252, 0}};

void X(codelet_hb2_32)(planner *p) { X(khc2hc_register)(p, hb2_32, &desc); }
#else
...
static void hb2_32(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
        ci = ci - ms, W = W + 8, MAKE_VOLATILE_STRIDE(64, rs)) {
      E T11, T14, T12, T15, T17, T2z, T2B, T1c, T18, T1d, T1g, T1k, T2F, T2L,
          T3t;
      E T4H, T3h, T3V, T3b, T4v, T4T, T4X, T6t, T71, T6z, T75, T81, T8x, T8f,
          T8z;
      E T2R, T2V, T8p, T8t, T4r, T4t, T53, T69, T3n, T3r, T7P, T7T, T4P, T4R,
          T6F;
      E T6R, T1f, T2X, T1j, T2Y, T1l, T31, T2d, T2Z, T49, T4h, T4c, T4i, T4d,
          T4n;
      E T4f, T4j;
      {
        E T2P, T3q, T2U, T3l, T2Q, T3p, T2T, T3m, T2D, T3g, T2K, T39, T2E, T3f,
            T2J;
        E T3a;
        {
          E T13, T1b, T16, T1a;
      ...
      {
        E T56, T7b, T7C, T6c, Tf, T1m, T6f, T7c, T3Y, T4I, T2t, T32, T5d, T7D,
            T3w;
        E T4w, Tu, T2e, T7g, T7F, T7j, T7G, T1B, T33, T3z, T40, T5l, T6i, T5s,
            T6h;
        E T3C, T3Z, TK, T1D, T7v, T86, T7y, T85, T1S, T35, T3O, T4C, T5F, T6J,
            T5M;
        E T6K, T3R, T4D, TZ, T1U, T7o, T89, T7r, T88, T29, T36, T3H, T4z, T5Y,
            T6M;
        E T65, T6N, T3K, T4A;
        {
          E T3, T54, T2o, T58, T2r, T5b, T6, T6a, Ta, T57, T2h, T6b, T2k, T55,
              Td;
          E T5a;
          {
            E T1, T2, T2m, T2n;
        ...
        {
          E Ti, T5p, T1w, T5n, T1z, T5q, Tl, T5m, Tp, T5i, T1p, T5g, T1s, T5j,
              Ts;
          E T5f;
          {
            E Tg, Th, T1u, T1v;
        ...
        {
          E Ty, T5v, TB, T5G, T1J, T5w, T1G, T5H, TI, T5K, T1Q, T5D, TF, T5J,
              T1N;
          E T5A;
          {
            E Tw, Tx, T1E, T1F;
        ...
        {
          E TN, T5O, TQ, T5Z, T20, T5P, T1X, T60, TX, T63, T27, T5W, TU, T62,
              T24;
          E T5T;
          {
            E TL, TM, T1V, T1W;
...
static const hc2hc_desc desc = {
    32, "hb2_32", twinstr, &GENUS, {376, 168, 112, 0}};
