 ...
 * -pipeline-latency 4 -sign 1 -n 32 -dif -name hc2cbdft_32 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft_32(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    32, "hc2cbdft_32", twinstr, &GENUS, {300, 62, 198, 0}};
...
static const hc2c_desc desc = {
    32, "hc2cbdft_32", twinstr, &GENUS, {404, 114, 94, 0}};
