 ...
 * -pipeline-latency 4 -sign 1 -n 16 -dif -name hc2cbdft2_16 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft2_16(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 30); m < me; m = m + 1, Rp = Rp + ms,
      ...
      E T26, T2J, T2M, T2N, T2U, T2V, T3H, Tu, T25, T3i, T3R, T1a, T2g, T1y,
          T21;
      E T39, T3W, T1p, T2b;
      {
      ...
      {
        E T3N, T47, T43, T45, T46, T4f, T3F, T3J, T3K, T3Z, T3S, T3X, T3T, T41,
            T4a;
        E T4d, T4b, T4h;
        {
      ...
      {
        E T2X, T3t, T3p, T3r, T3s, T3B, T2D, T2P, T2Q, T3l, T3a, T3j, T3b, T3n,
            T3w;
        E T3z, T3x, T3D;
        {
...
static const hc2c_desc desc = {
    16, "hc2cbdft2_16", twinstr, &GENUS, {136, 30, 70, 0}};
...
static const hc2c_desc desc = {
    16, "hc2cbdft2_16", twinstr, &GENUS, {168, 46, 38, 0}};
