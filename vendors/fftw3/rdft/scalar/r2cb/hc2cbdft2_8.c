 ...
 * -pipeline-latency 4 -sign 1 -n 8 -dif -name hc2cbdft2_8 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft2_8(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    8, "hc2cbdft2_8", twinstr, &GENUS, {60, 14, 22, 0}};
...
static const hc2c_desc desc = {
    8, "hc2cbdft2_8", twinstr, &GENUS, {68, 18, 14, 0}};
