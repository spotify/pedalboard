 ...
 * -pipeline-latency 4 -sign 1 -n 12 -dif -name hc2cbdft_12 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft_12(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 22); m < me; m = m + 1, Rp = Rp + ms,
      ...
      {
        E T1R, T2b, T27, T29, T2a, T2l, T1B, T1J, T1K, T25, T1W, T21, T1X, T23,
            T2e;
        E T2h, T2f, T2j;
        {
      ...
      {
        E T2v, T2P, T2L, T2N, T2O, T2X, T2n, T2r, T2s, T2H, T2A, T2F, T2B, T2J,
            T2S;
        E T2V, T2T, T2Z;
        {
...
static const hc2c_desc desc = {
    12, "hc2cbdft_12", twinstr, &GENUS, {96, 22, 46, 0}};
...
static const hc2c_desc desc = {
    12, "hc2cbdft_12", twinstr, &GENUS, {112, 30, 30, 0}};
