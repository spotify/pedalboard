 ...
 * -pipeline-latency 4 -sign 1 -n 4 -dif -name hc2cbdft2_4 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft2_4(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    4, "hc2cbdft2_4", twinstr, &GENUS, {24, 6, 6, 0}};
