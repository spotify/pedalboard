 ...
 * -pipeline-latency 4 -sign 1 -n 12 -dif -name hc2cb_12 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cb_12(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                     INT me, INT ms) {
...
static const hc2c_desc desc = {
    12, "hc2cb_12", twinstr, &GENUS, {72, 22, 46, 0}};
...
static const hc2c_desc desc = {
    12, "hc2cb_12", twinstr, &GENUS, {88, 30, 30, 0}};
