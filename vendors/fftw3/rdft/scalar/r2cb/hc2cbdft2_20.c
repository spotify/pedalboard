 ...
 * -pipeline-latency 4 -sign 1 -n 20 -dif -name hc2cbdft2_20 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft2_20(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 38); m < me; m = m + 1, Rp = Rp + ms,
      ...
      E T27, T2o, T3T, T41, T2p, T40, T1N, T2Q, T1w, T2L, T4n, T59, T4A, T5e,
          T24;
      E T2m, T2h, T2Z, T3P, T4J, T3W, T3Y, T7, TC, T2c, T2d, T3y, T3F, T3G, T3H;
      E T46, T4d, T4e, T4f, T4r, T4u, T4v, T4w, T1E, T1H, T1I, T1J, TJ, T16,
          T17;
      E T18;
      {
        E T3, T1A, TI, T25, T6, TF, T1D, T26, Te, T47, T4k, TO, T1e, T3z, T3M;
        E T1S, Tt, T4a, T4h, TZ, T1p, T3C, T3J, T1Z, TA, T4b, T4i, T14, T1u,
            T3D;
      ...
      {
        E TD, T28, T3o, T3r, T3p, T3v, T2r, T3l, T2H, T35, T2b, T2j, T2k, T2z,
            T2D;
        E T2F, T2G, T2T, T2X, T31, T32, T3d, T3h, T3j, T3k, T3t, T1x, T2u, T1O,
            T2x;
        E T1y, T29, T2v, T2B, T2M, T38, T2R, T3b, T2N, T2V, T39, T3f, T3n, T1P,
            T2a;
        E T1z;
        TD = T7 + TC;
        T28 = T24 + T27;
      ...
      {
        E T55, T51, T53, T54, T5h, T5I, T5L, T5J, T5P, T43, T5F, T4P, T5p, T3x,
            T3R;
        E T3S, T4D, T5l, T5n, T5o, T5x, T4H, T4L, T4M, T4X, T5B, T5D, T5E, T5N,
            T4o;
        E T4S, T4B, T4V, T4p, T4F, T4T, T4Z, T5a, T5s, T5f, T5v, T5b, T5j, T5t,
            T5z;
        E T52, T5H;
        T55 = T3W + T3T;
        T52 = T3y + T3F;
...
static const hc2c_desc desc = {
    20, "hc2cbdft2_20", twinstr, &GENUS, {176, 38, 110, 0}};
...
static void hc2cbdft2_20(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DK(KP559016994, +0.559016994374947424102293417182819058860154590);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 38); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 38,
        MAKE_VOLATILE_STRIDE(80, rs)) {
      E T7, T3N, T4a, T16, T1G, T3g, T3D, T26, T1k, T3A, T3B, T1v, T2e, T48,
          T47;
      E T2d, T1L, T43, T40, T1K, T2l, T3t, T2m, T3w, T3n, T3p, TC, T2b, T4d,
          T4f;
      ...
      {
        E TD, T27, T3c, T3e, T2o, T36, T2A, T2U, T1N, T2Z, T2t, T2J, T1x, T2X,
            T2r;
      ...
      {
        E T4F, T4P, T5c, T5e, T3y, T54, T4o, T4S, T4h, T4Z, T4x, T4N, T45, T4X,
            T4v;
...
static const hc2c_desc desc = {
    20, "hc2cbdft2_20", twinstr, &GENUS, {224, 62, 62, 0}};
