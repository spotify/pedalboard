 ...
 * -pipeline-latency 4 -sign 1 -n 20 -dif -name hc2cb_20 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cb_20(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs, INT mb,
                     INT me, INT ms) {
...
static const hc2c_desc desc = {
    20, "hc2cb_20", twinstr, &GENUS, {136, 38, 110, 0}};
...
static const hc2c_desc desc = {
    20, "hc2cb_20", twinstr, &GENUS, {184, 62, 62, 0}};
