 ...
 * -pipeline-latency 4 -sign 1 -n 64 -name r2cb_64 -include rdft/scalar/r2cb.h
 */
...
static void r2cb_64(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP2_000000000, +2.000000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs,
      ...
      E T4F, T5m, T1M, T3p, T1U, T3w, T3H, T2z, TM, T5Q, T5Y, T6f, T4M, T5q,
          T25;
      E T3I, T53, T5t, T2C, T3x, T11, T5V, T4W, T55, T5T, T6g, T2h, T2E, T2s,
          T2F;
...
static void r2cb_64(R *R0, R *R1, R *Cr, R *Ci, stride rs, stride csr,
  ...
  DK(KP2_000000000, +2.000000000000000000000000000000000000000000000);
  {
    ...
    for (i = v; i > 0; i = i - 1, R0 = R0 + ovs, R1 = R1 + ovs, Cr = Cr + ivs,
      ...
      E T41, T5r, T1A, T2y, T4a, T5y, T5N, T4H, TN, T31, T4E, T5z, T39, T3q,
          T1L;
      E T2B, T4h, T5M, T2h, T2F, T12, T36, T5D, T5J, T5G, T5K, T1U, T26, T23,
          T27;
      ...
      {
        E TQ, T4j, T1P, T4n, TT, T4m, T1S, T4k, TX, T4q, T1Y, T4u, T10, T4t,
            T21;
        E T4r;
        {
          E TO, TP, T1N, T1O;
