 ...
 * -pipeline-latency 4 -sign 1 -n 32 -dif -name hc2cbdft2_32 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft2_32(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * 62); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 62,
        MAKE_VOLATILE_STRIDE(128, rs)) {
      E T3h, T4B, Tv, T3K, T6T, T8Y, T7i, T8L, T7f, T8X, T1G, T4Y, T1j, T4K,
          T2M;
      E T4X, T6d, T8C, T66, T8o, T6M, T8K, T2P, T4L, T3o, T4C, T4q, T5q, T6C,
          T8p;
      E T6z, T8B, TK, TZ, T10, T32, T39, T3L, T4t, T4E, T8t, T8F, T4w, T4F, T8w;
      E T8E, T6l, T6E, T6s, T6F, T28, T51, T2R, T4P, T71, T90, T7k, T8P, T2z,
          T50;
      E T2S, T4S, T78, T91, T7l, T8S;
      {
        E T16, T3l, T2H, T3m, T3, T6, T7, T2E, T13, Ta, Td, Te, T1c, T3j, T3i;
        E T2J, T1h, T2K, Tt, T6Q, T6R, T1z, T1E, T6a, T6b, T3g, Tm, T6N, T6O,
            T1o;
      ...
      {
        E TC, T6V, T6Y, T1M, T23, T6f, T6j, T31, TY, T6n, T6p, T2i, T2n, T2w,
            T35;
        E T2v, TJ, T6g, T6i, T1R, T1W, T25, T2Y, T24, TR, T72, T75, T2d, T2u,
            T6m;
        E T6q, T38;
        {
      ...
      {
        E T11, T3q, T3x, T3t, T3v, T3w, T3F, T2B, T3A, T2U, T3D, T2C, T3r, T3B,
            T3H;
        E T2V, T3s, T2D;
        {
      ...
      {
        E T3R, T4b, T47, T49, T4a, T4j, T3J, T3N, T3O, T43, T3W, T4e, T41, T4h,
            T3X;
        E T45, T4f, T4l;
        {
      ...
      {
        E T4H, T5d, T4n, T4z, T4A, T55, T59, T5b, T5c, T5l, T4U, T5g, T53, T5j,
            T4V;
      ...
      {
        E T5x, T5R, T5p, T5t, T5u, T5J, T5N, T5P, T5Q, T5Z, T5C, T5U, T5H, T5X,
            T5D;
      ...
      {
        E T6H, T7x, T63, T6v, T6w, T7p, T7t, T7v, T7w, T7F, T7a, T7A, T7n, T7D,
            T7b;
        E T7r, T7B, T7H;
        {
          E T6D, T6G, T6J, T7z;
      ...
      {
        E T8H, T9d, T8n, T8z, T8A, T95, T99, T9b, T9c, T9l, T8U, T9g, T93, T9j,
            T8V;
        E T97, T9h, T9n;
        {
          E T8D, T8G, T8J, T9f;
      ...
      {
        E T9x, T9R, T9p, T9t, T9u, T9J, T9N, T9P, T9Q, T9Z, T9C, T9U, T9H, T9X,
            T9D;
        E T9L, T9V, Ta1;
        {
          E T9v, T9w, T9z, T9T;
      ...
      {
        E T7R, T8b, T7J, T7N, T7O, T83, T87, T89, T8a, T8j, T7W, T8e, T81, T8h,
            T7X;
        E T85, T8f, T8l;
        {
          E T7P, T7Q, T7T, T8d;
...
static const tw_instr twinstr[] = {{TW_FULL, 1, 32}, {TW_NEXT, 1, 0}};

static const hc2c_desc desc = {
    32, "hc2cbdft2_32", twinstr, &GENUS, {300, 62, 198, 0}};
...
static void hc2cbdft2_32(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 62); m < me; m = m + 1, Rp = Rp + ms,
        Ip = Ip + ms, Rm = Rm - ms, Im = Im - ms, W = W + 62,
        MAKE_VOLATILE_STRIDE(128, rs)) {
      E Tf, T4a, T6h, T7Z, T6P, T8e, T1j, T4v, T2R, T4L, T5C, T7E, T6a, T7U,
          T3n;
      E T4q, TZ, T38, T2p, T4B, T7M, T7R, T2y, T4C, T5Y, T63, T6C, T86, T4i,
          T4n;
      E T6z, T85, TK, T31, T1Y, T4y, T7J, T7Q, T27, T4z, T5R, T62, T6v, T83,
          T4f;
      E T4m, T6s, T82, Tu, T4p, T6o, T8f, T6M, T80, T1G, T4K, T2I, T4w, T5J,
          T7T;
      E T67, T7F, T3g, T4b;
      {
      ...
      {
        E TR, T5S, T29, T2t, T2c, T5W, T2w, T37, TY, T5T, T5V, T2i, T2n, T2r,
            T34;
        E T2q, T6A, T6B;
        {
          E TL, TM, TN, TO, TP, TQ;
      ...
      {
        E TC, T5L, T1I, T22, T1L, T5P, T25, T30, TJ, T5M, T5O, T1R, T1W, T20,
            T2X;
        E T1Z, T6t, T6u;
        {
          E Tw, Tx, Ty, Tz, TA, TB;
      ...
      {
        E T11, T3s, T3p, T3u, T3K, T40, T3G, T3Y, T2T, T43, T3z, T3P, T2B, T45,
            T3x;
        E T3T;
        {
          E Tv, T10, T3E, T3F;
      ...
      {
        E T7O, T8m, T7W, T8o, T8E, T8U, T8A, T8S, T8h, T8X, T8t, T8J, T89, T8Z,
            T8r;
        E T8N;
        {
          E T7G, T7N, T8y, T8z;
      ...
      {
        E T4k, T4S, T4s, T4U, T5a, T5q, T56, T5o, T4N, T5t, T4Z, T5f, T4F, T5v,
            T4X;
        E T5j;
        {
          E T4c, T4j, T54, T55;
      ...
      {
        E T60, T6W, T6c, T6Y, T7e, T7u, T7a, T7s, T6R, T7x, T73, T7j, T6F, T7z,
            T71;
        E T7n;
        {
          E T5K, T5Z, T78, T79;
...
static const hc2c_desc desc = {
    32, "hc2cbdft2_32", twinstr, &GENUS, {404, 114, 94, 0}};
