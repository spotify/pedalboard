 ...
 * -pipeline-latency 4 -sign 1 -n 6 -dif -name hc2cbdft_6 -include
 * rdft/scalar/hc2cb.h */
...
static void hc2cbdft_6(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    6, "hc2cbdft_6", twinstr, &GENUS, {36, 10, 22, 0}};
...
static const hc2c_desc desc = {
    6, "hc2cbdft_6", twinstr, &GENUS, {44, 14, 14, 0}};
