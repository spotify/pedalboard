 ...
 * -pipeline-latency 4 -sign 1 -twiddle-log3 -precompute-twiddles -n 25 -dif
 * -name hb2_25 -include rdft/scalar/hb.h */
...
static void hb2_25(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
                   INT ms) {
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
      ...
      E T2q, T76, T4o, T8d, T2u, T4e, T4i, T8a, T86, T71, T6Y, T6U, T26, T2a,
          T3U;
      E T8o, T8s, T4B, T4C, T4G, T2k, T5w, T5C, T6E, T5T, T4u, T7g, T7c, T1I,
          TY;
      E T5I, T8i, T5M;
      {
        E T2x, T2p, T85, T4d, T2t, T89, T4h, TU, T4m, T2j, T3T, TP, TV, T2d,
            T5v;
        E T5B;
        TN = W[0];
        TT = W[4];
      ...
      {
        E T9, T40, T1R, T6G, T6F, T3X, T6H, T2F, T7n, T4N, T5W, T1k, T1S, T1D,
            T1T;
        E Ti, Tr, Ts, TB, TK, TL, TM, T6p, T7K, T6w, T7A, T2U, T56, T3K, T4X;
        E T6i, T7J, T6v, T7x, T39, T57, T3L, T50, T3E, T59, T3O, T4Q, T63, T7H,
            T6y;
        ...
        {
          E Ta, T2H, T6n, T2S, Th, T2G, TC, T3r, T5Y, T3C, TJ, T3q, Tj, T30,
              T6d;
          E T33, Tq, T32, T1u, T3v, T61, T3y, T1B, T3x, T12, T2L, T6k, T2O, T19,
              T2N;
          E T1b, T2W, T6g, T37, T1i, T2V, T1l, T3g, T68, T3j, T1s, T3i, Tt, T3c,
              T65;
          E T3n, TA, T3b;
          {
            E Tg, T2R, Td, T2Q;
        ...
        {
          E T7U, T8f, T82, T8k, T7F, T7M, T7X, T7Y, T7D, T7R, T8e, T7I, T7L,
              T7E, T7O;
          E T7N;
          {
            E T7S, T7T, T80, T81;
        ...
        {
          E T5c, T5y, T5o, T5E, T5f, T5i, T5j, T5k, T5P, T55, T5x, T5g, T5h,
              T5Q, T5S;
          E T5R;
          {
            E T58, T5b, T5m, T5n;
        ...
        {
          E T3Q, T4q, T4a, T4w, T41, T44, T45, T46, T4J, T3J, T4p, T42, T43,
              T4K, T4M;
          E T4L;
          {
            E T3M, T3P, T48, T49;
...
static const hc2hc_desc desc = {
    25, "hb2_25", twinstr, &GENUS, {84, 78, 356, 0}};

void X(codelet_hb2_25)(planner *p) { X(khc2hc_register)(p, hb2_25, &desc); }
#else
...
static void hb2_25(R *cr, R *ci, const R *W, stride rs, INT mb, INT me,
  ...
  DK(KP951056516, +0.951056516295153572116439333379382143405698634);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 8); m < me; m = m + 1, cr = cr + ms,
      ...
      E T2j, T5l, T4X, T2v, T11, T3R, T1L, T5d, T6x, T5h, T6t, T25, T26, T27,
          T29;
      E T6D, T7v, T49, T7l, T7p, T7t, T2p, T2n, T4b, T4p, T5n, T6B, T5b, T5p,
          T6p;
      E T6r, T59, T4r;
      {
      ...
      }
      {
        ...
        E T5G, T71, T65, T6N, T5z, T70, T64, T6K, T2Z, T4Q, T3I, T4B, T20, T5Z,
            T3C;
        E T43, T6j, TB, TK, TL, T1w, T1F, T1Q, T3f, T4S, T3K, T4F, T5V, T74,
            T68;
        ...
        {
          E Ta, T2x, T5w, T2F, Th, T2w, T1e, T2P, T5B, T2X, T1l, T2O, Tj, T2N,
              T5D;
        ...
        {
          E Tt, T32, T5L, T3a, TA, T31, T1o, T36, T5J, T3c, T1v, T3b, TC, T3h,
              T5S;
        ...
        {
          E T76, T7n, T7a, T7q, T6H, T6W, T6X, T6Y, T7e, T7f, T7d, T7g, T7x,
              T7y;
          {
            E T72, T75, T78, T79;
            T72 = T70 + T71;
        ...
        {
          E T3N, T4h, T3U, T4m, T3D, T3E, T3w, T3F, T44, T45, T3X, T46, T4t,
              T4u;
          {
            E T3J, T3M, T3S, T3T;
            T3J = T3H - T3I;
        ...
        {
          E T4V, T5f, T50, T5i, T4L, T4M, T4K, T4N, T54, T55, T53, T56, T5r,
              T5s;
          {
            E T4R, T4U, T4Y, T4Z;
            T4R = T4P - T4Q;
        ...
        {
          E T6a, T6v, T6e, T6y, T60, T61, T5X, T62, T6k, T6l, T6h, T6m, T6F,
              T6G;
          {
            E T66, T69, T6c, T6d;
            T66 = T64 - T65;
...
static const hc2hc_desc desc = {
    25, "hb2_25", twinstr, &GENUS, {280, 180, 160, 0}};
