 ...
 * -pipeline-latency 4 -sign 1 -n 25 -dif -name hb_25 -include rdft/scalar/hb.h
 */
...
static void hb_25(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP618033988, +0.618033988749894848204586834365638117720309180);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 48); m < me; m = m + 1, cr = cr + ms,
      ...
      E T9, T3E, T1F, T6e, T6d, T3B, T6f, T2k, T6U, T4k, T5u, T19, T1G, T1s,
          T1H;
      E Ti, Tr, Ts, TB, TK, TL, TM, T5X, T7i, T64, T77, T2z, T4D, T3p, T4u;
      E T5Q, T7h, T63, T74, T2O, T4E, T3q, T4x, T3j, T4G, T3t, T4n, T5B, T7f,
          T66;
      ...
      }
      {
        ...
        E T2I, Tq, T2H, T1j, T3a, T5z, T3d, T1q, T3c, TR, T2q, T5S, T2t, TY,
            T2s;
        E T10, T2B, T5O, T2M, T17, T2A, T1a, T2V, T5G, T2Y, T1h, T2X, Tt, T2R,
            T5D;
        E T32, TA, T2Q;
        {
          E Tg, T2w, Td, T2v;
...
void X(codelet_hb_25)(planner *p) { X(khc2hc_register)(p, hb_25, &desc); }
#else
...
static void hb_25(R *cr, R *ci, const R *W, stride rs, INT mb, INT me, INT ms) {
  ...
  DK(KP951056516, +0.951056516295153572116439333379382143405698634);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * 48); m < me; m = m + 1, cr = cr + ms,
      ...
      E T5d, T6C, T5C, T6o, T56, T6B, T5B, T6l, T2z, T4m, T3i, T47, T1K, T5w,
          T3c;
      ...
      {
        E Ta, T27, T53, T2f, Th, T26, T10, T2p, T58, T2x, T17, T2o, Tj, T2n,
            T5a;
      ...
      {
        E Tt, T2C, T5i, T2K, TA, T2B, T1a, T2G, T5g, T2M, T1h, T2L, TC, T2R,
            T5p;
...
static const hc2hc_desc desc = {
    25, "hb_25", twinstr, &GENUS, {260, 140, 140, 0}};
