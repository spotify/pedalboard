...
static problem *mkcld_before(const problem_rdft *p) {
  return X(mkproblem_rdft_d)(X(tensor_copy_inplace)(p->sz, INPLACE_OS),
                             X(tensor_copy_inplace)(p->vecsz, INPLACE_OS), p->O,
                             p->O, p->kind);
}
...
static problem *mkcld_after(const problem_rdft *p) {
  return X(mkproblem_rdft_d)(X(tensor_copy_inplace)(p->sz, INPLACE_IS),
                             X(tensor_copy_inplace)(p->vecsz, INPLACE_IS), p->I,
                             p->I, p->kind);
}
...
static int applicable0(const solver *ego_, const problem *p_,
  ...
  return (1 &&
          ...
          (0
           ...
           || (p->I == p->O && !(X(tensor_inplace_strides2)(p->sz, p->vecsz)))
...
static plan *mkplan(const solver *ego_, const problem *p_, planner *plnr) {
  ...
  cldcpy =
      X(mkplan_d)(plnr, X(mkproblem_rdft_0_d)(X(tensor_append)(p->vecsz, p->sz),
                                              p->I, p->O));
  if (!cldcpy)
    goto nada;
