 ...
 * -no-generate-bytw -n 12 -dif -sign 1 -name hc2cbdftv_12 -include
 * rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_12(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    12, XSIMD_STRING("hc2cbdftv_12"), twinstr, &GENUS, {45, 25, 26, 0}};
 ...
 * -dif -sign 1 -name hc2cbdftv_12 -include rdft/simd/hc2cbv.h */
...
static const hc2c_desc desc = {
    12, XSIMD_STRING("hc2cbdftv_12"), twinstr, &GENUS, {67, 26, 4, 0}};
