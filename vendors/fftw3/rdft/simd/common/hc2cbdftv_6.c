 ...
 * -no-generate-bytw -n 6 -dif -sign 1 -name hc2cbdftv_6 -include
 * rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_6(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    6, XSIMD_STRING("hc2cbdftv_6"), twinstr, &GENUS, {17, 12, 12, 0}};
 ...
 * -dif -sign 1 -name hc2cbdftv_6 -include rdft/simd/hc2cbv.h */
...
static const hc2c_desc desc = {
    6, XSIMD_STRING("hc2cbdftv_6"), twinstr, &GENUS, {27, 12, 2, 0}};
