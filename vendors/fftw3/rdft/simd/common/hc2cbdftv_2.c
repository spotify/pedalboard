 ...
 * -no-generate-bytw -n 2 -dif -sign 1 -name hc2cbdftv_2 -include
 * rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_2(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    2, XSIMD_STRING("hc2cbdftv_2"), twinstr, &GENUS, {3, 2, 2, 0}};
 ...
 * -dif -sign 1 -name hc2cbdftv_2 -include rdft/simd/hc2cbv.h */
...
static const hc2c_desc desc = {
    2, XSIMD_STRING("hc2cbdftv_2"), twinstr, &GENUS, {5, 2, 0, 0}};
