 ...
 * -no-generate-bytw -n 32 -dif -sign 1 -name hc2cbdftv_32 -include
 * rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_32(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * ((TWVL / VL) * 62)); m < me; m = m + VL,
        Rp = Rp + (VL * ms), Ip = Ip + (VL * ms), Rm = Rm - (VL * ms),
        Im = Im - (VL * ms), W = W + (TWVL * 62),
        MAKE_VOLATILE_STRIDE(128, rs)) {
      V Ts, T1S, T3p, T45, T3A, T48, T1b, T1V, T1o, T2G, T2o, T2Y, T2z, T31,
          T1L;
      V T2H, T2J, T2K, TJ, T1c, T3D, T46, T10, T1d, T2r, T2A, T3w, T49, T1D,
          T1M;
      V T2u, T2B;
      {
        V T4, T1i, T15, T1j, Tb, T1m, T16, T1l, T1G, T1F, Tj, T3m, T18, T1J,
            T1I;
      ...
      {
        V T3f, T38, T4p, T4v, T3T, T3Z, T2a, T2i, T4b, T4h, T1O, T20, T2M, T2U,
            T3F;
        V T3L, T1g, T3X, T2g, T3J, T2E, T4l, T2S, T4f, T1Y, T4t, T26, T43, T34,
            T3P;
        V T3e, T3j, T36, T37, T35, T4n, T4o, T4m, T4u, T3R, T3S, T3Q, T3Y, T28,
            T29;
        ...
        {
          V T2I, T2L, T2F, T2T, T3x, T3E, T3k, T3K, T12, T2e, T1f, T2f, T11,
              T1e, T1;
          V T3W, T2d, T3I, T2w, T2Q, T2D, T2R, T2v, T2C, T2l, T4k, T2P, T4e,
              T1U, T24;
          V T1X, T25, T1T, T1W, T1R, T4s, T23, T42, T30, T3c, T33, T3d, T2Z,
              T32, T2X;
          V T3O, T3b, T3i;
          T2I = VSUB(T2G, T2H);
          T2L = VSUB(T2J, T2K);
        ...
        {
          V T1P, T4w, T2j, T4c, T4x, T1Q, T4d, T2k, T21, T4q, T2b, T4i, T4r,
              T22, T4j;
          V T2c, T2N, T40, T3g, T3G, T41, T2O, T3H, T3h, T2V, T3U, T39, T3M,
              T3V, T2W;
          V T3N, T3a;
          T1P = VADD(T1g, T1O);
...
static const tw_instr twinstr[] = {
    ...
    VTW(1, 13), VTW(1, 14),      VTW(1, 15), VTW(1, 16), VTW(1, 17), VTW(1, 18),
    VTW(1, 19), VTW(1, 20),      VTW(1, 21), VTW(1, 22), VTW(1, 23), VTW(1, 24),
    VTW(1, 25), VTW(1, 26),      VTW(1, 27), VTW(1, 28), VTW(1, 29), VTW(1, 30),
    VTW(1, 31), {TW_NEXT, VL, 0}};

static const hc2c_desc desc = {
    32, XSIMD_STRING("hc2cbdftv_32"), twinstr, &GENUS, {119, 62, 130, 0}};
 ...
 * 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 32
 * -dif -sign 1 -name hc2cbdftv_32 -include rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_32(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * ((TWVL / VL) * 62)); m < me; m = m + VL,
      ...
      V T22, T1E, T24, T3I, T4p, TU, T2n, T1i, T2h, T1L, T25, T3L, T4q, T1f,
          T2o;
      V T1j, T2k;
      {
      ...
      }
      {
        ...
        V T10, TZ, T14, T16, T15, T1H, T1K, T3J, T3K, T18, T2i, T1e, T2j, T13,
            T1d;
      ...
      {
        V T4L, T4G, T4s, T4y, T3W, T4g, T42, T4a, T3g, T4e, T3o, T3E, T1w, T46,
            T2M;
        V T40, T2u, T4w, T2C, T4k, T36, T3A, T3i, T3s, T28, T2O, T2w, T2G, T2Y,
            T4K;
        V T3y, T4C;
        {
          V T4E, T4F, T4D, T4o, T4r, T4l, T4x, T3Q, T48, T3V, T49, T3M, T3U,
              T3F, T4f;
          V T41, T47, T3c, T3n, T3f, T3m, T3a, T3b, T3d, T3e, T39, T4d, T3l,
              T3D, T1h;
          V T2K, T1v, T2L, Tz, T1g, T1k, T1u, T1, T45, T2J, T3Z, T2m, T2A, T2t,
              T2B;
          ...
          {
            V T32, T3q, T35, T3r, T30, T31, T33, T34, T2Z, T3z, T3h, T3p, T1Y,
                T2E, T27;
            V T2F, T1M, T1X, T23, T26, T1x, T2N, T2v, T2D, T2U, T3x, T2X, T3w,
                T2S, T2T;
        ...
        {
          V T29, T4M, T2P, T4t, T4N, T2a, T4u, T2Q, T2x, T4H, T2H, T4z, T4I,
              T2y, T4A;
          V T2I, T37, T4h, T3B, T3X, T4i, T38, T3Y, T3C, T3j, T4b, T3t, T43,
              T4c, T3k;
          V T44, T3u;
          T29 = VADD(T1w, T28);
...
static const hc2c_desc desc = {
    32, XSIMD_STRING("hc2cbdftv_32"), twinstr, &GENUS, {233, 88, 16, 0}};
