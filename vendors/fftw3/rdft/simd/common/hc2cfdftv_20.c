 ...
 * -no-generate-bytw -n 20 -dit -name hc2cfdftv_20 -include rdft/simd/hc2cfv.h
 */
...
static void hc2cfdftv_20(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DVK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * ((TWVL / VL) * 38)); m < me; m = m + VL,
      ...
      V T12, T1d, T1e, T24, T2g, Ti, T1t, T1V, T29, T26, T27, T1W, T25, T1H,
          T1L;
      ...
      {
        V T1m, T1q, T1g, T1p, T1j, T1k, T1l, T1i, T1f, T1h, T1s, T1n, T1o, T1r,
            T2e;
        V T2A, T2o, T2u, T2l, T2B, T2p, T2x, T2d, T2t, T2a, T2s, T28, T2k, T2w,
            T2h;
...
static const hc2c_desc desc = {
    20, XSIMD_STRING("hc2cfdftv_20"), twinstr, &GENUS, {77, 62, 66, 0}};
 ...
 * -dit -name hc2cfdftv_20 -include rdft/simd/hc2cfv.h */
...
static void hc2cfdftv_20(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
  ...
  DVK(KP500000000, +0.500000000000000000000000000000000000000000000);
  {
    ...
    for (m = mb, W = W + ((mb - 1) * ((TWVL / VL) * 38)); m < me; m = m + VL,
      ...
      V T2t, T2a, T2u, T2e, T2C, T20, T2w, T23, T2x, T2d, T2B, T1W, T1X, T1U,
          T1V;
      ...
      T2z =
          VMUL(LDK(KP500000000),
               VBYI(VFNMS(LDK(KP587785252), T2y, VMUL(LDK(KP951056516), T2v))));
      T2K =
          VMUL(LDK(KP500000000),
               VBYI(VFMA(LDK(KP951056516), T2y, VMUL(LDK(KP587785252), T2v))));
      ...
      {
        V T2c, T2p, T2l, T2s, T2o, T24, T2b, T2f, T2j, T2k, T2r, T2m, T2n, T2q,
            T1n;
        V T1Q, T1E, T1K, T1B, T1R, T1F, T1N, T1m, T1J, TZ, T1I, TX, TY, T1q,
            T1M;
        V T1A, T1L, T1t, T1z, T1C, T1S, T1T, T1D, T1G, T1O, T1P, T1H;
        T24 = VSUB(T20, T23);
        T2b = VSUB(T27, T2a);
        T2c = VMUL(LDK(KP500000000), VBYI(VFMA(LDK(KP951056516), T24,
                                               VMUL(LDK(KP587785252), T2b))));
        T2p = VMUL(LDK(KP500000000), VBYI(VFNMS(LDK(KP587785252), T24,
                                                VMUL(LDK(KP951056516), T2b))));
...
static const hc2c_desc desc = {
    20, XSIMD_STRING("hc2cfdftv_20"), twinstr, &GENUS, {131, 65, 12, 0}};
