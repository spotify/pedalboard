 ...
 * -no-generate-bytw -n 8 -dit -name hc2cfdftv_8 -include rdft/simd/hc2cfv.h */
...
static void hc2cfdftv_8(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
                        INT mb, INT me, INT ms) {
  DVK(KP500000000, +0.500000000000000000000000000000000000000000000);
  DVK(KP707106781, +0.707106781186547524400844362104849039284835938);
  {
    INT m;
    for (m = mb, W = W + ((mb - 1) * ((TWVL / VL) * 14)); m < me; m = m + VL,
        Rp = Rp + (VL * ms), Ip = Ip + (VL * ms), Rm = Rm - (VL * ms),
        Im = Im - (VL * ms), W = W + (TWVL * 14),
...
static const tw_instr twinstr[] = {VTW(1, 1), VTW(1, 2),       VTW(1, 3),
                                   VTW(1, 4), VTW(1, 5),       VTW(1, 6),
                                   VTW(1, 7), {TW_NEXT, VL, 0}};

static const hc2c_desc desc = {
    8, XSIMD_STRING("hc2cfdftv_8"), twinstr, &GENUS, {23, 22, 18, 0}};
 ...
 * 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 8
 * -dit -name hc2cfdftv_8 -include rdft/simd/hc2cfv.h */
...
static const hc2c_desc desc = {
    8, XSIMD_STRING("hc2cfdftv_8"), twinstr, &GENUS, {41, 23, 0, 0}};
