 ...
 * -no-generate-bytw -n 8 -dif -sign 1 -name hc2cbdftv_8 -include
 * rdft/simd/hc2cbv.h */
...
static void hc2cbdftv_8(R *Rp, R *Ip, R *Rm, R *Im, const R *W, stride rs,
...
static const hc2c_desc desc = {
    8, XSIMD_STRING("hc2cbdftv_8"), twinstr, &GENUS, {23, 14, 18, 0}};
 ...
 * -dif -sign 1 -name hc2cbdftv_8 -include rdft/simd/hc2cbv.h */
...
static const hc2c_desc desc = {
    8, XSIMD_STRING("hc2cbdftv_8"), twinstr, &GENUS, {41, 16, 0, 0}};
